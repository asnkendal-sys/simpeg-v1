    ...
    <div id="F4-landscape">
     <table border="0" cellpadding="0" width="100%">
        <tr>
            ...
            <td>Surat Perintah Sekretaris<BR> Daerah Kabupaten Kendal</td>
        </tr>
        <tr>
            <td width="70%">&nbsp;</td>
            <td width="6%">Nomor</td>
        ...
        <tbody>
            ...
            foreach($rs as $item){
                ...
                <tr>
                    ...
                    <td><?php echo ucword($item->pangkat)." (".$item->golru.")";?><br>{!!($item->tmtpkt!='0000-00-00')?date('d-m-Y', strtotime($item->tmtpkt)):''!!}</td>
            ...
            <tbody>
                ...
                <tr contenteditable="true">
                    ...
                    <td align="center" colspan="1" width="50%">
                        <div align="center" style="margin-left: 390px;">
                            <span style="font-size:14px;">SEKRETARIS DAERAH<br />
                                <span style="font-size:14px;">KABUPATEN KENDAL<br />
                                    <br />
                                    <br />
                                    <br />
                                    <u><b>{{$item->kepalasekda}}</b></u><br />
                                    {{$item->pangkatsekda}}<br />
                                    {{$item->nipsekda}}</span></span></div>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3" style="vertical-align: middle;" width="50%">
                                &nbsp;</td>
                                <td align="right" colspan="1" style="vertical-align:bottom;" width="80%">
                                &nbsp;</td>
                            </tr>
                            <tr>
                                <td colspan="3" style="vertical-align: middle; width: 50%;">
                                </td>
                                <td align="center" colspan="1" width="50%" style="padding-left: 390px;">
                                    <!--<div id="qrcode">--></div></td>
                                </tr>
                                <tr>
                                    <td colspan="3" style="vertical-align: middle; width: 50%;">
                                        <span style="font-family: arial, helvetica, sans-serif; font-size: 11px; line-height: 14.4px; text-align: right;"><small><em>e-Simpeg Kab. Kendal <?php echo gmdate("d-m-Y H:i", time()+60*60*7) ?></em></small></span></td>
                    ...
                    <script>
                        $(document).ready(function(){
                            $("#qrcode").qrcode({
                                size    : 83.149606299,
                                render  : "image",
                                text    : "{!!url().'/digitalsign/mutasi/antaropd/skkolektif/'.$item->nip.'/'.$item->nousul!!}"
                            });
