...
//        }
    ...
    $rs = \DB::table('tb_01')
        ->select('tb_01.*', 'a_golruang.golru', 'a_esl.esl', 'a_skpd.path_short','a_dikstru.dikstru','a_tkpendid.tkpendid','a_jenjurusan.jenjurusan','a_agama.agama',
     ...
     <Worksheet ss:Name=\"Sheet1\">
      <Table ss:ExpandedColumnCount=\"13000000\" ss:ExpandedRowCount=\"6000000\" x:FullColumns=\"1\"
       ...
       <Row ss:AutoFitHeight=\"0\">
        <Cell ss:MergeAcross=\"12\" ss:StyleID=\"s64\"><Data ss:Type=\"String\">REKAP KENAIKAN PANGKAT REGULER</Data></Cell>
       </Row>
       <Row ss:AutoFitHeight=\"0\">
    ...
    if((Input::get('idskpd') == '') && (Input::get('idjenjab') == '')){
        $w.="<Row ss:AutoFitHeight=\"0\" ss:Height=\"18\">
            <Cell ss:StyleID=\"s74\"><Data ss:Type=\"String\">Unit Kerja dan Jenis Jabatan tidak dipilih</Data></Cell>
        </Row>";
    }else{
      if(count($rs) != ''){
