...
<section class="content">
    <div class="box box-primary">
        ...
        <div class="row">
            <div class="col-md-12">
                {!! Form::model($unitkerja, array('url' => $uri, 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax') ,'id'=>'simpan')) !!}
                {!! Form::hidden('idskpd') !!}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            {!! comboSkpd("idparent",$unitkerja->idparent,"") !!}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            {!! listPublish("flag",$unitkerja->flag,"") !!}
                        </div>
                    </div>
                    <div class="form-group">
