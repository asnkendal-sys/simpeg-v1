...
<div class="print"></div>
<?php
    $rs = \NominatifpensiunModel::getDatapengantar($tmtpens, $idskpdpens);
...
<div class="page-lanscape" id="F4-landscape">
    <div align="center">
        <table>
            <tr>
                <td>
                    <p><h3 align="center">DAFTAR NOMINATIF USUL PENSIUN</h3></p>
                    <p><h3 align="center">UNIT KERJA : {!!strtoupper(getSkpd($idskpdpens))!!} </h3></p>
                    <p><h3 align="center">TMT <?php echo strtoupper(formatTanggalPanjang($rs[0]->tmtpens))?></h3></p>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div>
        <table class="table" id="tablex" border="0" cellpadding="0" width="25%" align='right'>
            <tr>
            ...
            <tr>
                <td>NOMOR</td>
                <td width="2%">:</td>
                <td width="50%" colspan="3">{!!$rs[0]->no_sp!!}</td>
            </tr>
            <tr>
                <td>TANGGAL</td>
                <td>:</td>
                <td colspan="2">{!!formatTanggalPanjang($rs[0]->tgl_sp)!!}</td>
            </tr>
        </table>
    </div>
    ...
    <div>
        <table class="table" border="0" cellpadding="0" width="100%">
            ...
            <tr>
                ...
                <th align="center" rowspan="3" width="5%">TMT PENSIUN <br>NOMOR</th>
            ...
            <tr>
                ...
                <td><div align="center"><?php echo $item->tmtpens_?><br><?php echo $item->noskpens?></div></td>
