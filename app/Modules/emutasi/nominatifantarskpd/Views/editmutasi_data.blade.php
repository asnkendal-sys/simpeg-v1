<form id="form-edit" class="form-horizontal" method="POST" action="{!!url()!!}/emutasi/nominatifantarskpd/updatemutasi" accept-charset="UTF-8">
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
             <div class="box-header">
                <h3 class="box-title"><i class="fa fa-fw fa-paper-plane"></i> ATRIBUT MUTASI ANTAR SKPD </h3>
            </div>
            <div class="box box-warning">
             <div class="box-body">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $.ajax({
            url:'{!!url()!!}/emutasi/nominatifantarskpd/editmutasi',
        ...
        $('#form-edit').on('submit',function(e){
            var $this = $(this);
            e.preventDefault();
            bootbox.confirm('Update Data Nominatif Mutasi Antar SKPD ?',function(a){
                if (a == true){
                    $.ajax({
