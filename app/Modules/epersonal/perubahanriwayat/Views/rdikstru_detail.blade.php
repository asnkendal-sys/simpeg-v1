<section class="content">
      ...
      {!! Form::open(array('url' => \Request::path().'/delete', 'method' => 'POST', 'class' => 'form-'.\Config::get('claravel::ajax'),'id'=>'data' )) !!}
                  ...
                  <p>
                     <div class="nav-tabs-custom" style="box-shadow:none;">
                        <ul class="nav nav-tabs tab2" id="myTabs">
                           ...
                           <li class="active"><a data-toggle="tab" href="#" id="rdikstru" recnip="{!! Input::get('nip')!!}"><i class="fa fa-fw fa-dot-circle-o"></i> DIKLAT STRUKTURAL</a></li>
                        ...
                        <div class="tab-content">
                           <div id="dikstru" class="tab-pane active">
                              <p>
                                 <table class="table table-striped table-hover table-condensed table-bordered" role='grid' id="tb-rdikstru">
                                    ...
                                    @foreach ($rdikstrus as $rdikstru)
                                    <?php $x++; ?>
                                    <tr>
                                        <td rowspan="2"align="center">{!!$x!!}</td>
                                        <td>{!!$rdikstru->dikstru!!}</td>
                                        <td>{!!$rdikstru->tmdikstru!!}</td>
                                        <td>{!!$rdikstru->penyelenggara!!}</td>
                                        <td>{!!$rdikstru->angkatan!!}</td>
                                        <td align="center">{!!date('d-m-Y',strtotime($rdikstru->tgmul))!!}</td>
                                        <td align="center">{!!date('d-m-Y',strtotime($rdikstru->tgsel))!!}</td>
                                        <td>{!!$rdikstru->jamhari!!} Jam </td>
                                        <td>{!!$rdikstru->nosttpdikstru!!}</td>
                                        <td align="center">{!!date('d-m-Y',strtotime($rdikstru->tgsttpdikstru))!!}</td>
                                        <td rowspan="2" align="right">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li><a class="text-info prevperubahan2" recid="{!!$rdikstru->id!!}" recnip="{!!$rdikstru->nip!!}" recflag="{!!$rdikstru->idjnsaksi!!}" href="javascript:void(0)" ><i class="{!!(session('role_id') <= 3)?'fa fa-check':'fa fa-search'!!}"></i> {!!(session('role_id') <= 3)?'Verifikasi':'Preview'!!}</a></li>
                                                    <li><a class="text-danger btlperubahan" recid="{!!$rdikstru->id!!}" recnip="{!!$rdikstru->nip!!}" recflag="{!!$rdikstru->idjnsaksi!!}" href="javascript:void(0)" ><i class="fa fa-times-circle"></i> Batalkan</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><em><small>{!!$rdikstru->nip."<br>".$rdikstru->namalengkap!!}</small></em></td>
                                        <td colspan="3"><em><small>{!!$rdikstru->path!!}</small></em></td>
                                        <td colspan="5" class="{!!($rdikstru->status == 2)?'alert-danger':''!!}">
                                            <em><small>{!!getKetaksi($rdikstru->idjnsaksi)!!}</small></em><br>
                                            <em><small>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Keterangan : {!!($rdikstru->ketditolak!='')?$rdikstru->ketditolak:'Belum ada tanggapan.'!!}</small></em>
                                        </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
         ...
         <div class="box-footer clearfix">
            <div class="row">
               ...
               <div class="col-sm-6">
                   <?php echo $rdikstrus->appends(array('idskpd'=>Input::get('idskpd'), 'search' => Input::get('search')))->render(); ?>
               </div>
            </div>
         </div>
      {!! Form::close() !!}
   ...
   <form id="prev-dikstruakhir" class="form-horizontal">
      <div class="row ">
         <div class="col-md-12">
            <div class="box box-primary">
               <div class="box-body">
                  ...
                  <div class="nav-tabs-custom" style="box-shadow:none;">
                     <ul class="nav nav-tabs tab1" id="myTab2">
                        <li class="active"><a data-toggle="tab" href="#dikstruakhir"> <i class="fa fa-fw fa-paper-plane"></i> DAFTAR DIKSTRU</a></li>
                     </ul>
                     ...
                     <div class="tab-content data-awal">
                        ...
                        ?>
                        <div id="dikstruakhir" class="tab-pane active">
                           <div class="row">
                              <table class="table table-striped table-hover table-condensed table-bordered" role='grid' id="tb-rdikstru">
                                  <thead class="bg-primary">
                                     <tr>
...
<script>
   $(document).ready(function(){
      ...
      $('.prevperubahan2').on('click', function(e){
          e.preventDefault(e);
          claravel_modal('Perubahan Riwayat Diklat Struktural','Loading...','main_modal2');
          $.ajax({
             type:'post',
             url : '{!!url()!!}/epersonal/perubahanriwayat/data/rdikstru_perubahan',
          ...
          bootbox.confirm('Batalkan perubahan data ?',function(a){
             if(a == true){
                 $.ajax({
                      ...
                      type : 'post',
                      data: {'id' : $this.attr('recid'), 'tb':'r_dikstru_temp', '_token' : '{!!csrf_token()!!}'},
                      beforeSend: function(){
                          preloader.on();
                      },
                      success:function(html){
