<form id="form-edit" class="form-horizontal" method="POST" action="{!!url()!!}/emutasi/nominatifpengangkatan/updatepengangkatan" accept-charset="UTF-8">
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
               <div class="box-header">
                <h3 class="box-title"><i class="fa fa-fw fa-paper-plane"></i> ATRIBUT PENGANGKATAN </h3>
            </div>
            <div class="box box-warning">
               <div class="box-body">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $.ajax({
            url:'{!!url()!!}/emutasi/nominatifpengangkatan/editpengangkatan',
            ...
            success:function(response){
                ...
                autoComplete(".data-atribut #idskpdbaru", '{{url()}}/emutasi/nominatifpengangkatan/cariwhereskpd2', 'Satker ..', null, ret.idskpdbaru, ret.skpdbaru);
                autoComplete(".data-atribut #idskpdbaru", '{{url()}}/emutasi/nominatifpengangkatan/cariwhereskpd2', 'Satker ..', null,  '', '',ret.idskpdbaru.substring(0,2));
            }
        });
        ...
        $('#form-edit').on('submit',function(e){
            var $this = $(this);
            e.preventDefault();
            bootbox.confirm('Update Data Nominatif Pengangkatan ?',function(a){
                if (a == true){
                    $.ajax({
