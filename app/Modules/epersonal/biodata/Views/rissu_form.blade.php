<div class="nav-tabs-custom" style="box-shadow:none;">
    <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#tab_1"><i class="fa fa-pencil"></i> <b>INPUT xx</b></a></li>
    </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group nipnrp">
                            ...
                            <div class="col-sm-7">
                                {!! Form::text('nipnrp', null, array('class'=> 'form-control', 'placeholder'=>'No. NIP/NRP Pasangan')) !!}
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    $.ajax({
                        ...
                        success:function(html){
                            ...
                            if(html==1){
                                ...
                                notification('Data Gagal Disimpan','danger');
                            }
                        }
                    });
                }
