...
//    use App\Repositories\SkpRepository;
    ...
    $nip = Input::get('nip');
    $iddikfung = Input::get('id');
    $idbkn = Input::get('iddikfungbkn');

    if($idbkn != ''){
//        $srv = new SkpService(new SkpRepository);
//        $dikfung = $srv->fetch($nip)->filter('tahun',2021)->first();
        $dikfung = accessDatapersonalsiasn('kursus/id',$idbkn);
    }

    /*catatan sinkronisasi*/
    /*
     *
     Jika $idbkn kosong maka data sinkronisasi upload kebkn dengan hanya menampilan 1 form r_dikfung yang akan dikirim sinkronisasinya
     Jika $idbkn tidka kosong maka data sinkronisasi menampilkan 2 form yaitu data dari SIASN dan data dari r_dikfung simpeg kemudian ada pilihan tombol :
     1. TARIK DATA KE SIMPEG : Untuk form preview data dari r_dikfung SIASN
     2. TARIK DATA KE SIASN    : Untuk form preview data dari r_dikfung simpeg
     *
     * */
...
<div class="nav-tabs-custom" style="box-shadow:none;">
    <ul class="nav nav-tabs">
        ...
        @endif
        <li class="<?php echo (($iddikfung != '')?'':'active')?>"><a data-toggle="tab" id="xdatabkn" href="#tab_syx2"><i class="fa fa-list"></i> <b>DATA DIKLAT FUNGSIONAL SIASN</b></a></li>
    </ul>
    <div class="tab-content">
        ...
        <div id="tab_syx1" class="tab-pane active">
            ...
            <div class="row">
                @if($idbkn != '')
                    <!--preview data r_dikfung SIASN-->
                    <div class="col-md-6">
                        <div class="alert callout callout-success">
                            <h4><i class="fa fa-info-circle"></i> PETUNJUK</h4>
                            <ul style="padding-left: 15px">
                                <li>Preview data yang ditampilkan merupakan data Riwayat Diklat Fungsional dari SIASN</li>
                                <li>Untuk melakukan sinkronisasi data Riwayat Diklat Fungsional dari SIASN ke simpeg tekan tombol <b>TARIK DATA</b></li>
                                <li>Ketika proses <b>TARIK DATA</b> selesai Riwayat Diklat Fungsional dari SIASN sudah terkoneksi dengan SIMPEG</li>
                            </ul>
                        </div>

                        {!! Form::open(array('url' => url().'/syncrdikfungbkn', 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax'),'id'=>'form-rdikfung1')) !!}
                        {!! Form::hidden('id', $iddikfung, array('id'=> 'id')) !!}
                        {!! Form::hidden('iddikfungbkn', $idbkn, array('id'=> 'iddikfungbkn')) !!}
                        <div class="box-body">
                            <b class="box-title"><i class="fa fa-fw fa-child"></i> DIKLAT FUNGSIONAL PEGAWAI</b><hr>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    {!! Form::text('namaKursus', $dikfung->namaKursus, array('class'=> 'form-control', 'placeholder'=>'Nama Diklat', 'readonly'=>'readonly')) !!}
                                    <br>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    {!! Form::text('institusiPenyelenggara', $dikfung->institusiPenyelenggara, array('class'=> 'form-control', 'placeholder'=>'Penyelenggara', 'readonly'=>'readonly')) !!}
                                    <br>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    {!! Form::text('tahun', $dikfung->tahunKursus, array('class'=> 'form-control', 'placeholder'=>'Tahun', 'maxlength'=> 4, 'readonly'=>'readonly')) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    {!! Form::text('noSertipikat', $dikfung->noSertipikat, array('class'=> 'form-control', 'placeholder'=>'Nomor Sertifikat', 'readonly'=>'readonly')) !!}
                                    <br>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    {!! Form::text('tanggalKursus', $dikfung->tanggalKursus, array('class'=> 'form-control', 'placeholder'=> 'dd-mm-yyyy', 'readonly'=>'readonly')) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('tanggalSelesaiKursus', 'Tanggal Selesai:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    {!! Form::text('tanggalSelesaiKursus', $dikfung->tanggalSelesaiKursus, array('class'=> 'form-control', 'placeholder'=> 'dd-mm-yyyy', 'readonly'=>'readonly')) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <div class='input-group'>
                                        {!! Form::text('jumlahJam', $dikfung->jumlahJam, array('class'=> 'form-control num', 'placeholder'=>'Lama Dalam Satuan Jam', 'readonly'=>'readonly')) !!}
                ...
                @if($iddikfung != 'x')
                <!--preview data r_dikfung simpeg-->
                <div class="col-md-<?php echo (($idbkn != '')?6:12)?>">
                    <div class="alert callout callout-success">
                        <h4><i class="fa fa-info-circle"></i> PETUNJUK</h4>
                        <ul style="padding-left: 15px">
                            <li>Preview data yang ditampilkan merupakan data Riwayat Diklat Fungsional dari SIMPEG</li>
                            <li>Untuk melakukan sinkronisasi data dari SIMPEG ke SIASN tekan tombol <b>SINKRONISASI DATA</b></li>
                            <li>Ketika proses <b>SINKRONISASI</b> selesai data pada Riwayat Diklat Fungsional SIMPEG sudah terkoneksi dengan SIASN</li>
                        </ul>
                    </div>
                    {!! Form::open(array('url' => url().'/syncrdikfungsimpegsiasn', 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax'),'id'=>'form-rdikfung2')) !!}
                    <div class="box-body rdikfung-perubahan">
                        <b class="box-title"><i class="fa fa-fw fa-child"></i> DIKLAT FUNGSIONAL PEGAWAI</b><hr>
                        <div class="form-group">
                            {!! Form::label('nip', 'NIP:', array('class' => 'col-sm-3 control-label')) !!}
                            <div class="col-sm-7">
                                {!! Form::hidden('id', null, array('id'=> 'id')) !!}
                                {!! Form::hidden('iddikfungbkn', null, array('id'=> 'iddikfungbkn')) !!}
                                {!! Form::text('nip', $nip, array('class'=> 'form-control ', 'maxlength'=>18, 'placeholder'=>'Nomor Induk Pegawai', 'readonly'=>'readonly')) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!! Form::label('iddikfung', 'Nama Diklat:', array('class' => 'col-sm-3 control-label')) !!}
                            <div class="col-sm-7">
        ...
        <div id="tab_syx2" class="tab-pane <?php echo (($iddikfung != '')?'':'active')?>">
            <br>
            <div class="row">
                <div class="alert callout callout-success">
                    <h4><i class="fa fa-info-circle"></i> PETUNJUK</h4>
                    <ul style="padding-left: 15px">
                        <li>Menu ini menampilkan data Riwayat Diklat Fungsional dari SIASN</li>
                        <li>Terdapat status sinkronisasi pada masing-masing list data riwayat</li>
                        <li>Tekan Tombol <b>SINKRONISASI</b> untuk tarik data Riwayat Diklat Fungsional dari SIASN ke SIMPEG</li>
                    </ul>
                </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#form-rdikfung2 .rdikfung-perubahan select').select2();
        autoComplete2('#form-rdikfung2 .rdikfung-perubahan #iddikfung', '{!!url()!!}/epersonal/biodata/dikfung', '.: Pilihan :.', null, '', '', '');

        $('#form-rdikfung2 .rdikfung-perubahan .num').keyup(function () {
            if (this.value != this.value.replace(/[^0-9\.]/g, '')) {
                this.value = this.value.replace(/[^0-9\.]/g, '');
            }
        });

        $("#form-rdikfung2 .rdikfung-perubahan .date").mask("99-99-9999");
        $("#form-rdikfung2 .rdikfung-perubahan .datepicker").datetimepicker({
            format: 'DD-MM-YYYY'
        });

        $('#form-rdikfung2 .rdikfung-perubahan #iddikfung').on('change', function(e){
            e.preventDefault();
            $('#form-rdikfung2 .rdikfung-perubahan #dikfung').val($(this).find(":selected").text());
        });

        $('#form-rdikfung1').on('submit',function(e){
        ...
        $('#form-rdikfung2').on('submit',function(e){
    ...
    <?php if(Input::get("flag") == 2){ ?>
        $.ajax({
            ...
            type:'post',
            data:{'id':'{!!Input::get("id")!!}','tb':'r_dikfung','_token' : '{!!csrf_token()!!}'},
            beforeSend:function(){
                preloader.on();
            },
            success:function(response){
                ...
                if(ret){
                    for(attrname in ret){
                        $('#form-rdikfung2 .rdikfung-perubahan #'+attrname).val(ret[attrname]);
                        if($.inArray(attrname,arrdate)!=-1){
                            var str = ret[attrname];
                            var res = str.split("-");
                            $('#form-rdikfung2 .rdikfung-perubahan #'+attrname).val(res[2]+'-'+res[1]+'-'+res[0]);
                        }
                    }

                    $("#form-rdikfung2 .rdikfung-perubahan #iddikfung").data('select2').trigger('select', {
                        data: {"id":ret.iddikfung,"text":ret.dikfung}
                    });
                }
            }
        });                
    ...
    function loadRdikfungbkn(){
        xhr.abort();
        xhr = $.ajax({
            type:'post',
            url:'{!!url()!!}/sinkronsiasn/rdikfung_sinkronsiasn_data',
