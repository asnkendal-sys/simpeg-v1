    ...
    <table class="table table-striped table-hover table-condensed">
        <tr>
            <td colspan="4" bgcolor="lightblue">
                <div style="font-weight: bold; font-size: 14px;">LOKASI KERJA</div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" bgcolor="lightblue">
                <div style="font-weight: bold; font-size: 14px;">PENETAPAN PENSIUN</div>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="2"><em>* Jika SK Pensiun belum keluar Status Kedudukan Pegawai : <b>Aktif</b> & cukup isikan <b>TMT Pensiun</b> saja.</em></td>
            </td>
