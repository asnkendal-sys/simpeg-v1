...
<html>
<head>
    <title>{!!ucfirsts(getUtility('alias_aplikasi'))!!} Statistik Kedudukan Pegawai</title>
...
<script>
	$(document).ready(function(){
        $('#tb-statistik .link').on('click', function(e){
            ...
            var vidjenkedudupeg = $(this).attr("ed1");
...
<form id="form-print" name="form-print" action="{!!url()!!}/epersonal/statistikpegawai/print/statistik_statuskedu_pegawai" class="form-horizontal" method="post" enctype="multipart/form-data" target="_blank">
    {!!csrf_field()!!}
...
<h4 align="center">STATISTIK PEGAWAI BERDASARKAN STATUS KEDUDUKAN PEGAWAI {!! ((Input::get('idskpd')!='')?'PADA '.strtoupper(getSkpd(Input::get('idskpd'))):'') !!}</h4><br>
<table class="table table-hovered table-bordered" id="tb-statistik" border="{!!(Request::segment(3) == 'print')?'1':'0'!!}">
    <thead class="bg-primary">
		<tr>
			<th rowspan="3"><div class="text-center">STATUS KEDUDUKAN</div></th>
    ...
    @if(count($rs) > 0)
		...
		?>
		<tr>
			<td><div class="text-left">{!!$item->jenkedudupeg!!}</div></td>
			<td><div class="link text-center" data="notnull" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->gol!!}</div></div></td>
			<td><div class="link text-center" data="null" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->golempty!!}</div></div></td>
			<td><div class="link text-center" data="11" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_11!!}</div></div></td>
			<td><div class="link text-center" data="12" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_12!!}</div></div></td>
			<td><div class="link text-center" data="13" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_13!!}</div></div></td>
			<td><div class="link text-center" data="14" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_14!!}</div></div></td>
			<td><div class="link text-center" data="21" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_21!!}</div></div></td>
			<td><div class="link text-center" data="22" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_22!!}</div></div></td>
			<td><div class="link text-center" data="23" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_23!!}</div></div></td>
			<td><div class="link text-center" data="24" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_24!!}</div></div></td>
			<td><div class="link text-center" data="31" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_31!!}</div></div></td>
			<td><div class="link text-center" data="32" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_32!!}</div></div></td>
			<td><div class="link text-center" data="33" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_33!!}</div></div></td>
			<td><div class="link text-center" data="34" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_34!!}</div></div></td>
			<td><div class="link text-center" data="41" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_41!!}</div></div></td>
			<td><div class="link text-center" data="42" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_42!!}</div></div></td>
			<td><div class="link text-center" data="43" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_43!!}</div></div></td>
			<td><div class="link text-center" data="44" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_44!!}</div></div></td>
			<td><div class="link text-center" data="45" ed1="{!!$item->idjenkedudupeg!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_45!!}</div></div></td>
		</tr>
        @endforeach
    @else
        <tr>
