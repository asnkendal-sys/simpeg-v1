...
class ClaravelHelpers {
    ...
    public static function checkPrev($id){
		return "<input type=\"checkbox\" class=\"checkme\" name=\"data[]\" value=\"".$id."\"  data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Pilih untuk preview\">";
	}

    public static function btnPreviewAll($caption = 'Preview yang ditandai'){
		return "<button class='btn btn-warning btn-sm' style='display:none' id='preview_sk_all'><i class='fa fa-times'></i> ".$caption."</button>";
	}
