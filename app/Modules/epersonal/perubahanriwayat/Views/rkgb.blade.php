                ...
                <div id="riwayat" class="tab-pane">
                    ...
                    <div class="nav-tabs-custom" style="box-shadow:none;">
                        ...
                        <div class="tab-content">
                            <div id="rkgb" class="tab-pane active">
                                <p>
                                        ...
                                        <td rowspan="2" align="right">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li><a class="text-info prevperubahan" recrole="{!! session('role_id') !!}" recid="{!!$rkgb->id!!}" recnip="{!!$rkgb->nip!!}" recflag="{!!$rkgb->idjnsaksi!!}" href="javascript:void(0)" ><i class="{!!(session('role_id') <= 3)?'fa fa-check':'fa fa-search'!!}"></i> {!!(session('role_id') <= 3)?'Verifikasi':'Preview'!!}</a></li>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('.prevperubahan').on('click', function(e){
            ...
            if(roleid < 3){
               var tipe = 'get';
               var alamat = '{!!url()!!}/epersonal/perubahanriwayat/rkgbdetail/rkgb';
               var modal = 'main_modal3';
               var judul = 'Perubahan Data';
            }else{
               var tipe = 'post';
               var alamat = '{!!url()!!}/epersonal/perubahanriwayat/data/rkgb_perubahan';
               var modal = 'main_modal2';
               var judul = 'Perubahan Riwayat KGB';
            }
