<?php namespace App\Modules\webservices\datapensiun\Models;
...
class DatapensiunModel extends Model {
    ...
    public static function all($columns = array('*')){
        ...
        if (\PermissionsLibrary::hasPermission('mod-datapensiun-listall')){
