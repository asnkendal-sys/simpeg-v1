<?php
    ...
    /* Kondisi skpd atau unit kerja */
      ...
      $rs = \DB::table('tb_01')
            ->select('tb_01.*','a_golruang.golru','a_golruang.pangkat','a_skpd.path','a_skpd.skpd','a_esl.esl','a_tkpendid.tkpendid','a_jenjurusan.jenjurusan','a_jenjab.jenjab','a_dikstru.dikstru','tb_01.alm',
     ...
     <Worksheet ss:Name=\"Sheet1\">
      <Table ss:ExpandedColumnCount=\"13000000\" ss:ExpandedRowCount=\"6000000\" x:FullColumns=\"1\"
       ...
       <Row ss:AutoFitHeight=\"0\">
        <Cell ss:MergeAcross=\"12\" ss:StyleID=\"s64\"><Data ss:Type=\"String\">DAFTAR NOMINATIF PEGAWAI PENJAGAAN PERPANJANGAN PPPK</Data></Cell>
       </Row>
       <Row ss:AutoFitHeight=\"0\">
...
foreach($rs as $item){ $n++;
    ...
    if($mkbln > 12){
      ...
      $w.="<Row ss:Height=\"33.75\">
		...
		<Cell ss:StyleID=\"s83\"><Data ss:Type=\"String\">".$item->golru."</Data></Cell>
		...
		<Cell ss:StyleID=\"s84\"><Data ss:Type=\"String\">".$hasil->y." Tahun ".$hasil->m." Bulan</Data></Cell>
...
force_download("nominatif_penjagaan_perpanjangan_pppk_".date('Ymds').".xls", $w);
?>
