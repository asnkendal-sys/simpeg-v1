...
$rs = \DB::table('tb_01')
    ->select(
        'tb_01.*',
        \DB::raw('IF(tb_01.idstspeg=3,a_golruang.golru_p3k,a_golruang.golru) as golru'),
        'a_golruang.pangkat',
        'a_skpd.path_short',
        'a_esl.esl',
        'a_tkpendid.tkpendid',
...
<br>
<div align="center">
    <h4>DAFTAR NOMINATIF KENAIKAN GAJI BERKALAa</h4>
    <h4>
        <?php
            ...
            <tr {!!$style!!}>
                ...
                <td align="center">
                    <small>
                        ...
                        <div class="text-left">{!!$item->path_short!!} asda</div>
