<?php namespace App\Modules\emutasi\skmasukkabupaten\Models;
use Illuminate\Database\Eloquent\Model;


/**
* Skmasukkabupaten Model
...
class SkmasukkabupatenModel extends Model {
	...
	public static function all($columns = array('*')){
		...
		if (\PermissionsLibrary::hasPermission('mod-skmasukkabupaten-listall')){
