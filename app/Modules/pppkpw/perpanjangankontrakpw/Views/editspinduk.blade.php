...
<div>
    {!! Form::open(array('url' => url().'/pppkpw/perpanjangankontrakpw/simpanspinduk', 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax'),'id'=>'form-sp-induk')) !!}
...
<script type="text/javascript">
    ...
    $('#form-sp-induk').on('submit',function(e){
        e.preventDefault();
        $.ajax({
            url : '{!! url('') !!}/pppkpw/perpanjangankontrakpw/simpanspinduk',
            type : 'post',
            data: $(this).serialize(),
            beforeSend: function(){
                preloader.on();
