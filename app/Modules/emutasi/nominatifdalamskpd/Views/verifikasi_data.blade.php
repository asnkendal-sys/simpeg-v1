<form id="form-edit" class="form-horizontal" method="POST" action="{!!url()!!}/emutasi/nominatifdalamskpd/verifikasimutasidalamskpd" accept-charset="UTF-8">
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-6">
...
<div class="form-group">
   ...
   <div class="col-sm-7">
    <?php if(session::get('role_id')!=3 || session::get('role_id')!=5) { ?>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $.ajax({
            url:'{!!url()!!}/emutasi/nominatifdalamskpd/verdalamskpd',
            ...
            success:function(response){
                ...
                autoComplete(".data-atribut #idskpdbaru", '{{url()}}/emutasi/nominatifdalamskpd/cariwhereskpd2', 'Satker ..', null,  ret.idskpdbaru, ret.skpdbaru, ret.idskpdbaru);
            }
        });
...
autoComplete(".data-atribut #idskpdbaru", '{{url()}}/emutasi/nominatifdalamskpd/cariwhereskpd2', 'Satker ..', null,  '','');
...
/*select jabjbt xjab1*/
        ...
        $('#form-edit').on('submit',function(e){
            var $this = $(this);
            e.preventDefault();
            bootbox.confirm('Update Data Nominatif Mutasi Dalam OPD ?',function(a){
                if (a == true){
                    $.ajax({
