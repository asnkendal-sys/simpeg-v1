...
<?php
    ...
    $where = " tb_01.idjenkedudupeg not in (99,21) and tb_01.idjenjab = 2 and a_jabfung.isguru = '3' and tb_01.idstspeg in (".Input::get('idstspeg').")";
...
<h3>BERDASARKAN JABATAN FUNGSIONAL TEKNIS {!! strtoupper($kesehatan) !!}</h3>
</div><br>
    <table border="1">
