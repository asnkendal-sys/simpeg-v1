...
<?php
    ...
    $eselon = getAttr('a_esl', 'idesl', Input::get('ideselon'), 'esl');
    $dikstru = getAttr('a_dikstru', 'iddikstru', Input::get('iddikstru'), 'dikstru');
    ...
    if(Input::get('ideselon') == "null"){
        $where .= "and tb_01.idesljbt = ''";
        $titleadd = strtoupper($skpd)." YANG ESELONYA KOSONG ";
    }else if(Input::get('ideselon') > 0){
...
<div align="center">
    ...
    <h3>BERDASARKAN DIKLAT STRUKTURAL {!!strtoupper($dikstru)!!}</h3>
</div><br>
<table border="1">
