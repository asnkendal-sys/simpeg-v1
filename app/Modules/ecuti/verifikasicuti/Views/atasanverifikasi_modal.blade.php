...
<section class="content">
	<form id="form-veratasancuti" class="form-horizontal form-veratasancuti" method="POST" action="{!!url()!!}/ecuti/verifikasicuti/verifikasiatasan" accept-charset="UTF-8">{!!csrf_field()!!}
		...
		<div class="col-md-6">
			...
			<div class="col-md-6">
				<div class="box-header">
					<h3 class="box-title"><i class="fa fa-fw fa-check"></i> ATRIBUT VERIFIKASI USULAN CUTI (ATASAN LANGSUNG)<a title="Tekan Untuk Melihat Detail" recnip="{!! $item->nip !!}" class="detailriwayat" href="javascript:void(0)">
					</a></h3>
				</div>
				<div class="box box-warning">
					<div class="box-body">
						<table class="table table-hovered table-stripped" width="100%">
							<tr>
								...
								<td class="text-center" width="2%"> : </td>
								<td>
									<input type="text" value="{!!$item->atasan_nip!!}" name="atasan_nama" class="form-control atasan_nama" id="atasan_nama" disabled>
								</td>
							</tr>
							<tr>
								<td width="25%">Nama</td>
								<td class="text-center" width="2%"> : </td>
								<td>
									<input type="text" value="{!!$item->atasan_nama!!}" name="atasan_nama" class="form-control atasan_nama" id="atasan_nama" disabled>
								</td>
							</tr>
							<tr>
								<td width="25%">Jab</td>
								<td class="text-center" width="2%"> : </td>
								<td>
									<input type="text" value="{!!$item->atasan_jab!!}" name="atasan_jab" class="form-control atasan_jab" id="atasan_jab" disabled>
								</td>
							</tr>
							<tr>
								...
								<td class="text-center" width="2%"> : </td>
								<td>
									<input type="text" value="{!!$item->atasan_pangkat!!}" name="atasan_pangkat" class="form-control atasan_pangkat" id="atasan_pangkat" disabled>
								</td>
							</tr>
						</table>
						<table class="table table-hovered table-stripped" width="100%">
			...
			<div class="box-footer">
				<div class="form-group">
					<div class="col-sm-offset-1 col-sm-3 pull-right">
						<button class="btn btn-success form-veratasancuti" type="submit"><i class='fa fa-floppy-o'></i> Simpan</button>
						&nbsp;
						&nbsp;
	...
	<script>
		function refresh_page_awal_atasan(){
			<?php
		...
		$(document).ready(function(){
			...
			/*END*/
			$('.form-veratasancuti').on('submit',function(e){
				var $this = $(this);
				e.preventDefault();
				bootbox.confirm('Simpan data?',function(a){
					if (a == true){
						$.ajax({
                       url: '{{url()}}/ecuti/verifikasicuti/verifikasiatasan', //ganti biar gag nabrak
                       type : 'POST',
                       data : $this.serialize(),
                       beforeSend: function(){
                       	preloader.on();
