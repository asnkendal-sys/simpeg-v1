      ...
      {!! Form::open(array('url' => \Request::path().'/delete', 'method' => 'POST', 'class' => 'form-'.\Config::get('claravel::ajax'),'id'=>'data' )) !!}
                  ...
                  <p>
                     <div class="nav-tabs-custom" style="box-shadow:none;">
                        <ul class="nav nav-tabs tab2" id="myTabs">
                           ...
                           <li class="active"><a data-toggle="tab" href="#" id="rjab" recnip="{!! Input::get('nip')!!}"><i class="fa fa-fw fa-dot-circle-o"></i> JABATAN</a></li>
                        ...
                        <div class="tab-content">
                           <div id="jabatan" class="tab-pane active">
                              <p>
                                 <table class="table table-striped table-hover table-condensed table-bordered" role='grid' id="tb-rjab">
                                    ...
                                    @foreach ($rjabs as $rjab)
                                    <?php $x++; ?>
                                    <tr>
                                        <td rowspan="2"align="center">{!!$x!!}</td>
                                        <td>{!!$rjab->jenis_jabatan!!}</td>
                                        <td>{!!$rjab->jab!!}</td>
                                        <td>{!!$rjab->nosk!!}</td>
                                        <td align="center">{!!date('d-m-Y', strtotime($rjab->tgsk))!!}</td>
                                        <td align="center">{!!date('d-m-Y', strtotime($rjab->tmtjab))!!}</td>
                                        <td>{!!$rjab->skpd!!}</td>
                                        <td rowspan="2" align="right">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li><a class="text-info prevperubahan2" recid="{!!$rjab->id!!}" recnip="{!!$rjab->nip!!}" recflag="{!!$rjab->idjnsaksi!!}" href="javascript:void(0)" ><i class="{!!(session('role_id') <= 3)?'fa fa-check':'fa fa-search'!!}"></i> {!!(session('role_id') <= 3)?'Verifikasi':'Preview'!!}</a></li>
                                                    <li><a class="text-danger btlperubahan" recid="{!!$rjab->id!!}" recnip="{!!$rjab->nip!!}" recflag="{!!$rjab->idjnsaksi!!}" href="javascript:void(0)" ><i class="fa fa-times-circle"></i> Batalkan</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><em><small>{!!$rjab->nip."<br>".$rjab->namalengkap!!}</small></em></td>
                                        <td><em><small>{!!$rjab->path!!}</small></em></td>
                                        <td colspan="4" class="{!!($rjab->status == 2)?'alert-danger':''!!}">
                                            <em><small>{!!getKetaksi($rjab->idjnsaksi)!!}</small></em><br>
                                            <em><small>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Keterangan : {!!($rjab->ketditolak!='')?$rjab->ketditolak:'Belum ada tanggapan.'!!}</small></em>
                                        </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
         ...
         <div class="box-footer clearfix">
            <div class="row">
               ...
               <div class="col-sm-6">
                   <?php echo $rjabs->appends(array('idskpd'=>Input::get('idskpd'), 'search' => Input::get('search')))->render(); ?>
               </div>
            </div>
         </div>
      {!! Form::close() !!}
               ...
               <div class="box-body">
                  ...
                  <div class="nav-tabs-custom" style="box-shadow:none;">
                     <ul class="nav nav-tabs tab1" id="myTab2">
                        <li class="active"><a data-toggle="tab" href="#lokasijab"> <i class="fa fa-fw fa-map-marker"></i> DAFTAR JABATAN</a></li>
                     </ul>
...
<script>
   $(document).ready(function(){
      $('select').select2();
      $('#tb-rjab .xjabstruk, #tb-rjab .xjabfung, #tb-rjab .xisguru, #tb-rjab .xisdokter').fadeOut();
      ...
      $('.prevperubahan2').on('click', function(e){
          ...
          $.ajax({
             type:'post',
             url : '{!!url()!!}/epersonal/perubahanriwayat/data/rjab_perubahan',
