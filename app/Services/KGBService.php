    ...
    public function generateSK()
    {
        if ($this->kgb->statussk == 1) {
            ...
            if ($this->kgb->idstspeg == 3) { //p3k font
                ...
                if (strtotime($item->tglskkgbb) < strtotime('2026-02-06')) {
                    $client->post('http://10.5.2.131:8000/api/render/sklama', [
                        'json' => [
                            'noskkgbb' => $item->noskkgbb,
                            'nama' => $item->nama,
                            'nip'  => $item->nip,
                            'nmajab' => $item->nmajab,
                            ...
                            'gaji' => ($item->gkgbl != '') ? "  " . number_format($item->gkgbl, 0, ',', '.') : '',
                            ...
                            'gkgbb' => ($item->gkgbb != '') ? "  " . number_format($item->gkgbb, 0, ',', '.') : '',
                            'nomgpb' => $item->nomgpb,
                        ...
                        'sink' => storage_path('app/kgb/draft/' . $filename),
                    ]);
                } else {
