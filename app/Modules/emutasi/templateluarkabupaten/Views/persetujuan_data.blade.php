    ...
    $(document).ready(function(){
        ...
        $('#persetujuan #defaultthem').on('click', function(e){
            ...
            $.ajax({
                ...
                data: {'idskpd':'all', 'jnssurat': '3.2', '_token': '{!!csrf_token()!!}'},
                beforeSend:function(){
                    preloader.on();
                },
        ...
        <div class="span12">
            <div class="accordion-heading">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="nama" class="nama input-xxlarge form-control" id="nama" value="<?php echo TemplateluarkabupatenModel::getTemplate('all', '3.2','nama')?>">
                        <input type="hidden" name="jnssurat" class="jnssurat" id="jnssurat" value="3.2">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea rows="10" cols="600" name="template2" class="ckeditor" id="template2" placeholder="Template Surat Perintah">
                            <?php
                                if(TemplateluarkabupatenModel::getTemplate(session('idskpd'), '3.2','template')=='0'){
                                    echo TemplateluarkabupatenModel::getTemplate('all', '3.2','template');
                                }else{
                                    echo TemplateluarkabupatenModel::getTemplate(session('idskpd'), '3.2','template');
                                }
                            ?>
                        </textarea>
                    </div>
