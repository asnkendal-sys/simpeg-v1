            ...
            <!--<div class="box-tools pull-right col-lg-9 pull-right">
                ...
                <div class="col-md-12">
                    <ul class="nav nav-tabs tab1" id="myTab">
                        <li class=""><a href="{!!url()!!}/epersonal/entripensiun"> <i class="fa fa-fw fa-list-ul"></i> NOMINATIF PENSIUN</a></li>
                        <li class="active"><a href="{!!url()!!}/epersonal/entripensiun/datapensiun"> <i class="fa fa-fw fa-list-ul"></i> DAFTAR PENSIUN</a></li>
                    </ul>
            ...
            <div class="box-body no-padding">
                <table class="table table-striped table-hover table-condensed table-bordered" id='tabel'>
                    ...
                    <tbody> 
                        ...
                        <tr>
                            <td>{!!$x!!}</td>
                            <td>{!!$entripensiun->namalengkap!!} <br> <small>{!!$entripensiun->tmlhr.", ".(($entripensiun->tglhr != '0000-00-00')?date('d-m-Y', strtotime($entripensiun->tglhr)):'-')!!}</small></td>
                            ...
                            <td>{!!$entripensiun->jenjurusan!!} - {!!$entripensiun->pensiunnext!!}</td>
                            <td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a class="text-primary editverify" recid="{{$entripensiun->nip}}" href="javascript:void(0)"><i class="fa fa-pencil-square-o"></i> Edit Pensiunkan</a></li>
                                        <li><a class="text-primary btlverify" recid="{{$entripensiun->nip}}" href="javascript:void(0)"><i class="fa fa-times-circle"></i> Batalkan Pensiunkan</a></li>
                                    </ul>
                                </div>
    ...
    $(document).ready(function(){
        ...
        $('#tabel').on('click','.btlverify',function(e){
            ...
            bootbox.confirm('Batalkan Pensiun ?',function(a){
                if(a == true){
                    $.ajax({
                        url : '{!!url()!!}/epersonal/entripensiun/btlpensiun',
                        type: 'post',
        ...
        $('#prev-pensiun').on('click', function(e){
            e.preventDefault();
            $.ajax({
                url : '{!!url()!!}/epersonal/entripensiun/datapensiun',
                type : 'get',
        ...
        $('#data').on('submit',function(e){
         ...
         $('#cetak-pensiun').on('click', function(e){
            e.preventDefault();                  
            $('#cari_pensiun').attr("action", "{!!url()!!}/epersonal/entripensiun/print/pensiun");
            $('#cari_pensiun').submit();              
        });

        $('#excel-pensiun').on('click', function(e){
            e.preventDefault();
            $('#cari_pensiun').attr("action", "{!!url()!!}/epersonal/entripensiun/excel/pensiun");
            $('#cari_pensiun').submit();
            /*cetak_excel('result');*/            
        });
    });
