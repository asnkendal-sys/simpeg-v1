...
class PenyesuaiankuotacutiController extends Controller {
    ...
    //         ->select('tr_penyesuaian_cuti.*','tb_01.nip','tr_penyesuaian_cuti.id',
    ...
    //         ->orderBy(\DB::raw('tb_01.idgolrupkt desc,tb_01.tmtpkt,tb_01.idjenjab,tb_01.idesljbt,tb_01.idtkpendid desc,tb_01.tglhr'))
    ...
    public function getIndex(){
        cekAjax();
        return View::make('penyesuaiankuotacuti::index');
    }
    ...
    public function getAlldata() {
        ...
        return View::make('penyesuaiankuotacuti::all_data', compact('penyesuaiankuotacutis'));
    }
