<?php
    ...
    $tglusul = Input::get('tglusul');
    $row = \App\Modules\kenaikanpangkat\penetapannonnominatifkp\Models\PenetapannonnominatifkpModel::where('nousul', $nousul)->first();
...
<div class="row" style="padding-left: 35px;">
    <div class="span12">
        <form id="form2" name="form2" class="form-horizontal" action="{!!url()!!}/kenaikanpangkat/penetapannonnominatifkp/cetak/nonnominatif" target="_blank" class="" method="post" enctype="multipart/form-data">
            {!!csrf_field()!!}
            <input type="hidden" id="nousul" name="nousul" value="<?php echo $nousul?>" />
            <input type="hidden" id="tglusul" name="tglusul" value="<?php echo $tglusul?>" />
            <input type="hidden" id="idskpd" name="idskpd" value="<?php echo substr($row->idskpd,0,2)?>" />

            <div class="row">

                <div class="head-line">
                    <h4><i class="fa fa-fire"></i> Formulir Dokumen Non Nominatif KP</h4>
                </div></br>
