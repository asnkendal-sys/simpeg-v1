...
<div class="row" style="padding-left: 35px;">
    <div class="span12">
        @if(isset($row))
        <form id="form2" name="form2" class="form-horizontal" action="{!!url()!!}/emutasi/skpengangkatan/excel/skpengangkatan" target="_blank" class="" method="post" enctype="multipart/form-data">
            {!!csrf_field()!!}
            ...
            <div class="row">
                ...
                <div class="head-line">
                    <h4><i class="fa fa-fire"></i> SK Petikan</h4>
                </div></br>
