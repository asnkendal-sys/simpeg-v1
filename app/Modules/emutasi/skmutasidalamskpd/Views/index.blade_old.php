                            ...
                            <tr>
                                <th style="position:relative;" colspan="6">
                                    <div class="text-left">
                                        ...
                                        <i class="fa fa-calendar"></i> <?php echo date("d-m-Y", strtotime($skmutasidalamskpd->tglusul))?> 
                                        &nbsp;
                                ...
                                <th style="position:relative;" colspan="6">
                                    <div class="text-right">
                                        ...
                                        &nbsp;<a href="#" class="attrnominatif" recnousul="{!!$skmutasidalamskpd->nousul!!}" act="nominatif" title="Cetak Lampiran Nominatif"><i class="fa fa-list"> Nominatif</i></a> |
