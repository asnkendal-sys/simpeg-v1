...
<script>
	$(document).ready(function(){
		...
		$.ajax({
			url:'{{url()}}/epersonal/statistikpegawai/graphpendformal1',
			type:'post',
		...
		$.ajax({
			url:'{{url()}}/epersonal/statistikpegawai/graphpendformal2',
			type:'post',
			data:{ 'idskpd':$('#idskpd').val(), 'idstspeg': idstspeg, '_token':'{!!csrf_token()!!}' },
			beforeSend:function(){
		...
		$.ajax({
			url:'{{url()}}/epersonal/statistikpegawai/graphpendformal3',
			type:'post',
			data:{ 'idskpd':$('#idskpd').val(), 'idstspeg': idstspeg, '_token':'{!!csrf_token()!!}' },
			beforeSend:function(){
		...
		$.ajax({
			url:'{{url()}}/epersonal/statistikpegawai/graphpendformal4',
			type:'post',
			data:{ 'idskpd':$('#idskpd').val(), 'idstspeg': idstspeg, '_token':'{!!csrf_token()!!}' },
			beforeSend:function(){
...
<h4 align="center">GRAFIK STATISTIK PEGAWAI BERDASARKAN PENDIDIKAN FORMAL {!! ((Input::get('idskpd')!='')?'PADA '.strtoupper(getSkpd(Input::get('idskpd'))):'') !!}</h4>
