...
<?php
	$where = " tb_01.idjenkedudupeg not in (99,21) and tb_01.idtkpendid='".Input::get('idtkpendid')."' and tb_01.idstspeg in (".Input::get('idstspeg').")";
...
<h3>BERDASARKAN TINGKAT PENDIDIKAN {!!strtoupper($tkpendid)!!}</h3>
</div><br>
<table border="1">
