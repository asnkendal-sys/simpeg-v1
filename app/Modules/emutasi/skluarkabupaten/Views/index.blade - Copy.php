                    ...
                    ?>
                        <tr>
                            <th class="text-left" colspan="6">
                                USULAN NO. : <?=$skluarkabupaten->nousul?>
                                ...
                                <div class="text-right">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            ...
                                            <li><a href="{!!url()!!}/emutasi/skluarkabupaten/cetak/pengantar_persetujuan/{!!$skluarkabupaten->nousul!!}" target="_blank" title="Cetak Surat Pengantar Persetujuan"><i class="fa fa-print"></i> Surat Pengantar Persetujuan</a></li>
                                            <li><a href="{!!url()!!}/emutasi/skluarkabupaten/cetak/lampiran_persetujuan/{!!$skluarkabupaten->nousul!!}" target="_blank" title="Cetak lampiran Menghadapkan"><i class="fa fa-list"></i> Lampiran Pengantar</a></li>
                                            @else
                                            <li><a href="javascript:void(0)" style="color: red" title="Surat Pengantar Persetujuan Sataus Belum Diproses"><i class="fa fa-print"></i> Surat Pengantar Persetujuan</a></li>
                                            <li><a href="javascript:void(0)" style="color: red" title="lampiran Menghadapkan Sataus Belum Diproses"><i class="fa fa-list"></i> Lampiran Pengantar</a></li>
                                            @endif
                                        </ul>
                                    </div>
                                    ...
                                    <div class="btn-group">
                                        <button data-toggle="dropdown" class="btn btn-default dropdown-toggle" type="button" aria-expanded="false">
                                            <span class="fa fa-print"></span> Menghadapkan
                                        </button>
                                        <ul class="dropdown-menu pull-right">
                                            @if(($skluarkabupaten->statususul == 1) or ($skluarkabupaten->statussk == 1))
                                            ...
                                            <li><a href="{!!url()!!}/emutasi/skluarkabupaten/cetak/lampiran_menghadapkan/{!!$skluarkabupaten->nousul!!}" target="_blank" title="Cetak Lampiran Menghadapkan"><i class="fa fa-list"></i> Lampiran Menghadapkan</a></li>
                                            @else
                                            ...
                                            <li><a href="javascript:void(0)" style="color: red" title="Lampiran Menghadapkan Sataus Belum Diproses"><i class="fa fa-list"></i> Lampiran Menghadapkan</a></li>
                                            @endif
                                        </ul>
                                    </div>
                                </div>
