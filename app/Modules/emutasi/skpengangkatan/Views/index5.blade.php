            ...
            <div class="box-body">
                <table class="table table-striped table-hover table-condensed table-bordered" id='tabel'>
                    ...
                    <tbody>
                                    ...
                                    <div class="text-right">
                                        @if(session::get('role_id')<=2)
                                            ...
                                            <button data-toggle="dropdown" class="btn btn-default dropdown-toggle" type="button" aria-expanded="false">
                                                <span class="fa fa-pencil"></span> <a href="javascript::void(0)" target="_blank" class="nokolektif" recnousul="#" act="nokolektif" title="No Kolektif">No Kolektif</a>
                                            </button>
                        ...
                        $arr[0]= "";
                        $n = 0;
                        $rows = \DB::table('tr_mutasi_pengangkatan')
                        ->select('idskpd')->groupBy('idskpd')->orderBy('idskpd','ASC')->get();
                        ?>
                        ...
                        <?php
                        $n++;
                        $arr[$n] = substr($skpengangkatan->idskpd, 0,2);
                        if($arr[$n]!=$arr[$n-1]){
                            ?>
                            <tr>
                                <th style="position:relative;" colspan="6">
                                ...
                                <th style="position:relative;" colspan="6">
                                    <div class="text-right">
                                        <!-- @if(session::get('role_id')<=2)
                                            ...
                                            <button data-toggle="dropdown" class="btn btn-default dropdown-toggle" type="button" aria-expanded="false">
                                                <span class="fa fa-pencil"></span> <a href="javascript::void(0)" target="_blank" class="nokolektif" recnousul="{!!$skpengangkatan->nousul!!}" act="nokolektif" title="No Kolektif">No Kolektif</a>
                                            </button>
                        ...
                        <tr>
                            ...
                            <td>{!!$skpengangkatan->nip!!}<br>{!!$skpengangkatan->namalengkap!!}
                                ...
                                <td><?php echo getSkpd(substr($skpengangkatan->idskpd, 0,2))."&nbsp".getSkpd(substr($skpengangkatan->idskpd, 3,5)); ?></td>

                                <td>{!!$skpengangkatan->jabatan!!}<br>{!!$skpengangkatan->tmtjbt!!}</td>
                                <td>{!!$skpengangkatan->skpdbaru!!}</td>
                        ...
                        <div class="box-footer clearfix">
                          <div class="row">
                              ...
                              <div class="col-sm-6">
                                  <?php echo $skpengangkatans->appends(array('search' => Input::get('search')))->render(); ?>
                              </div>
                          </div>
                      </div>
                      {!! Form::close() !!}
