...
<body>
  ...
  <?php
  $where = "tr_mutasi_dalam_daerah.nousul = \"".\Request::segment(5)."\"";
  ...
  <div id="F4-landscape">
    <table border="0" cellpadding="0" width="100%">
      <tr>
        <td><p><h3 align="center">DAFTAR NOMINATIF MUTASI ANTAR OPD</h3></p>
          <p><h3 align="center">PERIODE <?php echo strtoupper(formatTanggalPanjang($rs[0]->tglusul))?></h3></p>
        </td> 
      </tr>
    </table>
    <br>
  ...
  <script>
    $(document).ready(function(){
     $("#qrcode").qrcode({
      size    : 90,
      render  : "image",
      text    : "{!!url().'/digitalsign/mutasi/antaropd/pengantar/'.$item->nip.'/'.$item->nousul!!}"
    });
