                    ...
                    <div class="box-body">
                        <div class="col-md-12 data-awal">
                            ...
                            <div class="box-header with-border">
                                <b class="box-title"><small><i class="fa fa-fw fa-map-marker"></i> LOKASI KERJA</small></b>
                            </div>
                            </p>
                            <div class="form-group">
                                {!! Form::label('kdunit', 'Unit Kerja:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div class="form-control {!!$kdunit!!} kdunit">{{($item1->unitskpd!='')?$item1->unitskpd:'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('idskpd', 'Sub Unit Kerja:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div class="form-control {!!$idskpd!!} idskpd">{{($item1->skpd!='')?$item1->skpd:'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <p>
                            <div class="box-header with-border">
                                <b class="box-title"><small><i class="fa fa-street-view"></i> JABATAN TERAKHIR</small></b>
                            </div>
                            </p>
                            <div class="form-group">
                            ...
                            <p>
                            <div class="box-header with-border">
                                <b class="box-title"><small><i class="fa fa-fw fa-paper-plane-o"></i> CPNS</small></b>
                            </div>
                            </p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-control {!!$pejmencpn!!} pejmencpn">{{($item1->penetapcpn!='')?$item1->penetapcpn:'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('idgolrucpn', 'Golongan:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div class="form-control {!!$idgolrucpn!!} idgolrucpn">{{($item1->golrucpn!='')?$item1->golrucpn:'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('noskcpn', ' NO. SK:', array('class' => 'col-sm-3 control-label', 'placeholder'=> 'NO. SK')) !!}
                                <div class="col-sm-7">
                                    <div class="form-control {!!$noskcpn!!} noskcpn">{{($item1->noskcpn!='')?$item1->noskcpn:'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('tgskcpn', 'TGL. SK:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div class="form-control {!!$tgskcpn!!} tgskcpn">{{($item1->tgskcpn!='0000-00-00')?date('d-m-Y', strtotime($item1->tgskcpn)):'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('tmtcpn', ' TMT:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div class="form-control {!!$tmtcpn!!} tmtcpn">{{($item1->tmtcpn!='0000-00-00')?date('d-m-Y', strtotime($item1->tmtcpn)):'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('mkthncpn', 'Masa Kerja:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-2">
                                    <div class="form-control {!!$mkthncpn!!} mkthncpn">{{($item1->mkthncpn!='')?$item1->mkthncpn:'-'}}</div>
                                </div>
                                <div class="col-sm-1" style="margin-top: 7px;">
                                    Tahun
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-control {!!$mkblncpn!!} mkblncpn">{{($item1->mkblncpn!='')?$item1->mkblncpn:'-'}}</div>
                                </div>
                                <div class="col-sm-1" style="margin-top: 7px;">
                                    Bulan
                                </div>
                            ...
                            <p>
                            <div class="box-header with-border">
                                <b class="box-title"><small><i class="fa fa-fw fa-paper-plane-o"></i> PNS</small></b>
                            </div>
                            </p>
                            <div class="form-group">
                                {!! Form::label('pejmenpns', 'Pejabat Menetapkan:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div class="form-control {!!$pejmenpns!!} pejmenpns">{{($item1->penetappns!='')?$item1->penetappns:'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('idgolrupns', 'Golongan:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div class="form-control {!!$idgolrupns!!} idgolrupns">{{($item1->golrupns!='')?$item1->golrupns:'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('noskpns', ' NO. SK:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div class="form-control {!!$noskpns!!} noskpns">{{($item1->noskpns!='')?$item1->noskpns:'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('tgskpns', 'TGL. SK:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div class="form-control {!!$tgskpns!!} tgskpns">{{($item1->tgskpns!='0000-00-00')?date('d-m-Y', strtotime($item1->tgskpns)):'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('tmtpns', ' TMT:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div class="form-control {!!$tmtpns!!} tmtpns">{{($item1->tmtpns!='0000-00-00')?date('d-m-Y', strtotime($item1->tmtpns)):'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('mkthnpns', 'Masa Kerja:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-2">
                                    <div class="form-control {!!$mkthnpns!!} mkthnpns">{{($item1->mkthnpns!='')?$item1->mkthnpns:'-'}}</div>
                                </div>
                                <div class="col-sm-1" style="margin-top: 7px;">
                                    Tahun
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-control {!!$mkblnpns!!} mkblnpns">{{($item1->mkblnpns!='')?$item1->mkblnpns:'-'}}</div>
                                </div>
                                <div class="col-sm-1" style="margin-top: 7px;">
                                    Bulan
                                </div>
                            ...
                            <p>
                            <div class="box-header with-border">
                                <b class="box-title"><small><i class="fa fa-fw fa-anchor"></i> PANGKAT TERAKHIR</small></b>
                            </div>
                            </p>
                            ...
                            <p>
                            <div class="box-header with-border">
                                <b class="box-title"><small><i class="fa fa-fw fa-money"></i> KGB TERAKHIR</small></b>
                            </div>
                            </p>
                            ...
                            <p>
                            <div class="box-header with-border">
                                <b class="box-title"><small><i class="fa fa-fw fa-graduation-cap"></i> PENDIDIKAN AWAL</small></b>
                            </div>
                            </p>
                            ...
                            <p>
                            <div class="box-header with-border">
                                <b class="box-title"><small><i class="fa fa-fw fa-graduation-cap"></i> PENDIDIKAN AKHIR</small></b>
                            </div>
                            </p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-control">{{($item1->idtkpendid!='')?$item1->idtkpendid:'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('idjenjurusan', 'Jurusan:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div class="form-control">{{($item1->idjenjurusan!='')?$item1->idjenjurusan:'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <span class="{!!(session('role_id') > 3)?'div-disabled':''!!}">
                            ...
                            <span class="div-disabled">
                                <div class="form-group">
                                    {!! Form::label('kdunit', 'Unit Kerja:', array('class' => 'col-sm-3 control-label')) !!}
                                    <div class="col-sm-7">
                                        <div style="width: auto;" class="{!!$kdunit!!} kdunit">
                                            {!! comboSkpdunit("kdunit","","") !!}
                                        </div>
                                    </div>
                                    @if($item1->kdunit!=$item2->kdunit)
                                        <div class="col-sm-1">
                                            <a href="javascript:void(0)" title="Verifikasi Unit Kerja" valupdate="kdunit" class="kdunit ver-perubahan"><i class="fa fa-check"></i></a>
                                        </div>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    @if($item1->idskpd!=$item2->idskpd)
                                        <div class="col-sm-1">
                                            <a href="javascript:void(0)" title="Verifikasi Sub Unit Kerja" valupdate="idskpd" class="idskpd ver-perubahan"><i class="fa fa-check"></i></a>
                                        </div>
                                    @endif
                                </div>
                            </span>
                            ...
                            <span class="div-disabled">
                                ...
                                <div class="form-group">
                                    {!! Form::label('tmtjbt', 'TMT Jab:', array('class' => 'col-sm-3 control-label')) !!}
                                    <div class="col-sm-7">
                                        {!! Form::text('tmtjbt', null, array('class'=> 'form-control', 'placeholder'=> 'dd-mm-yyyy')) !!}
                                    </div>
                                </div>
                            </span>
                            ...
                            <div class="form-group">
                                {!! Form::label('pejmencpn', 'Pejabat Menetapkan:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div style="width: auto;" class="{!!$pejmencpn!!} pejmencpn">
                                        {!! comboPenetapsk("pejmencpn","","") !!}
                                    </div>
                                </div>
                                @if($item1->pejmencpn!=$item2->pejmencpn)
                                    <div class="col-sm-1">
                                        <a href="javascript:void(0)" title="Verifikasi Pejabat Menetapkan CPNS" valupdate="pejmencpn" class="pejmencpn ver-perubahan"><i class="fa fa-check"></i></a>
                                    </div>
                                @endif
                            </div>
                            <div class="form-group">
                                {!! Form::label('idgolrucpn', 'Golongan:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div style="width: auto;" class="{!!$idgolrucpn!!} idgolrucpn">
                                        {!! comboGolru("idgolrucpn","","") !!}
                                    </div>
                                </div>
                                @if($item1->idgolrucpn!=$item2->idgolrucpn)
                                    <div class="col-sm-1">
                                        <a href="javascript:void(0)" title="Verifikasi Golongan CPNS" valupdate="idgolrucpn" class="idgolrucpn ver-perubahan"><i class="fa fa-check"></i></a>
                                    </div>
                                @endif
                            </div>
                            <div class="form-group">
                                {!! Form::label('noskcpn', ' NO. SK:', array('class' => 'col-sm-3 control-label', 'placeholder'=> 'NO. SK')) !!}
                                <div class="col-sm-7">
                                    {!! Form::text('noskcpn', null, array('class'=> 'form-control '.$noskcpn, 'placeholder'=> 'NO. SK')) !!}
                                </div>
                                @if($item1->noskcpn!=$item2->noskcpn)
                                    <div class="col-sm-1">
                                        <a href="javascript:void(0)" title="Verifikasi NO. SK CPNS" valupdate="noskcpn" class="noskcpn ver-perubahan"><i class="fa fa-check"></i></a>
                                    </div>
                                @endif
                            </div>
                            <div class="form-group">
                                {!! Form::label('tgskcpn', 'TGL. SK:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    {!! Form::text('tgskcpn', null, array('class'=> 'form-control date '.$tgskcpn, 'placeholder'=> 'dd-mm-yyyy')) !!}
                                </div>
                                @if($item1->tgskcpn!=$item2->tgskcpn)
                                    <div class="col-sm-1">
                                        <a href="javascript:void(0)" title="Verifikasi TGL. SK CPNS" valupdate="tgskcpn" class="tgskcpn ver-perubahan"><i class="fa fa-check"></i></a>
                                    </div>
                                @endif
                            </div>
                            <div class="form-group">
                                {!! Form::label('tmtcpn', ' TMT:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    {!! Form::text('tmtcpn', null, array('class'=> 'form-control date '.$tmtcpn, 'placeholder'=> 'dd-mm-yyyy')) !!}
                                </div>
                                @if($item1->tmtcpn!=$item2->tmtcpn)
                                    <div class="col-sm-1">
                                        <a href="javascript:void(0)" title="Verifikasi TMT CPNS" valupdate="tmtcpn" class="tmtcpn ver-perubahan"><i class="fa fa-check"></i></a>
                                    </div>
                                @endif
                            </div>
                            <div class="form-group">
                                {!! Form::label('mkthncpn', 'Masa Kerja:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-2">
                                    {!! Form::text('mkthncpn', null, array('class'=> 'form-control num '.$mkthncpn, 'maxlength'=> '2', 'placeholder'=> '00')) !!}
                                </div>
                                <div class="col-sm-1" style="margin-top: 7px; padding: 0px">
                                    @if($item1->mkthncpn!=$item2->mkthncpn)
                                        <a href="javascript:void(0)" title="Verifikasi masa kerja tahun CPNS" valupdate="mkthncpn" class="mkthncpn ver-perubahan"><i class="fa fa-check"></i></a>
                                    @endif
                                    THN
                                </div>
                                <div class="col-sm-2">
                                    {!! Form::text('mkblncpn', null, array('class'=> 'form-control num '.$mkblncpn, 'id'=> 'mkblncpn', 'maxlength'=> '2', 'placeholder'=> '00')) !!}
                                </div>
                                <div class="col-sm-1" style="margin-top: 7px; padding: 0px">
                                    @if($item1->mkblncpn!=$item2->mkblncpn)
                                        <a href="javascript:void(0)" title="Verifikasi masa kerja bulan CPNS" valupdate="mkblncpn" class="mkblncpn ver-perubahan"><i class="fa fa-check"></i></a>
                                    @endif
                                    BLN
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                {!! Form::label('pejmenpns', 'Pejabat Menetapkan:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div style="width: auto;" class="{!!$pejmenpns!!} pejmenpns">
                                        {!! comboPenetapsk("pejmenpns","","") !!}
                                    </div>
                                </div>
                                @if($item1->pejmenpns!=$item2->pejmenpns)
                                    <div class="col-sm-1">
                                        <a href="javascript:void(0)" title="Verifikasi Pejabat Menetapkan PNS" valupdate="pejmenpns" class="pejmenpns ver-perubahan"><i class="fa fa-check"></i></a>
                                    </div>
                                @endif
                            </div>
                            <div class="form-group">
                                {!! Form::label('idgolrupns', 'Golongan:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div style="width: auto;" class="{!!$idgolrupns!!} idgolrupns">
                                        {!! comboGolru("idgolrupns","","") !!}
                                    </div>
                                </div>
                                @if($item1->idgolrupns!=$item2->idgolrupns)
                                    <div class="col-sm-1">
                                        <a href="javascript:void(0)" title="Verifikasi Golongan PNS" valupdate="idgolrupns" class="idgolrupns ver-perubahan"><i class="fa fa-check"></i></a>
                                    </div>
                                @endif
                            </div>
                            <div class="form-group">
                                {!! Form::label('noskpns', ' NO. SK:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    {!! Form::text('noskpns', null, array('class'=> 'form-control '.$noskpns, 'placeholder'=> 'NO. SK')) !!}
                                </div>
                                @if($item1->noskpns!=$item2->noskpns)
                                    <div class="col-sm-1">
                                        <a href="javascript:void(0)" title="Verifikasi NO. SK PNS" valupdate="noskpns" class="noskpns ver-perubahan"><i class="fa fa-check"></i></a>
                                    </div>
                                @endif
                            </div>
                            <div class="form-group">
                                {!! Form::label('tgskpns', 'TGL. SK:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    {!! Form::text('tgskpns', null, array('class'=> 'form-control date '.$tgskpns, 'placeholder'=> 'dd-mm-yyyy')) !!}
                                </div>
                                @if($item1->tgskpns!=$item2->tgskpns)
                                    <div class="col-sm-1">
                                        <a href="javascript:void(0)" title="Verifikasi TGL. SK PNS" valupdate="tgskpns" class="tgskpns ver-perubahan"><i class="fa fa-check"></i></a>
                                    </div>
                                @endif
                            </div>
                            <div class="form-group">
                                {!! Form::label('tmtpns', ' TMT:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    {!! Form::text('tmtpns', null, array('class'=> 'form-control date '.$tmtpns, 'placeholder'=> 'dd-mm-yyyy')) !!}
                                </div>
                                @if($item1->tmtpns!=$item2->tmtpns)
                                    <div class="col-sm-1">
                                        <a href="javascript:void(0)" title="Verifikasi TMT PNS" valupdate="tmtpns" class="tmtpns ver-perubahan"><i class="fa fa-check"></i></a>
                                    </div>
                                @endif
                            </div>
                            <div class="form-group">
                                {!! Form::label('mkthnpns', 'Masa Kerja:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-2">
                                    {!! Form::text('mkthnpns', null, array('class'=> 'form-control num '.$mkthnpns, 'maxlength'=> '2', 'placeholder'=> '00')) !!}
                                </div>
                                <div class="col-sm-1" style="margin-top: 7px; padding: 0px">
                                    @if($item1->mkthnpns!=$item2->mkthnpns)
                                        <a href="javascript:void(0)" title="Verifikasi masa kerja tahun PNS" valupdate="mkthnpns" class="mkthnpns ver-perubahan"><i class="fa fa-check"></i></a>
                                    @endif
                                    THN
                                </div>
                                <div class="col-sm-2">
                                    {!! Form::text('mkblnpns', null, array('class'=> 'form-control num '.$mkblnpns, 'id'=> 'mkblnpns', 'maxlength'=> '2', 'placeholder'=> '00')) !!}
                                </div>
                                <div class="col-sm-1" style="margin-top: 7px; padding: 0px">
                                    @if($item1->mkblnpns!=$item2->mkblnpns)
                                        <a href="javascript:void(0)" title="Verifikasi masa kerja bulan PNS" valupdate="mkblnpns" class="mkblnpns ver-perubahan"><i class="fa fa-check"></i></a>
                                    @endif
                                    BLN
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                {!! Form::label('password', 'Password:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    {!! Form::text('password', null, array('class'=> 'form-control '.$password, 'placeholder'=> 'Password login pegawai')) !!}
                                </div>
                                @if($item1->password!=$item2->password)
                                <div class="col-sm-1">
                                    <a href="javascript:void(0)" title="Verifikasi Password" valupdate="password" class="password ver-perubahan"><i class="fa fa-check"></i></a>
                                </div>
                                @endif
                            </div>-->
                        </span>
    ...
    function perubahanBiodata(){
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                var arraytext = new Array("skpdunit","ketpermohonan","stspermohonan");
                ...
                if(ret){
                    ...
                    $(".data-perubahan").find('#tmlhr, #idskpd, #idjabjbt, #idjabfung, #idjabfungum, #idjenjurusanawal, #idjenjurusan, #idmatkulpel').data('select2').trigger('select', {
                        data: {"id":"","text":""}
                    });
