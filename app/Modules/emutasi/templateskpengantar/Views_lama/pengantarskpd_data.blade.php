...
<script type="text/javascript">
    ...
    <?php if(session('role_id') <= 3){?>
        ...
        $('#pengantarskpd #idskpd').change(function(){
    ...
    <?php } ?>
        ...
        $('#pengantarskpd #defaultthem').click(function(){
            $.ajax({
                type : 'post',
                url: '{!!url()!!}/emutasi/templateskpengantar/surat',
                data: {'idskpd':'all', 'jnssurat': '2.1', '_token': '{!!csrf_token()!!}'},
                beforeSend:function(){
                    preloader.on();
                },
                success:function(response){
        ...
        <div class="span12">
            <div class="accordion-heading">
                <div class="control-group">
                    ...
                    @endif
                        <input type="hidden" name="jnssurat" class="jnssurat" id="jnssurat" value="2.1">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="nama" class="nama input-xxlarge form-control" id="nama" value="<?php echo TemplateskpengantarModel::getTemplate('all', '2.1','nama')?>">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea rows="10" cols="600" name="template" class="ckeditor" id="template" placeholder="Template Surat Perintah">
                            <?php
                            if(TemplateskpengantarModel::getTemplate(session('idskpd'), '2.1','template')=='0'){
                                echo TemplateskpengantarModel::getTemplate('all', '2.1','template');
                            }else{
                                echo TemplateskpengantarModel::getTemplate(session('idskpd'), '2.1','template');
                            }
                            ?>
                        </textarea>
                    </div>
