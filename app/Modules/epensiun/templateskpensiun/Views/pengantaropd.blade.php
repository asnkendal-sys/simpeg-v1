        ...
        <!-- <div class="box-header with-border">
            ...
            <div class="col-md-12">
                <ul class="nav nav-tabs tab1" id="myTab">
                    ...
                    <li class="active"><a href="{!!url()!!}/epensiun/templateskpensiun/pengantaropd"> <i class="fa fa-fw fa-list-ul"></i> PENGANTAR OPD</a></li>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                ?>
                                <input type="hidden" name="jenis" class="jenis" id="jenis" value="5">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea rows="10" cols="600" name="template" class="ckeditor form-control" id="template" placeholder="Template Kenaikan Gaji Berkala">
                                    <?php
                                    $cek = TemplateskpensiunModel::getTemplate(session('idskpd'), 5);

                                    if(empty($cek)){
                                        echo  TemplateskpensiunModel::getTemplate('all', 5);
                                    }else{
                                        echo $cek;
                                    }
                                    ?>
