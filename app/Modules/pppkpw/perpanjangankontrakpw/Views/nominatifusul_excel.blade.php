     ...
     <Worksheet ss:Name=\"Sheet1\">
      <Table ss:ExpandedColumnCount=\"13000000\" ss:ExpandedRowCount=\"6000000\" x:FullColumns=\"1\"
       ...
       <Row ss:AutoFitHeight=\"0\">
        <Cell ss:MergeAcross=\"12\" ss:StyleID=\"s64\"><Data ss:Type=\"String\">NOMINATIF PERPANJANGAN KONTRAK PEGAWAI PPPK PW</Data></Cell>
       </Row>
       <Row ss:AutoFitHeight=\"0\">
       ...
       <Row ss:Index=\"4\" ss:AutoFitHeight=\"0\" ss:Height=\"29.25\">
		...
		<Cell ss:StyleID=\"s73\"><Data ss:Type=\"String\">SELISIH AKHIR KONTRAK SAMPAI BUP</Data></Cell>
            ...
            <Cell ss:StyleID=\"s73\"><Data ss:Type=\"String\">WAKTU</Data></Cell>
            <Cell ss:StyleID=\"s73\"><Data ss:Type=\"String\">AWAL PERPANJANGAN</Data></Cell>
            <Cell ss:StyleID=\"s73\"><Data ss:Type=\"String\">AKHIR PERPANJANGAN</Data></Cell>
      </Row> 
      ...
      $w.="<Row ss:Height=\"33.75\">
		...
		<Cell ss:StyleID=\"s84\"><Data ss:Type=\"String\">".$hasil->y." Tahun ".(($hasil->y > 0)?$hasil->m:$item->selisih_bulankerja)." Bulan</Data></Cell>";
            if($item->selisih_bulankerja>0){                  
                  if($tahun_penjagaan >= 5){
                        $tahun = $tahun_penjagaan;
                  }else{
                        if($item->selisih_bulankerja >= 12){
                              if($item->selisih_bulankerja > 12){
                                    $tahun = $tahun_penjagaan + 1;
                              }else{
                                    $tahun = $tahun_penjagaan;
                              }
                        }else if($item->selisih_bulankerja > 0){
                  ...
                  if($tahun_penjagaan >= 5){
                        ...
                        if($item->selisih_bulankerja >= 12){
                              $bulan = 0; //$item->selisih_bulankerja%12;
                        }else if($item->selisih_bulankerja > 0){
                              $bulan = 0;
                        }else{
                              $bulan = 0;
	      ...
	      $w.="
                  <Cell ss:StyleID=\"s84\"><Data ss:Type=\"String\">".$tahun." TAHUN | ".$bulan." BULAN</Data></Cell>
                  <Cell ss:StyleID=\"s84\"><Data ss:Type=\"String\">".$tmtmulai_pppk."</Data></Cell>
                  <Cell ss:StyleID=\"s84\"><Data ss:Type=\"String\">".$tmtakhir_pppk."</Data></Cell>
            ";
            }else{
            $w.="                  
                  <Cell ss:MergeAcross=\"2\" ss:StyleID=\"m2376916008652\"><Data ss:Type=\"String\">Diusulkan untuk pemberhentian Batas Usia Pensiun</Data></Cell>
            ";
            }
       $w.="</Row>";
