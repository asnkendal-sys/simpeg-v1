...
function getIdEselon($eselon) 
{
    return (int)\DB::table('a_esl')->where('esl', $eselon)->first()->idesl;
}
function getJabatanIdSapk($idjenjab, $id)
{
    if ($idjenjab == 1) {
        $unorid = \DB::table('a_skpd')->where('idskpd', $id)->first()->idsapk;
    } elseif ($idjenjab == 2) {
        $unorid = \DB::table('a_jabfung')->where('idjabfung', $id)->first()->idsapk;
    } else {
        $unorid = \DB::table('a_jabfungum')->where('idjabfungum', $id)->first()->idsapk;
    }
    return $unorid;
}
...
function getUnOrId($id) 
{
    return \DB::table("a_skpd")->where("idskpd", "$id")->first()->idsapk;
...
{
    switch ($idjenis) {
        case 1: $ket = "<i class='glyphicon glyphicon-plus-sign' title='Permohonan Baru'></i>&nbsp;Permohonan&nbsp;Baru"; break;
        case 2: $ket = "<i class='glyphicon glyphicon-info-sign' title='Permohonan Update'></i>&nbsp;Permohonan&nbsp;Edit"; break;
        case 3: $ket = "<i class='glyphicon glyphicon-remove-sign' title='Permohonan Delete'></i>&nbsp;Permohonan&nbsp;Hapus"; break;
        default: $ket = "-";
    }
...
function Hitanakkandung($nip, $tmtcpn)
{
