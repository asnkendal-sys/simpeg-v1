...
<div class="row" style="padding-left: 35px;">
    <div class="span12">
        <form id="form2" name="form2" class="form-horizontal" action="{!!url()!!}/emutasi/nominatifpengangkatan/cetak/pengantar" target="_blank" class="" method="post" enctype="multipart/form-data">
            {!!csrf_field()!!}
