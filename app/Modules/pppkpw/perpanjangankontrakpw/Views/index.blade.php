        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-tabs tab1" id="myTab">
                    <li class="active"><a href="{!!url()!!}/pppkpw/perpanjangankontrakpw"> <i class="fa fa-fw fa-list-ul"></i> PENJAGAAN PERPANJANGAN PPPKPW</a></li>                    
                    <li class=""><a href="{!!url()!!}/pppkpw/perpanjangankontrakpw/indexnominatif"> <i class="fa fa-fw fa-list-ul"></i> PENETAPAN PERPANJANGAN PPPKPW</a></li>                    
                </ul>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#prev-nominatif').on('click', function(e){
            e.preventDefault();
            $.ajax({
                url : '{!!url()!!}/pppkpw/perpanjangankontrakpw/data/nominatif',
                type : 'post',
        ...
        $('#cetak-nominatif').on('click', function(e){
            e.preventDefault();
            $('#nominatif-pegawai').attr("action", "{!!url()!!}/pppkpw/perpanjangankontrakpw/print/nominatif");
            $('#nominatif-pegawai').submit();
        });

        $('#excel-nominatif').on('click', function(e){
            e.preventDefault();
            $('#nominatif-pegawai').attr("action", "{!!url()!!}/pppkpw/perpanjangankontrakpw/excel/nominatif");
            $('#nominatif-pegawai').submit();
            /*cetak_excel('result');*/
        });
    });
