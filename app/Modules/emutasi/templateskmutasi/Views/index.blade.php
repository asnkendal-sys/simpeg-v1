		...
		<div class="table-responsive">
			<div class="box-body nav-tabs-custom">
				...
				<ul class="nav nav-tabs" id="myTab">
					...
					<li class=""><a href="#perintahfungsional" data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil"></i> Surat Perintah Fungsional</a></li>
				...
				<div class="tab-content">
					...
					<div class="tab-pane" id="perintahfungsional"></div>
...
<script>
	...
	function getPerintahfungsional() {
		xhr.abort();
		$.ajax({
			type: 'post',
			url: '{!!url()!!}/emutasi/templateskmutasi/data/perintahfungsional',
			data: {
				'_token': '{!!csrf_token()!!}'
			},
			beforeSend: function() {
			...
			success: function(response) {
				preloader.off();
				$('#perintahfungsional').html(response);
			}
		});
	}
