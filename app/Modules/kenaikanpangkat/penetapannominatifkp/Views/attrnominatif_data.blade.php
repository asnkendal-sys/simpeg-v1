<?php
    ...
    $row = \App\Modules\kenaikanpangkat\penetapannominatifkp\Models\PenetapannominatifkpModel::where('nousul', $nousul)->first();
...
<div class="row" style="padding-left: 35px;">
    <div class="span12">
        <form id="form2" name="form2" class="form-horizontal" action="{!!url()!!}/kenaikanpangkat/penetapannominatifkp/cetak/nominatif" target="_blank" class="" method="post" enctype="multipart/form-data">
            {!!csrf_field()!!}
