    ...
    $(document).ready(function(){
        ...
        <?php if(session('role_id') <= 3){?>
            ...
            $('#pengantarskpd #idskpd').on('change', function(e){
                ...
                var jnskp = $('#pengantarskpd #jnskp').val();

                $.ajax({
                    type : 'post',
                    url : '{!!url()!!}/kenaikanpangkat/templatekenaikanpangkat/surat',
                    data: {'idskpd':idskpd, 'jnskp': jnskp, '_token': '<?php echo csrf_token()?>'},
                    beforeSend:function(){
                        preloader.on();
                    },
        ...
        $('#pengantarskpd #defaultthem').on('click', function(e){
            ...
            $.ajax({
                type : 'post',
                url : '{!!url()!!}/kenaikanpangkat/templatekenaikanpangkat/surat',
                data: {'idskpd':'all', 'jnskp': '3', '_token': '{!!csrf_token()!!}'},
                beforeSend:function(){
                    preloader.on();
                },
                success:function(response){
            ...
            <div class="accordion-heading">
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <input type="hidden" name="jnskp" class="jnskp" id="jnskp" value="3">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea rows="10" cols="600" name="template" class="ckeditor" id="template" placeholder="Template Surat Perintah">
                            <?php
                                if(TemplatekenaikanpangkatModel::getTemplate(session('idskpd'), '3','template')=='0'){
                                    echo TemplatekenaikanpangkatModel::getTemplate('all', '3','template');
                                }else{
                                    echo TemplatekenaikanpangkatModel::getTemplate(session('idskpd'), '3','template');
                                }
                            ?>
                        </textarea>
                    </div>
