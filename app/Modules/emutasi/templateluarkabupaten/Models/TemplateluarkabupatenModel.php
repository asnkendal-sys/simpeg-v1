<?php namespace App\Modules\emutasi\templateluarkabupaten\Models;
use Illuminate\Database\Eloquent\Model;


/**
* Templateluarkabupaten Model
...
class TemplateluarkabupatenModel extends Model {
	...
	public static function all($columns = array('*')){
		$instance = new static;
		if (\PermissionsLibrary::hasPermission('mod-templateluarkabupaten-listall')){
    ...
    public static function attrPengantarsk($idskpd, $field){
        $rs = \DB::table('tb_01 as a')
            ->select('a.nip','a.idskpd', 'a.idjenjab', 'a.idjabjbt', 'b.skpd', 'b.jab', 'c.golru', 'c.pangkat',
            \DB::raw("CONCAT(a.gdp,IF(LENGTH(a.gdp)>0,' ',''),a.nama,IF(LENGTH(a.gdb)>0,', ',''),a.gdb) AS nama")
        )
