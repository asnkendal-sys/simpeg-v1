            ...
            <td align="right">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right">
                        ...
                        <li><a class="text-info kelolafile" recid="{!!$item->id!!}" jns="Diklat Fungsional {!!$item->dikfung!!}" href="javascript:void(0)" ><i class="fa fa-file-o"></i> Kelola File</a></li>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#rdikfung a.kelolafile').on('click',function(e){
            e.preventDefault();
            claravel_modal('Kelola File Riwayat Diklat Fungsional','Loading...','kelola_file');
            var id = $(this).attr('recid');
            var nama_jenis = $(this).attr('jns');
            $.ajax({
                type:'post',
                url : '{!!url()!!}/epersonal/biodata/kelolafile',
                data: {'nip': '{!!$nip!!}', 'jenis': 10, 'subjenis': id, 'nama_jenis':nama_jenis, 'tb': 'r_gol', '_token' : '{!!csrf_token()!!}'},
        ...
        $('#rdikfung a.edit').on('click',function(e){
            e.preventDefault();
            ...
            $.ajax({
                ...
                data: {'nip': $('#nip').val(), 'id': id, 'flag':2, 'tb': 'r_dikfung', '_token' : '{!!csrf_token()!!}'},
                success:function(html){
        ...
        $('#rdikfung a.editpermohonan').on('click',function(e){
            e.preventDefault();
            claravel_modal('Riwayat Riwayat Diklat Fungsional','Loading...','main_modal');
            var id = $(this).attr('recid');
            $.ajax({
                type:'post',
                url : '{!!url()!!}/epersonal/biodata/data/rdikfung_form',
                data: {'nip': $('#nip').val(), 'id': id, 'flag':2, 'tb': 'r_dikfung_temp', '_token' : '{!!csrf_token()!!}'},
                success:function(html){
                    $('#main_modal .modal-body').html(html);
                }
            });
        ...
        $('#rdikfung a.hapusmin').on('click',function(e){
            e.preventDefault();
            claravel_modal('Riwayat Diklat Fungsional','Loading...','main_modal');
            var id = $(this).attr('recid');
            $.ajax({
                type:'post',
                url : '{!!url()!!}/epersonal/biodata/data/rdikfung_form',
                data: {'nip': $('#nip').val(), 'id': id, 'flag':3, 'tb': 'r_dikfung', '_token' : '{!!csrf_token()!!}'},
                success:function(html){
                    $('#main_modal .modal-body').html(html);
                }
            });
        ...
        $('#rdikfung a.hapus').on('click',function(e){
            e.preventDefault();
            var id = $(this).attr('recid');
        ...
        $('#rdikfung a.hapuspermohonan').on('click',function(e){
            e.preventDefault();
            var id = $(this).attr('recid');
            bootbox.confirm('Hapus?',function(a){
                if(a == true){
                    $.ajax({
                        type:'post',
                        url : '{!!url()!!}/epersonal/biodata/delriwayat',
                        data: {'nip': $('#nip').val(), 'id': id, 'flag':3, 'tb':'r_dikfung_temp', '_token' : '{!!csrf_token()!!}'},
                        beforeSend: function(){
                            preloader.on();
                        },
                        success:function(html){
        ...
        $('#rdikfung a.sinkronsiasn').on('click',function(e){
            e.preventDefault();
            claravel_modal('Sinkronisai SIASN','Loading...','main_modal2');
            var id = $(this).attr('recid');
            var iddikfungbkn = $(this).attr('idbkn');
            $.ajax({
                type:'post',
                url : '{!!url()!!}/sinkronsiasn/rdikfung_sinkronsiasn_form',
                data: {'nip': $('#nip').val(), 'id': id, 'iddikfungbkn': iddikfungbkn, 'flag':2, '_token' : '{!!csrf_token()!!}'},
                success:function(html){
        ...
        $('#rdikfung a.prevsinkronsiasn').on('click',function(e){
            e.preventDefault();
            claravel_modal('Preview Data Diklat Fungsional SIASN','Loading...','main_modal2');
            var id = '';
            var iddikfungbkn = '';
            $.ajax({
                type:'post',
