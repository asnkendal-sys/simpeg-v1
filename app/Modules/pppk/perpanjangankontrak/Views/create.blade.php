...
<section class="content-header" style="margin-bottom: 0 !important;">
    <h1>
        Perpanjangan Kontrak PPPK<small></small>
    </h1>
    <ol class="breadcrumb">
                        ...
                        <div class="col-md-12">
                            <div class="callout callout-success">
                                ...
                                <ul style="padding-left: 15px">
                                    ...
                                    <li>Pastikan data nominatif yang akan diusulkan sudah memiliki berkas PPPK dan Kinerja 2 tahun terakhir</li>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#nominatif-pegawai').on('submit',function(e){
            ...
            if($this.validationEngine('validate')){
                bootbox.confirm('Simpan data?',function(a){
                    if (a == true){
                        $.ajax({
                            url : '{!!url()!!}/pppk/perpanjangankontrak/create',
                            type : 'POST',
                            data : $this.serialize(),
                            beforeSend: function(){
                                preloader.on();
        ...
        $('#prev-nominatif').on('click', function(e){
            ...
            if(tahun){
                $.ajax({
                    url : '{!!url()!!}/pppk/perpanjangankontrak/data/nominatif_perpanjangan',
                    type : 'post',
        ...
        $('#cetak-nominatif').on('click', function(e){            
            ...
            if(tahun){
                ...
                let url = '{!!url()!!}/pppk/perpanjangankontrak/print/nominatifusul';
        ...
        $('#excel-nominatif').on('click', function(e){
            ...
            if(tahun){
                let form = $('#nominatif-pegawai');
                let url = '{!!url()!!}/pppk/perpanjangankontrak/excel/nominatifusul';
