<html>
<head>
<title>{!!ucfirsts(getUtility('alias_aplikasi'))!!} Nominatif Pegawai</title>
...
if (Input::get('idisesl') != '') {
    ...
    $rs = \DB::table('tb_01')
        ->select('tb_01.*','z.skpd','a_golruang.golru','a_golruang.pangkat','a_skpd.path_short','a_skpd.skpd as sub_unit','a_esl.esl','a_tkpendid.tkpendid','a_jenjurusan.jenjurusan','a_jenjab.jenjab',
