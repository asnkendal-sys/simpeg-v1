<html>
<head>
<title>{!!ucfirsts(getUtility('alias_aplikasi'))!!} Statistik Jenis Kelamin Golongan</title>
...
<?php
    $where = " tb_01.idjenkedudupeg not in (99,21) and tb_01.idjenkel='".Input::get('idjenkel')."' and tb_01.idstspeg in (".Input::get('idstspeg').")";
...
<h3>BERDASARKAN BERDASARKAN JENIS KELAMIN {!!$jenkel!!}</h3>
</div><br>
    <table border="1">
