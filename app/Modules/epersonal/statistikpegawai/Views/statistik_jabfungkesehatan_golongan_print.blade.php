...
<?php
    ...
    $where = " tb_01.idjenkedudupeg not in (99,21) and tb_01.idjenjab = 2 and a_jabfung.isguru = '2' and tb_01.idstspeg in (".Input::get('idstspeg').")";
    $skpd = getSkpd(Input::get('idskpd'));
    $golru = getAttr('a_golruang', 'idgolru', Input::get('idgolru'), 'golru');
    $kesehatan = getAttr('a_jabfung', 'tingkat', Input::get('idtingkat'), 'jabfung2');
...
<h3>BERDASARKAN JABATAN FUNGSIONAL KESEHATAN {!! strtoupper($kesehatan) !!}</h3>
</div><br>
    <table border="1">
