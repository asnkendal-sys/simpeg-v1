<form id="form-edit" class="form-horizontal" method="POST" action="{!!url()!!}/pppk/perpanjangankontrak/verifikasipppk" accept-charset="UTF-8">
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="box box-warning">
                ...
                <div class="box-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php
                                $x = 0;                                
                                $rs = callApi('get', 'https://simpeg.kendalkab.go.id/efile/dokumenpersyaratan?id=42&nip='.Input::get('nip'));                                
                            ?>
            ...
            <div class="col-md-6 data-attribut">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-fw fa-paper-plane-o"></i> VERIFIKASI PERPANJANGAN PPPK </h3>
                </div>
                ...
                @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls col-sm-7">
                            <?php
                                $item = \DB::table('tr_pppk')->where('idpppk', Input::get('idpppk'))->where('sts_kontrak', 2)->where('nip',Input::get('nip'))->first();
