...
<head>
    ...
    <title>Lampiran SK Mutasi Dalam OPD</title>
...
<body>
    ...
    $where .= "and tr_mutasi_dalam_skpd.nousul = \"".Input::get('nousul')."\"";
    ...
    ->select('tr_mutasi_dalam_skpd.*')->whereRaw($where)->first();
        ...
        <table class="table" border="0" cellpadding="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th colspan="2" width="30%">JABATAN</th>
