...
<head>
    ...
    <title>SK Petikan Perpanjangan Kontrak PPPK PW TEST</title>
...
echo $idpppk;
echo $idpppk;
        $item = \PerpanjangankontrakpwModel::getNominatifver($idpppk, $nip);
        ...
        $template = \App\Models\PPPKPW\TemplateSurat::where('jnssurat','=',7)->first();
