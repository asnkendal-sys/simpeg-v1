            ...
            <p>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-left">
                        {!! NominatifpensiunModel::btnCreatebup('BUP',1,Session::get('user_id')) !!}
                        {!! NominatifpensiunModel::btnCreatebup('NON BUP',1,Session::get('user_id')) !!}
                    </ul>
                </div>
            </p>
            ...
            <div class="box-body no-padding">
                <table class="table table-striped table-hover table-condensed table-bordered" id='tabel'>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <div class="btn-group">
                                            <button data-toggle="dropdown" class="btn btn-success dropdown-toggle" type="button" aria-expanded="false">
                                                ...
                                                <a href="javascript:void(0)" rectmtpens="{!!$nominatifpensiun->tmtpens!!}" recidskpd="{!!((Input::get('idskpd')!='')?Input::get('idskpd'):substr($nominatifpensiun->idskpd,0,2))!!}" class="attrpengantaropd btn-success" title="Input Surat Pengantar"> Pengantar OPD</a>
                                            </button>
                                                <!-- <a href="{!!url()!!}/epensiun/nominatifpensiun/cetaknominatif/{!!$nominatifpensiun->tmtpens!!}/{!!((Input::get('idskpd')!='')?Input::get('idskpd'):substr($nominatifpensiun->idskpd,0,2))!!}" class="attrnominatif btn-default" act="nominatif" title="Cetak Daftar Nominatif" target="_blank"><i class="fa fa-print"/></i> Data Nominatif</a> -->
                                        </div>
                                        @if(session('role_id') < 3)
                                            <!-- <div class="btn btn-success">
                                                <input type="checkbox" name="iscetaksk" class="iscetaksk" value="1" rectmtpens="{!!$nominatifpensiun->tmtpens!!}" recidskpd="{!!((Input::get('idskpd')!='')?Input::get('idskpd'):substr($nominatifpensiun->idskpd,0,2))!!}" {!!($nominatifpensiun->iscetaksk==1)?'checked':''!!}> Sudah Cetak DPCP
                                            </div> -->
                                        @endif
                                        <!-- &nbsp;<a href="{!!url()!!}/epensiun/nominatifpensiun/cetakskkolektif/{!!$nominatifpensiun->tmtpens!!}/{!!((Input::get('idskpd')!='')?Input::get('idskpd'):substr($nominatifpensiun->idskpd,0,2))!!}" class="attrpengantar btn btn-success" act="pengantar" title="Cetak DPCP Kolektif" target="_blank"><i class="fa fa-file"/></i> DPCP Kolektif</a> -->
                                    </div>
                                </th>
                            </tr>
                    <?php } ?>
                    <tr>
                        ...
                        <td>
                            <small>
                                <div class="text-center">{!!($nominatifpensiun->esl!='')?$nominatifpensiun->esl:'-'!!}</div>                                
                            </small>
                        </td>
                        <td>                            
                        ...
                        <td>                            
                            <div class="text-center">{!!substr($nominatifpensiun->mkskr,0,-2)!!}</div>                                                
                        </td>
                        <td>                            
                            <div class="text-center">{!!substr($nominatifpensiun->mkskr,-2)!!}</div>                                                
                        </td>
                        <td>                            
                        ...
                        <!-- <td class="text-center">
                            <?php
                            //switch($nominatifpensiun->jnskgb){
                            //     case 1 : echo "OPD"; break;
                            //     case 2 : echo "BKD"; break;
                            //     case 3 : echo "SEKDA"; break;
                            //     case 4 : echo "BUPATI"; break;
                            //     default: echo ""; break;
                            // }
                            ?>
                        </td> -->
                        ...
                        <td>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li><a href="javascript:void(0)" recnip="{!!$nominatifpensiun->nip!!}" rectmtpens="{!!$nominatifpensiun->tmtpens!!}" recidskpd="{!!((Input::get('idskpd')!='')?Input::get('idskpd'):substr($nominatifpensiun->idskpd,0,2))!!}" class="attrhukpidopd btn-default"><i class="fa fa-pencil"/></i> OPD</a></li>
                                    @if(Session::get('role_id') <= 3)
                                    <li><a href="javascript:void(0)" recnip="{!!$nominatifpensiun->nip!!}" rectmtpens="{!!$nominatifpensiun->tmtpens!!}" recidskpd="{!!((Input::get('idskpd')!='')?Input::get('idskpd'):substr($nominatifpensiun->idskpd,0,2))!!}" class="attrpengantarBkpp btn-default"><i class="fa fa-pencil"/></i> BKPP</a></li>
                                    @endif
                                </ul>
                            </div>
                        </td>
    ...
    $(document).ready(function(){
        ...
        $('.attrpengantaropd').on('click', function(e){
            ...
            $.ajax({
                ...
                data: {'tmtpens': $(this).attr('rectmtpens'), 'idskpd': $(this).attr('recidskpd'), '_token' : '{!!csrf_token()!!}'},
                success:function(html){
                    $('#main_modal .modal-body').html(html);
                }
            });
        ...
        $('.attrhukpidopd').on('click', function(e){
            ...
            $.ajax({
                type:'post',
                url : '{!!url()!!}/epensiun/nominatifpensiun/data/surathukpid',
                data: {'nip': $(this).attr('recnip'), 'tmtpens': $(this).attr('rectmtpens'), 'idskpd': $(this).attr('recidskpd'), '_token' : '{!!csrf_token()!!}'},
                success:function(html){
                    $('#main_modal .modal-body').html(html);
                }
            });
        ...
        $('.attrpengantarBkpp').on('click', function(e){
            ...
            $.ajax({
                type:'post',
                url : '{!!url()!!}/epensiun/nominatifpensiun/data/suratpengantarBkpp',
                data: {'nip': $(this).attr('recnip'), 'tmtpens': $(this).attr('rectmtpens'), 'idskpd': $(this).attr('recidskpd'), '_token' : '{!!csrf_token()!!}'},
                success:function(html){
                    $('#main_modal .modal-body').html(html);
                }
