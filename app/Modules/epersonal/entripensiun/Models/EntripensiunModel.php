<?php namespace App\Modules\epersonal\entripensiun\Models;
...
class EntripensiunModel extends Model {
	...
	public static function all($columns = array('*')){
		$instance = new static;
        $where = " tb_01.idjenkedudupeg not in('99','21') and tb_01.nip != '' and tb_01.tglhr != '0000-00-00'";
		...
		if (\PermissionsLibrary::hasPermission('mod-entripensiun-listall')){
