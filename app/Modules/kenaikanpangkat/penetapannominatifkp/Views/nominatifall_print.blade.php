...
$where = "tr_kenaikan_pangkat.tmt like '".$tmt."%'";
...
<table class="table" border="1" cellpadding="0" width="100%" style="font-size:8pt">
    <thead>
        <tr>
            ...
            <th align="center" rowspan="2" width="10%">NAMA LENGKAP<br>TEMPAT, TGL. LAHIR</th>
            <th align="center" rowspan="2" width="10%">NIP</th>
            <th align="center" colspan="2" >Lama</th>
            <th align="center" colspan="2" >Baru</th>
            <th align="center" rowspan="2" width="10%">Unit Kerja</th>
            <th align="center" colspan="3">Atasan Langsung</th>
        </tr>
        <tr>
            <th align="center" width="10%">Pangkat<br>Gol/Ruang<br>TMT</th>
            <th align="center" width="10%">Jabatan</th>
            <th align="center" width="10%">Pangkat<br>Gol/Ruang<br>TMT</th>
            <th align="center" width="10%">Jabatan</th>
            <th align="center" width="10%">Nama<br>NIP</th>
            <th align="center" width="10%">Pangkat, Gol/Ruang<br>TMT</th>
            <th align="center" width="10%">Jabatan</th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td>{!! $row->nip !!}</td>
            <td>{!! $row->pangkat !!}<br>{!! $row->golru !!}<br>{!! tglina($row->tmtpkt) !!}</td>
            <td>{!! $row->jabatan !!}</td> 
...
<table width="100%">
    ...
    <td colspan="3" style="vertical-align: middle; width: 45%;">&nbsp;</td>
    <td colspan="3" style="width: 55%; vertical-align: middle;">
        <div style="float: right; width: auto; margin-right: 10px; text-align: center;">
        <span style="font-size:16px;">{!!strtoupper($attr->jab)!!}<br />
        <br />
        <br />
        <br />
        <u>{!!$attr->namalengkap;!!}</u><br />
        &nbsp; NIP. {!!$attr->nip!!}<br />
        &nbsp; {!!ucword($attr->pangkat)!!}</span></div>
    </td>
    </tr>
</table>
<br>
