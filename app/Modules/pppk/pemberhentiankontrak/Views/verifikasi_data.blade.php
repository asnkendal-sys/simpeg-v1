<form id="form-edit" class="form-horizontal" method="POST" action="{!!url()!!}/pppk/pemberhentiankontrak/verifikasipppk" accept-charset="UTF-8">
        ...
        <div class="box box-warning">
            <div class="col-md-6 data-attribut">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        {!! Form::label('bup', 'TMT Pemberhentian:', array('class' => 'col-sm-3 control-label')) !!}
                        <div class="col-sm-3">
                            <span id="attr-bup"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('idjenpens', 'Jenis Pemberhentian:', array('class' => 'col-sm-3 control-label')) !!}
                        <div class="col-sm-3">
                            <span id="attr-jenpens"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('keterangan', 'Keterangan:', array('class' => 'col-sm-3 control-label')) !!}
                        <div class="col-sm-3">
                            <span id="attr-keterangan"></span>
                        </div>
                    </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php
                                $x = 0;                                
                                $rs = callApi('get', 'https://simpeg.kendalkab.go.id/efile/dokumenpersyaratan?id=43&nip='.Input::get('nip'));
                            ?>
            ...
            <div class="col-md-6 data-attribut">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-fw fa-paper-plane-o"></i> VERIFIKASI PEMBERHENTIAN PPPK </h3>
                </div>
                ...
                @if(session('role_id') < 3)
                    ...
                    <div id="ftampil11">
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="nosk">No. SK Pemberhentian </label>
                            <div class="controls col-sm-7">
                                <input name="nosk" value="" id="nosk" maxlength="45" class="form-control" type="text" placeholder="No. SK Pemberhentian">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="tgsk">Tanggal SK Pemberhentian</label>
                            <div class="controls col-sm-7">
                        ...
                        {{-- <div class="box-header">
                            <h3 class="box-title"><i class="fa fa-fw fa-paper-plane-o"></i> PENETAPAN KEPALA BKPP </h3>
                        </div>
                        <div class="form-group">
                ...
                @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls col-sm-7">
                            <?php
                                $item = \DB::table('tr_pppk')->where('idpppk', Input::get('idpppk'))->where('sts_kontrak', 3)->where('nip',Input::get('nip'))->first();
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                $('.data-attribut #attr-bup').html(ret.bup_);
                $('.data-attribut #attr-jenpens').html(ret.jenpens);
                $('.data-attribut #attr-keterangan').html(ret.keterangan);
                $('.data-attribut #attr-no_dasar').html(ret.no_dasar);
                $('.data-attribut #attr-tgl_dasar').html(ret.tgl_dasar);
                $('.data-attribut #attr-tmt_dasar').html(ret.tmt_dasar);
                if(ret.idjenpens != '1'){
                    $('.data-attribut #xjenispens').fadeIn();
                }
