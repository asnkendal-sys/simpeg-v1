...
<body>
  ...
  <?php
    ...
    $rs = \DB::table('tr_kenaikan_pangkat')
        ->select('tr_kenaikan_pangkat.*','tb_01.thijaz','a_tkpendid.*','a_skpd.path_short','a_jenjab.jenjab','a_golruang.golru','a_golruang.pangkat','tb_01.tmlhr','tb_01.tglhr','tb_01.nokarpeg',
    ...
    <table class="table" border="1" cellpadding="0" width="100%" style="font-size:8pt">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{!! $row->tkpendid."<br>".$row->thijaz !!}</td>
                ...
                <td>{!! getKepskpd($row->idskpd, 'nip') !!} <br> {!! getKepskpd($row->idskpd, 'nama') !!}</td>
                <td>{!! getKepskpd($row->idskpd, 'pangkat') !!} <br> {!! getKepskpd($row->idskpd, 'golru') !!}</td>
                <td>{!! getKepskpd($row->idskpd, 'jab') !!}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
