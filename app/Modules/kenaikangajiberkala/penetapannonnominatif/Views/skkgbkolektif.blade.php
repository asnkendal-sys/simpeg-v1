...
<body>
    ...
    <?php
        ...
        $rs = \PenetapannonnominatifModel::getDatanominatifver($idkgb, $jnskgb, $idstspeg);
        ...
        foreach($rs as $item){
            ...
            if($item->idstspeg == 3){
                ...
                $arrsearch = array("search","[nama]","[nip]","[golpns_txt]","[nmajab]","[tmtmulaiawal_pppk]","[tmtakhirawal_pppk]",
                ...
                $rstemplate = (\PenetapannominatifModel::getTemplatesk($idskpd,$item->jnskgb,$item->golpnsskr) == '0')?'<div align="center"><b>Perhatian!</b> Template SK KGB Belum tersedia.<br><em>"Silahkan buat template pada menu Template SK."</em></div>':\PenetapannominatifModel::getTemplatesk($idskpd,$item->jnskgb,$item->golpnsskr);
            ...
            if($item->idstspeg == 3){
                $arrreplace = array("replace",$item->nama,$item->nip,$item->golpns_txt,$item->nmajab,formatTanggalPanjang($item->tmtmulaiawal_pppk),
                ...
                $item->jabpenkgbb,$item->pejpenkgbb);
            }else{
