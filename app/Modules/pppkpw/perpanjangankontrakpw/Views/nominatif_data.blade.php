...
<?php
	$where = " tb_01.idjenkedudupeg not in('99','21') and tb_01.nip != '' and tb_01.idstspeg = 4 ";
    $having = '';
...
//         $titlebulan = ' BULAN '.strtoupper(formatBulan(Input::get('bulan1'))).' S/D '.strtoupper(formatBulan(Input::get('bulan2')));
//     }else if((Input::get('bulan1') != '') and (Input::get('bulan2') == '')){
...
?>
<br><div align="center">
<h4>DAFTAR NOMINATIF PEGAWAI PPPK PARUH WAKTU</h4>
<h4>
