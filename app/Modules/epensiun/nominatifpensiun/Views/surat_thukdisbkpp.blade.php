...
// dd($rstemplate); exit();
        ...
        foreach($rs as $item){
            ...
            $arrreplace = array("replace",$item->nosk_hukdis,$item->pejpenpens,$item->nippenpens,$item->pangkatpenpens,$item->golrupenpens,$item->jabpenpens,$item->namalengkap,$item->nip,$item->golpnsskr_txt,$item->golpns_txt,
                $item->namajab,$item->path_short,$item->no_hukdis,formatTanggalPanjang($item->tgl_hukpid),formatTanggalPanjang($item->tgskpens),$item->jabpen_hukpid,strtoupper($item->jabpenpens),'');
