...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#skpetikan .ckeditor').ckeditor(config_pengantar);

        $("#skpetikan #form1").on('submit',function(e){
            var $this = $(this);
            e.preventDefault();
        ...
        $('#skpetikan #defaultthem').click(function(){
            $.ajax({
                type : 'post',
                url: '{!!url()!!}/emutasi/templateskpengantar/surat',
                data: {'idskpd':'all', 'jnssurat': '2.4', '_token': '{!!csrf_token()!!}'},
                beforeSend:function(){
                    preloader.on();
                },
                success:function(response){
                    ...
                    $('#skpetikan #template4').val(ret.template);
                }
            });
        });
    });
        ...
        <div class="span12">
            <div class="accordion-heading">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="nama" class="nama input-xxlarge form-control" id="nama" value="<?php echo TemplateskpengantarModel::getTemplate('all', '2.4','nama')?>">
                <input type="hidden" name="jnssurat" class="jnssurat" id="jnssurat" value="2.4">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea rows="10" cols="600" name="template4" class="ckeditor" id="template4" placeholder="Template Surat Perintah">
                            <?php
                                if(TemplateskpengantarModel::getTemplate(session('idskpd'), '2.4','template')=='0'){
                                    echo TemplateskpengantarModel::getTemplate('all', '2.4','template');
                                }else{
                                    echo TemplateskpengantarModel::getTemplate(session('idskpd'), '2.4','template');
                                }
                            ?>
                        </textarea>
                    </div>
