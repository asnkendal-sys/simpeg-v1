...
class PenetapannonnominatifController extends Controller {
    ...
    public function __construct(PenetapannonnominatifModel $penetapannonnominatif){
        ...
        if ((strlen(Input::has('search')) > 0) or (Input::get('bulan') != '') or (Input::get('tahun') != '') or (Input::get('jnskgb') != '') or (Input::get('idskpd') != '') or (Input::get('statussk') != '')) {
            if(Input::get('bulan') != ''){
    ...
    public function postCreate(){
        ...
        if ($validation->passes()){
            ...
            $data = array(
                ...
                'jnskgb' => \PenetapannominatifModel::getJeniskgb($golru,$idskpd),
                'statususul' => 0,
                'statussk' => 0,
                'statuskgb' => 2,
                ...
                'gkgbl' => getgaji($golru,$attr->mkgolthnkgb), /*besar gaji lama*/ /*$golru = $attr->idgolrupkt*/
                ...
                'gkgbb' => getgaji($attr->idgolrupkt,$mktkgbb), /*besar gaji baru*/ /*$golru = $attr->idgolrupkt*/
                'noskkgbb' => $noskkgbb, /*nomor skkgb*/

                /*diisi sesuai kondisi skpd dan golongan*/

                'idpejab' => PenetapannonnominatifModel::attrKepskpd($attr->idgolrupkt,$attr->idskpd,'idpenetap'),
                'jabpenkgbb' => PenetapannonnominatifModel::attrKepskpd($attr->idgolrupkt,$attr->idskpd,'jab_utuh'),
                'pejpenkgbb' => PenetapannonnominatifModel::attrKepskpd($attr->idgolrupkt,$attr->idskpd,'nama'),
                'nippb' => PenetapannonnominatifModel::attrKepskpd($attr->idgolrupkt,$attr->idskpd,'nip'),
                'golrupb' => PenetapannonnominatifModel::attrKepskpd($attr->idgolrupkt,$attr->idskpd,'pangkat'),
                ...
                'nomgpl' => terbilang(getGaji($attr->idgolrupkt,$attr->mkgolthnkgb))."rupiah",/*$golru = nominal gaji lama*/
                'nomgpb' => terbilang(getGaji($golru,$mktkgbb))."rupiah", /*$golru = nominal gaji baru*/
    ...
    public function postAcuan(){
        ...
        if($idacuan == 1){
            $row = \DB::table('tb_01')
                    ->select(
                        \DB::raw("
                            pejmenkgb as pejmen, noskkgb as nosk, tgskkgb as tgsk, idgolrupkt as golru,
            ...
            $row = \DB::table('tb_01')
                    ->select(
                        \DB::raw("
                            pejmenpkt as pejmen, noskpkt as nosk, tgskpkt as tgsk, idgolrupkt as golru,
            ...
            $row = \DB::table('tb_01')
                    ->select(
                        \DB::raw("
                            pejmenpns as pejmen, noskpns as nosk, tgskpns as tgsk, idgolrupns as golru,
            ...
            $row = \DB::table('tb_01')
                    ->select(
                        \DB::raw("
                            pejmencpn as pejmen, noskcpn as nosk, tgskcpn as tgsk, idgolrucpn as golru,
        ...
        $gaji = getgaji($row->golru,$row->mkgolthn);
        $gajikgb = getgaji($row->golru,$thmker);
