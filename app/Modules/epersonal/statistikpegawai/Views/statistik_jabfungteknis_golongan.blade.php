...
<html>
<head>
    <title>{!!ucfirsts(getUtility('alias_aplikasi'))!!} Statistik Jabatan Fungsional Teknis dan Golongan</title>
...
<form id="form-print" name="form-print" action="{!!url()!!}/epersonal/statistikpegawai/print/statistik_jabfungteknis_golongan" class="form-horizontal" method="post" enctype="multipart/form-data" target="_blank">
    {!!csrf_field()!!}
...
<h4 align="center">STATISTIK PEGAWAI BERDASARKAN JABATAN FUNGSIONAL TEKNIS DAN GOLONGAN {!! ((Input::get('idskpd')!='')?'PADA '.strtoupper(getSkpd(Input::get('idskpd'))):'') !!}</h4><br>
<table class="table table-hovered table-bordered" id="tb-statistik" border="{!!(Request::segment(3) == 'print')?'1':'0'!!}">
    <thead class="bg-primary">
        <tr>
            <th rowspan="3"><div class="text-center">FUNGSIONAL TEKNIS</div></th>
