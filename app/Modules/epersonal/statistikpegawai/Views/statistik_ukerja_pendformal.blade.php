            ...
            @if(count($rs) > 0)
                @foreach($rs as $item)
                    ...
                    <tr>
                        ...
                        <td><div class="link text-center" data="notnull" ed2="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->TOT!!}</div></div></td>
                        <td><div class="link text-center" data="null" ed2="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->empty!!}</div></td>
                        <td><div class="link text-center" data="05" ed2="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->sd!!}</div></div></td>
                        <td><div class="link text-center" data="10" ed2="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->sp!!}</div></div></td>
                        <td><div class="link text-center" data="12" ed2="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->spk!!}</div></div></td>
                        <td><div class="link text-center" data="15" ed2="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->sa!!}</div></div></td>
                        <td><div class="link text-center" data="17" ed2="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->sak!!}</div></div></td>
                        <td><div class="link text-center" data="18" ed2="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->sag!!}</div></div></td>
                        <td><div class="link text-center" data="20" ed2="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->d1!!}</div></div></td>
                        <td><div class="link text-center" data="25" ed2="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->d2!!}</div></div></td>
                        <td><div class="link text-center" data="30" ed2="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->d3!!}</div></div></td>
                        <td><div class="link text-center" data="35" ed2="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->d4!!}</div></div></td>
                        <td><div class="link text-center" data="40" ed2="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->s1!!}</div></div></td>
                        <td><div class="link text-center" data="45" ed2="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->s2!!}</div></div></td>
                        <td><div class="link text-center" data="50" ed2="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->s3!!}</div></div></td>
                    </tr>
                @endforeach
            @else
                <tr>
