                                        ...
                                        <td rowspan="2" align="right">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li><a class="text-info prevperubahan" recrole="{!! session('role_id') !!}" recid="{!!$rpppk->id!!}" recnip="{!!$rpppk->nip!!}" recflag="{!!$rpppk->idjnsaksi!!}" href="javascript:void(0)" ><i class="{!!(session('role_id') <= 3)?'fa fa-check':'fa fa-search'!!}"></i> {!!(session('role_id') <= 3)?'Verifikasi':'Preview'!!}</a></li>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('.prevperubahan').on('click', function(e){
            ...
            if(roleid < 3){
               var tipe = 'get';
               var alamat = '{!!url()!!}/epersonal/perubahanriwayat/rpppkdetail/rpppk';
               var modal = 'main_modal3';
               var judul = 'Perubahan Data';
            }else{
               var tipe = 'post';
               var alamat = '{!!url()!!}/epersonal/perubahanriwayat/data/rpppk_perubahan';
            ...
            bootbox.confirm('Batalkan perubahan data ?',function(a){
                if(a == true){
                    $.ajax({
                        ...
                        type : 'post',
                        data: {'id' : $this.attr('recid'), 'tb':'r_pppk_temp', '_token' : '{!!csrf_token()!!}'},
                        beforeSend: function(){
                            preloader.on();
                        },
                        success:function(html){
