...
<div class="row">
    <div class="col-xs-7">
        <table>
            <tr>
                ...
                <td width='5%'> : </td>
                <td width='50%'><a href="{!!url().'/packages/upload/excel/refpendidikan/'.$attr->filename!!}" target="_blank">{!!$attr->filename_original!!}</a></td>
            </tr>
            <tr>
                <td>Lama Konversi</td>
                <td>: </td>
    ...
    <div class="col-xs-5">
        <div align="right">
            <form action="{!!url()!!}/konversidata/referensipendidikan/excel/referensi" id="form-hasil" method="post" target="_blank">
                {!!csrf_field()!!}
        ...
        <table class="table table-striped table-hover table-condensed table-bordered" id='tabel'>
            ...
            <tbod>
                ...
                <tr>
                    ...
                    <td>{!!$item->idgolru!!}</td>
                    <td>{!!$item->idfungsional!!}</td>
                    <td>{!!$item->idkeljurusan!!}</td>
                    <td>{!!$item->user_id!!}</td>
                    <td>{!!$item->role_id!!}</td>
