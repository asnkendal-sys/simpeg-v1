    ...
    $(document).ready(function(){
        ...
        <?php if(session('role_id') <= 3){?>
            ...
            $('#templatepengantar #idskpd').on('change', function(e){
                ...
                $.ajax({
                    type : 'post',                    
                    url : '{!!url()!!}/pppkpw/templateskpppkpw/surat',
...
<div class="row-fluid">
    <form id="form1" name="form1" class="form-horizontal" action="{!!url()!!}/pppkpw/templateskpppkpw/savetemplate" method="post">
        {!!csrf_field()!!}
        <div class="span12">
            <div class="accordion-heading">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="nama" id="nama" class="nama form-control" value="{!!TemplateskpppkpwModel::getTitle('all', 6)!!}">
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea rows="10" cols="600" name="template6" class="ckeditor form-control" id="template6" placeholder="Template Pengantar OPD">                            
                            <?php
                                if(TemplateskpppkpwModel::getTemplate(session('idskpd'), 6)=='0'){
                                    echo TemplateskpppkpwModel::getTemplate('all', 6);
                                }else{
                                    echo TemplateskpppkpwModel::getTemplate(session('idskpd'), 6);
                                }
                            ?>
                        </textarea>
                    </div>
