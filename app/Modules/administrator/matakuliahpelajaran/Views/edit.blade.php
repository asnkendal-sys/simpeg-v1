<section class="content-header">
    <h1>
        Edit Matakuliah Pelajaran<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li><a href="#" id="back"> Matakuliah Pelajaran</a></li>
        <li class="active">Edit Matakuliah Pelajaran</li>
    </ol>
</section>
<section class="content">
  <div class="box box-primary">
    ...
    <div class="row">
      <div class="col-md-12">
        {!! Form::model($matakuliahpelajaran, array('url' => $uri, 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax') ,'id'=>'simpan')) !!}
        {!! Form::hidden('idmatkulpel') !!}
        <div class="box-body">
                <div class="form-group">
                    {!! Form::label('idmatkulpel', ' Kode Matkul/Pelajaran:', array('class' => 'col-sm-3 control-label')) !!}
                    <div class="col-sm-2">
                        {!! Form::text('idmatkulpel', null, array('class'=> 'form-control', 'placeholder'=>"Kode Matkul/Pelajaran", 'disabled'=>'disabled')) !!}
                    </div>
                </div>
                <div class="form-group">
					{!! Form::label('idtugasgurudosen', 'Tugas Guru / Dosen:', array('class' => 'col-sm-3 control-label')) !!}
					<div class="col-sm-3">
                        {!! comboTgsgurudosen("idtugasgurudosen",$matakuliahpelajaran->idtugasgurudosen,"") !!}
					</div>
				</div>
				<div class="form-group">
