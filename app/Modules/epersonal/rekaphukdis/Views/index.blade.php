<section class="content-header">
    <h1>
        Nominatif Hukumuan Disiplin<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li class="active">Nominatif Hukumuan Disiplin</li>
    </ol>
</section>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        {!! Form::label('tkhukdis', 'Tingkat Hukuman Disiplin:', array('class' => 'col-sm-3 control-label')) !!}
                        <div class="col-sm-4">
                            <select name="idtkhukdis" id="idtkhukdis" class="form-control validate['required']">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#prev-nominatif').on('click', function(e){
            e.preventDefault();
            $.ajax({
                url : '{!!url()!!}/epersonal/rekaphukdis/data/nominatif',
                type : 'post',
        ...
        $('#cetak-nominatif').on('click', function(e){
            e.preventDefault();
            $('#nominatif-pegawai').attr("action", "{!!url()!!}/epersonal/rekaphukdis/print/nominatif");
            $('#nominatif-pegawai').submit();
        });

        $('#excel-nominatif').on('click', function(e){
            e.preventDefault();
            $('#nominatif-pegawai').attr("action", "{!!url()!!}/epersonal/rekaphukdis/excel/nominatif");
            $('#nominatif-pegawai').submit();
            /*cetak_excel('result');*/
        });
    });
