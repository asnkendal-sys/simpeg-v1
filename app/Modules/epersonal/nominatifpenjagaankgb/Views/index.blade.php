<section class="content-header">
    <h1>
        Nominatif Penjagaan KGB<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li class="active">Nominatif Penjagaan KGB</li>
    </ol>
</section>
            ...
            <div class="col-md-12">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            {!! \NominatifpenjagaankgbModel::comboStsPegawai("idstspeg","","multiple") !!}
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#prev-nominatif').on('click', function(e){
            e.preventDefault();
            $.ajax({
                url : '{!!url()!!}/epersonal/nominatifpenjagaankgb/data/nominatif',
                type : 'post',
                ...
                beforeSend:function(){
                    if($('#bulan').val() != ''){
                        ...
                        bootbox.alert('bulan harus diisi !');
                    }
        ...
        $('#cetak-nominatif').on('click', function(e){
            e.preventDefault();
            if($('#bulan').val() != ''){
                $('#nominatif-pegawai').attr("action", "{!!url()!!}/epersonal/nominatifpenjagaankgb/print/nominatif");
        ...
        e.preventDefault();
        if($('#bulan').val() != ''){
            $('#nominatif-pegawai').attr("action", "{!!url()!!}/epersonal/nominatifpenjagaankgb/excel/nominatif");
            $('#nominatif-pegawai').submit();  
        }else {
            bootbox.alert('bulan harus diisi !');
        }
