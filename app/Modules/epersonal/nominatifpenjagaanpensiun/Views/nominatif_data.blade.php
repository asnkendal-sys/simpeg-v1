...
<?php
    ...
    $rs = \DB::table('tb_01')
        ...
        \DB::raw("CONCAT(LEFT(DATE_ADD(DATE_ADD(tb_01.tglhr, INTERVAL IF(tb_01.idjenjab>=20,a_skpd.bup,IF(tb_01.idjenjab=2,a_jabfung.pens,IF(tb_01.idjenjab=3,a_jabfungum.pens,IF(tb_01.idjenjab=4,a_jabnonjob.pens,58)))) YEAR), INTERVAL 1 MONTH),8),'01') AS pensiunnext"), //tmtpens tegal dr pensiunnext
        ...
        ->whereRaw($where)
        ->havingRaw($having)
        ->orderBy(\DB::raw('pensiunnext, tb_01.tglhr, tb_01.idgolrupkt, tb_01.tmtpkt, tb_01.nama'))
        ->get();
