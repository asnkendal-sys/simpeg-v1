        ...
        <div class="box-header with-border row">
            <div class="col-md-12">
                <ul class="nav nav-tabs tab1" id="myTab">
                    ...
                    <li class="active"><a data-toggle="tab" href="{!!url()!!}/emutasi/templatemasukkabupaten/persetujuanpindahprov"> <i class="fa fa-pencil"></i> Surat Persetujuan II</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                          <input type="hidden" name="jnssurat" class="jnssurat" id="jnssurat" value="4.2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea rows="10" cols="600" name="template" class="ckeditor form-control" id="template2" placeholder="Template Surat Keputusan Ijin Belajar">
                                <?php
                                    ...
                                    echo  TemplatemasukkabupatenModel::getTemplate('all', 4.2, 'template');
                                ?>
                                </textarea>
                            </div>
                        </div>
