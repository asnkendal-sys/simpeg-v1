<form id="form-perubahan" class="form-horizontal" method="POST" action="{!!url()!!}/epersonal/perubahanriwayat/verrdikfung" accept-charset="UTF-8">
<section class="content">
            ...
            <div class="box box-success">
                <?php
                    ...
                    $item = \DB::table('r_dikfung_temp')
                        ...
                        ->where('r_dikfung_temp.id', $id)
                        ->where('r_dikfung_temp.nip', $nip)
                        ->first();

                    $item2 = \DB::table('r_dikfung')
                    ->select('r_dikfung.*')
                    ->where('r_dikfung.nip', $nip)
                    ->where('r_dikfung.id', $item->id_rdikfung)
                    ->first();
 ...
 $dokumenpendukung = \DB::connection('efile_2017')->table('files_temp')
                    ...
                    if($flag != 1){
                        $dikfung        = ($item->iddikfung!=$item2->iddikfung)?'alert-dangers':'';
                        $penyelenggara  = ($item->penyelenggara!=$item2->penyelenggara)?'alert-dangers':'';
                        $tmdikfung      = ($item->tmdikfung!=$item2->tmdikfung)?'alert-dangers':'';
                        ...
                        $nosttpdikfung   = ($item->nosttpdikfung!=$item2->nosttpdikfung)?'alert-dangers':'';
                        $tgsttpdikfung   = ($item->tgsttpdikfung!=$item2->tgsttpdikfung)?'alert-dangers':'';
                    }
                    if($flag == 1){
                ...
                <div class="col-md-6">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-fw fa-dot-circle-o"></i> RIWAYAT DIKLAT FUNGSIONAL ({!!$title1!!})</h3>
                    </div>
                    ...
                    <div class="box-body">
                        <div class="col-md-12 data-awal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-control">{{($item2->dikfung!='')?$item2->dikfung:'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('tmdikfung', 'Tempat:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div class="form-control">{{($item2->tmdikfung!='')?$item2->tmdikfung:'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-control">{{($item2->nosttpdikfung!='')?$item2->nosttpdikfung:'-'}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('tgsttpdikfung', 'Tgl. STTP:', array('class' => 'col-sm-3 control-label')) !!}
                                <div class="col-sm-7">
                                    <div class="form-control">{{($item2->tgsttpdikfung!='0000-00-00')?date('d-m-Y', strtotime($item2->tgsttpdikfung)):'-'}}</div>
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-fw fa-dot-circle-o"></i> RIWAYAT DIKLAT FUNGSIONAL ({!!$title2!!})</h3>
                    </div>
                    <div class="box-body">
                        <div class="col-md-12 data-perubahan">
                            ...
                            {!! Form::hidden('id_rdikfung', null, array('class'=> 'form-control', 'id'=>'id_rdikfung')) !!}
                            ...
                            <div class="form-group">
                                ...
                                @elseif($flag == 2)
                                <div style="width: auto;" class="{!!$dikfung!!} dikfung">
                                    <select name="iddikfung" class="form-control" id="iddikfung" data-placeholder=".: Pilihan :." style="width: 100%"></select>
                                </div>
                                    {!! Form::hidden('dikfung', null, array('class'=> 'form-control', 'id'=> 'dikfung')) !!}
                                @endif
                            ...
                            <div class="form-group">
                                ...
                                @elseif($flag == 2)
                                    {!! Form::text('tmdikfung', null, array('class'=> 'form-control '.$tmdikfung, 'placeholder'=>'Tempat Diklat')) !!}
                                @endif
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                @elseif($flag == 2)
                                    <div style="width: auto;" class="{!!$jamhari!!} jamhari">
                                    <div class='input-group'>
                                        {!! Form::text('jamhari', null, array('class'=> 'form-control num', 'placeholder'=>'Lama Dalam Satuan Jam')) !!}
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-time"></span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    @elseif($flag == 2)
                                    {!! Form::text('nosttpdikfung', null, array('class'=> 'form-control '.$nosttpdikfung, 'placeholder'=>'No. STTP')) !!}
                                    @endif
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                @elseif($flag == 2)
                                    <div style="width: auto;" class="{!!$tgsttpdikfung!!} tgsttpdikfung">
                                    <div class='input-group datepicker'>
                                        {!! Form::text('tgsttpdikfung', null, array('class'=> 'form-control date', 'placeholder'=>'Tgl. STTP')) !!}
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.data-perubahan #iddikfung').on('change', function(e){
            e.preventDefault();
            $('.data-perubahan #dikfung').val($(this).find(":selected").text());
        });

        autoComplete('.data-perubahan #iddikfung', '{{url()}}/epersonal/biodata/dikfung', '.: Pilihan :.', null, '', '', '');
        ...
        $.ajax({
            ...
            type:'post',
            data:{'id':'{!!Input::get("id")!!}','tb':'r_dikfung_temp','_token' : '{!!csrf_token()!!}'},
            beforeSend:function(){
                preloader.on();
            },
            success:function(response){
                ...
                if(ret){
                    ...
                    $(".data-perubahan #iddikfung").data('select2').trigger('select', {
                        data: {"id":(ret.iddikfung != '' ? ret.iddikfung : ret.dikfung),"text":ret.dikfung}
                    });
