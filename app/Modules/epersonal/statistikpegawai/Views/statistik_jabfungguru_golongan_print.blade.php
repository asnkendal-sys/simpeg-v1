...
<?php
    ...
    $issek = getAttr('a_skpd', 'issek', Input::get('issek'), 'issek');

    switch(Input::get('issek')){
        case "1":
            $jenjang = 'TK';
            break;
        case "2":
    ...
    $where .= " and a_skpd.issek='".Input::get('issek')."'";
    $rs = \DB::table('tb_01')
...
<h3>BERDASARKAN JABATAN FUNGSIONAL GURU {!!$jenjang!!}</h3>
</div><br>
    <table border="1">
