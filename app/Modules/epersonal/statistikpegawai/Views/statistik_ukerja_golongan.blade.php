    ...
    @if(count($rs) > 0)
        @foreach($rs as $item)
            ...
            <tr>
                ...
                <td><div class="link text-center" data="notnull" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->gol!!}</div></td>
                <td><div class="link text-center" data="null" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->golempty!!}</div></td>
                <td><div class="link text-center" data="11" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_11!!}</div></td>
                <td><div class="link text-center" data="12" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_12!!}</div></td>
                <td><div class="link text-center" data="13" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_13!!}</div></td>
                <td><div class="link text-center" data="14" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_14!!}</div></td>
                <td><div class="link text-center" data="21" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_21!!}</div></td>
                <td><div class="link text-center" data="22" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_22!!}</div></td>
                <td><div class="link text-center" data="23" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_23!!}</div></td>
                <td><div class="link text-center" data="24" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_24!!}</div></td>
                <td><div class="link text-center" data="31" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_31!!}</div></td>
                <td><div class="link text-center" data="32" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_32!!}</div></td>
                <td><div class="link text-center" data="33" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_33!!}</div></td>
                <td><div class="link text-center" data="34" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_34!!}</div></td>
                <td><div class="link text-center" data="41" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_41!!}</div></td>
                <td><div class="link text-center" data="42" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_42!!}</div></td>
                <td><div class="link text-center" data="43" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_43!!}</div></td>
                <td><div class="link text-center" data="44" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_44!!}</div></td>
                <td><div class="link text-center" data="45" ed1="{!!$item->idskpd!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail">{!!$item->_45!!}</div></td>
            </tr>
        @endforeach
    @else
        <tr>
