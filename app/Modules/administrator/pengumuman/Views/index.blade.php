    ...
    <div class="box box-primary">
            ...
            <div class="box-body no-padding">
                <table class="table table-striped table-hover table-condensed table-bordered" id='tabel'>
                    ...
                    <tr>
                        ...
                        <td>{!!substr(strip_tags($pengumuman->pengumuman), 0, 150)!!}..</td>
                        <td class="text-center">{!!($pengumuman->status==1)?'<i class="glyphicon glyphicon-ok-circle"></i>':'<i class="glyphicon glyphicon-remove-circle"></i>'!!}</td>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li>{!! ClaravelHelpers::btnEdit($pengumuman->id) !!}</li>
                                    <li>{!! ClaravelHelpers::btnDelete($pengumuman->id) !!}</li>
                                </ul>
                            </div>
                        </td>
                    </tr>
        ...
        <div class="box-footer clearfix">
          <div class="row">
            ...
            <div class="col-sm-6">
              <?php echo $pengumumans->appends(array('search' => Input::get('search')))->render(); ?>
            </div>
          </div>
        </div>
        {!! Form::close() !!}
