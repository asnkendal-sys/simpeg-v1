...
<div class="row" style="padding-left: 35px;">
    <div class="span12">
        <form id="form2" name="form2" class="form-horizontal" action="{!!url()!!}/emutasi/nominatifpengangkatan/cetak/nominatif" target="_blank" class="" method="post" enctype="multipart/form-data">
            {!!csrf_field()!!}
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="no_sp" id="no_sp" class="input-medium form-control" placeholder="No Surat" value="<?php echo ($row->no_sp=='')?'822.3/...../'.date('Y'):$row->no_sp?>">
                    </div>
                </div>
                <div class="form-group">
