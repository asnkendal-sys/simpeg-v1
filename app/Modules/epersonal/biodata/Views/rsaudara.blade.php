...
@else
    <tr>
        <td colspan="8">Riwayat Saudara belum tersedia.</td>
    </tr>
@endif

<script type="text/javascript">
    $(document).ready(function(){
        $('#rsaudara a.edit').on('click',function(e){
            e.preventDefault();
        ...
        $('#rsaudara a.hapus').on('click',function(e){
            e.preventDefault();
            var id = $(this).attr('recid');
            bootbox.confirm('Hapus?',function(a){
                if(a == true){
                    $.ajax({
                        ...
                        data: {'nip': $('#nip').val(), 'id': id, 'flag':3, 'tb':'r_saudarakandung', '_token' : '{!!csrf_token()!!}'},
                        beforeSend: function(){
                            preloader.on();
                        },
                        success:function(html){
