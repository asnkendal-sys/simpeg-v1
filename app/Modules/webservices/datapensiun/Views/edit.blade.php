<section class="content-header">
    <h1>
        Edit Data Pensiun<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li><a href="#" id="back"> Data Pensiun</a></li>
        <li class="active">Edit Data Pensiun</li>
    </ol>
</section>
<section class="content">
    <div class="box box-primary">
        ...
        <div class="row">
            <div class="col-md-12">
                {!! Form::model($datapensiun, array('url' => $uri, 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax') ,'id'=>'simpan')) !!}
                {!! Form::hidden('id') !!}
                <div class="box-body">
                    <div class="form-group">
                        {!! Form::label('no', 'no:', array('class' => 'col-sm-3 control-label')) !!}
                        <div class="col-sm-7">
                            {!! Form::text('no', null, array('class'=> 'form-control', 'placeholder'=>'no')) !!}
                        </div>
                    </div>
                    <div class="form-group">
