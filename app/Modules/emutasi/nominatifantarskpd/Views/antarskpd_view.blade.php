...
->select(
    'a.*','a.nip', 'a.nama', 'a.photo','a.nopak','a.thijaz', 'b.skpd','a_tkpendid.tkpendid','a_tkpendid.idtkpendid','a.tmtjbt','a.tmtpkt',
    'a_jenjurusan.jenjurusan','a_jenjurusan.idjenjurusan','a_golruang.golru'
    ,
...
<div class="nomi" id="{!!Input::get('nip')!!}" urutan="{!!Input::get('n')!!}">
    <table class="tb table-bordered" border="0" width="95%"  style="margin-left: 25px;">
        <tbody>
            <tr>
        ...
        <tr>
            ...
            <td>{!!$item->skpd!!}<br>
                @if(substr($item->idskpd,0,2)==04)
                <input type="hidden" name="{!!Input::get('n')!!}[isdiperbantukan]" value="<?php echo $item->isdiperbantukan?>" required class="input-large form-control">
                <?php echo NominatifantarskpdModel::comboDiperbantukan('[iddiperbantukan]',$item->iddiperbantukan,'','iddiperbantukan',Input::get('n')) ?>
                @endif
            </td>
            <td>
                @if($item->nopak=='')-
                ...
                <table width="100%" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- DOKUMENTASI Revisi Kejadian CPNS -->
                            <?php if ($item->idstspeg == 1) { ?>
                                <input type="hidden" name="{!!Input::get('n')!!}[idskpd]" value="" id="idskpd{!!Input::get('n')!!}" required class="">
                            <?php }else{
                                ?>
                        ...
                        <td>
                            ...
                            <select id="idskpdbaru{!!Input::get('n')!!}" class=" form-control" name="<?php echo Input::get('n')."[idskpdbaru]"?>"/>
                            </select>
                        </td>
                        <td>
