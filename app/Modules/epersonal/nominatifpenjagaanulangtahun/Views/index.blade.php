<section class="content-header">
    <h1>
        Nominatif Penjagaan Ulang Tahun<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li class="active">Nominatif Penjagaan Ulang Tahun</li>
    </ol>
</section>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        {!! Form::label('idwaktu', 'Pilihan Waktu:', array('class' => 'col-sm-3 control-label')) !!}
                        <div class="col-sm-3">
                            {!! comboKategoriwaktu("idwaktu","","") !!}
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#prev-nominatif').on('click', function(e){
            e.preventDefault();
            $.ajax({
                url : '{!!url()!!}/epersonal/nominatifpenjagaanulangtahun/data/nominatif',
                type : 'post',
        ...
        $('#cetak-nominatif').on('click', function(e){
            e.preventDefault();
            $('#nominatif-pegawai').attr("action", "{!!url()!!}/epersonal/nominatifpenjagaanulangtahun/print/nominatif");
            $('#nominatif-pegawai').submit();
        });

        $('#excel-nominatif').on('click', function(e){
            e.preventDefault();
            $('#nominatif-pegawai').attr("action", "{!!url()!!}/epersonal/nominatifpenjagaanulangtahun/excel/nominatif");
            $('#nominatif-pegawai').submit();
            /*cetak_excel('result');*/
        });
    });
