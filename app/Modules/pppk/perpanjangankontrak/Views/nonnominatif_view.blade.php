    ...
    <table class="tb table-bordered" border="0" width="98%">
        <tbody>
            <tr>
                ...
                <th colspan="2" width="10%">MASA KERJA</th>
                <th colspan="2" width="15%">PERJANJIAN KERJA</th>
            ...
            <tr>
                ...
                <td class="text-center">
                    {!!$item->golru_p3k!!}
                    {{-- <br>{!!($item->tmtpkt!='0000-00-00')?date('d-m-Y', strtotime($item->tmtpkt)):''!!} --}}
                </td>
                ...
                <td align="center">
                    <div class="text-center">{!!date('d-m-Y', strtotime($item->tmtmulaiakhir_pppk))!!}</div>
                </td>
                <td align="center">
                    <div class="text-center">{!!date('d-m-Y', strtotime($item->tmtakhirakhir_pppk))!!}</div>
                </td>
                <td>{!!$item->tkpendid!!}</td>
                        ...
                        <tr style="background-color: #ececec">
                            <td width="10%" rowspan="3" style="vertical-align:middle">                                
                                <div class="text-center">
                                    Atribut Perpanjangan Kontrak PPPK<br>
                            ...
                            <td rowspan="2" class="text-center" width="15%">Golongan</td>
                            <td colspan="2" class="text-center" width="5%">Masa Kerja</td>
                            <td colspan="2" class="text-center" width="5%">Masa Perjanjian</td>
                            <td rowspan="2" class="text-center" width="15%">Keterangan Perpanjangan <span class="pull-right"><a class="remove_item" href="javascript:void(0)" title="Delete Nominatif"><i class="glyphicon glyphicon-trash"></i></a></span></td>
                        </tr>
                        <tr style="background-color: #ececec">
                            <td class="text-center" width="5%">Tahun</td>
                            <td class="text-center" width="5%">Bulan</td>
                            <td class="text-center" width="15%">Tanggal Awal</td>
                            <td class="text-center" width="15%">Tanggal Akhir</td>
                        </tr>
                        <tr>
                            <td>{!! comboGolrupppk(Input::get('n')."[idgolru]",$item->idgolruakhir_pppk,"required") !!}</td>
                            <td><input type="text" name="{!!Input::get('n')!!}[thkerja]" class="validate[required] form-control" value="{!!$thnmkskr+1!!}" placeholder="00"></td>
                            <td><input type="text" name="{!!Input::get('n')!!}[blkerja]" class="validate[required] form-control" value="00" placeholder="00"></td>
                            <td>
                                <div class='input-group datepicker'>
                                    <input type="text" name="{!!Input::get('n')!!}[tmtawal]" class="validate[required] form-control date" value="{!!date('d-m-Y', strtotime($item->tmtakhirakhir_pppk. ' +1 day'))!!}" placeholder="dd-mm-yyyy">
                            ...
                            <td>
                                <div class='input-group datepicker'>
                                    <input type="text" name="{!!Input::get('n')!!}[tmtakhir]" class="validate[required] form-control date" placeholder="dd-mm-yyyy">
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>                                
                                <input type="hidden" name="{!!Input::get('n')!!}[sts_kontrak]" value="2">                                
                            ...
                            <td>
                                <input type="text" name="{!!Input::get('n')!!}[keterangan]" class="validate[required] form-control" placeholder="Keterangan Perpanjangan">

                            </td>
                        </tr>
                        <tr>
                            <td colspan="5">
                                <em>* Harap periksa kembali biodata ASN apabila jenis jabatan dan nama jabatan belum sesuai dengan data sebenarnya.</em>
                            </td>
                        </tr>
                    </table>
                </td>
