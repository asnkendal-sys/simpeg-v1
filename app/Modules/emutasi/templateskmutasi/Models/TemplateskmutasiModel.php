<?php namespace App\Modules\emutasi\templateskmutasi\Models;
use Illuminate\Database\Eloquent\Model;


/**
* Templateskmutasi Model
...
class TemplateskmutasiModel extends Model {
	...
	public static function all($columns = array('*')){
		$instance = new static;
		if (\PermissionsLibrary::hasPermission('mod-templateskmutasi-listall')){
