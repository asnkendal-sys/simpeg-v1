<?php
    ...
    /*diisi query menampilkan data dari SIASN*/
    $x = 0;
...
@if(count($bkn) > 0)
    @foreach($bkn as $item)
        @if($item->jenisKursusSertifikat == 'DIKLAT FUNGSIONAL')
        <?php $x++;?>
        <tr>
    ...
    @if($x == 0)
    <tr>
        <td colspan="8">Riwayat Diktat Fungsional SIASN belum tersedia.</td>
    </tr>
    @endif
@else
    <tr>
