        ...
        <div class="table-responsive">
            <div class="box-body no-padding">
                <table class="table table-striped table-hover table-condensed table-bordered" id='tabel'>
                    ...
                    <tr>
                        <td><center>{!! ClaravelHelpers::ckDelete($jabatanfungsional->idjabfung); !!}</center></td>
					...
					<td>{!!$jabatanfungsional->jenjang!!}</td>
					<td>{!!$jabatanfungsional->pens!!}</td>
                    <td>{!!$jabatanfungsional->kategori!!}</td>
                    <td class="text-center">{!!($jabatanfungsional->flag==1)?'<i class="glyphicon glyphicon-ok-circle"></i>':'<i class="glyphicon glyphicon-remove-circle"></i>'!!}</td>
