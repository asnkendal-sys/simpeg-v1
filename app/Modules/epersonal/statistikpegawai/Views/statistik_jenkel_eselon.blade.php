    ...
    <tbody>
        ...
        @if(count($rs) > 0)
            ...
            <tr>
                ...
                <td><div class="link text-center" data="notnull" ed1="{!!$item->idjenkel!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->eselon!!}</div></div></td>
                <td><div class="link text-center" data="null" ed1="{!!$item->idjenkel!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->eselonempty!!}</div></div></td>
                <td><div class="link text-center" data="11" ed1="{!!$item->idjenkel!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_11!!}</div></div></td>
                <td><div class="link text-center" data="12" ed1="{!!$item->idjenkel!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_12!!}</div></div></td>
                <td><div class="link text-center" data="21" ed1="{!!$item->idjenkel!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_21!!}</div></div></td>
                <td><div class="link text-center" data="22" ed1="{!!$item->idjenkel!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_22!!}</div></div></td>
                <td><div class="link text-center" data="31" ed1="{!!$item->idjenkel!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_31!!}</div></div></td>
                <td><div class="link text-center" data="32" ed1="{!!$item->idjenkel!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_32!!}</div></div></td>
                <td><div class="link text-center" data="41" ed1="{!!$item->idjenkel!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_41!!}</div></div></td>
                <td><div class="link text-center" data="42" ed1="{!!$item->idjenkel!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_42!!}</div></div></td>
                <td><div class="link text-center" data="51" ed1="{!!$item->idjenkel!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_51!!}</div></div></td>
                <td><div class="link text-center" data="52" ed1="{!!$item->idjenkel!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_52!!}</div></div></td>
                <td><div class="link text-center" data="99" ed1="{!!$item->idjenkel!!}" ed2="{!!Input::get('idskpd')!!}" ed3="{!!$idstspeg!!}" title="Lihat Detail"><div align='center'>{!!$item->_99!!}</div></div></td>
            </tr>
            @endforeach
        @else
        <tr>
