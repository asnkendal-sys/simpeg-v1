<section class="content-header">
    <h1>
        Buat Nominatif Luar Kabupaten Baru<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li><a href="#" id="back"> Nominatif Luar Kabupaten</a></li>
        <li class="active">Buat Nominatif Luar Kabupaten Baru</li>
    </ol>
</section>
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class='input-group datepicker'>
                                {!! Form::text('tmtx', ((Request::segment(5)!='')?date('d-m-Y', strtotime(Request::segment(5))):date('d-m-Y')), array('class'=> 'form-control date', 'placeholder'=>'dd-mm-yyyy')) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="hidden" name="nousul" value="{!!(Request::segment(4)!='')?Request::segment(4):''!!}" id="nousul" />
                        </div>
                    </div>
                    <div class="form-group">
                ...
                if(!$('#'+$('#simpan .nip').val()).html()){
                    bootbox.confirm("<b>Perhatian. </b>Tambahkan ke Data..?", function(r) {
                        if(r===true){
                            count += 1;
                            $.ajax({
                                url:'{!!url()!!}/emutasi/nominatifluarkabupaten/view/luarkabupaten',
                                type:'post',
