            ...
            <div class="box-body">
                <table id="tabel-cuti" class="table table-hovered table-stripped" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="text-center" width="2%"> : </td>
                        <td><input type="text" value="{!! $rs->k_tahunan_n2 !!}" name="k_tahunan_n2" class="form-control num maxtahunan6"></td>
                        <td>Hari</td>
                    </tr>
                    <tr>
                        <td>Cuti Tahunan N-1</td>
                        <td class="text-center" width="2%"> : </td>
                        <td><input type="text" value="{!! $rs->k_tahunan_n1 !!}" name="k_tahunan_n1" class="form-control num maxtahunan6"></td>
                        <td>Hari</td>
                    </tr>
                    <tr>
                        <td>Cuti Tahunan N</td>
                        <td class="text-center" width="2%"> : </td>
                        <td><input type="text" value="{!! $rs->k_tahunan_n !!}" name="k_tahunan_n" class="form-control num maxtahunan12"></td>
                        <td>Hari</td>
                    </tr>
                    <tr>
                        <td>Cuti Besar</td>
                        ...
                        <td>
                            <table class="tablex" border="0" width="100%">
                                <tr>
                                    ...
                                    <td><input type="text" value="{!! $rs->k_besar_bulan !!}" name="k_besar_bulan" class="form-control num" size=4></td>
                                    <td>Bulan</td>

                                    <td><input type="text" value="{!! $rs->k_besar_hari !!}" name="k_besar_hari" class="form-control num" size=4></td>
                                    <td>Hari</td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table class="tablex" border="0" width="100%">
                                <tr>
                                    <td><input type="text" value="{!! $rs->k_sakit_tahun !!}" name="k_sakit_tahun" class="form-control num" size=4></td>
                                    <td>Tahun</td>

                                    <td><input type="text" value="{!! $rs->k_sakit_bulan !!}" name="k_sakit_bulan" class="form-control num" size=4></td>
                                    <td>Bulan</td>

                                    <td><input type="text" value="{!! $rs->k_sakit_hari !!}" name="k_sakit_hari" class="form-control num" size=4 ></td>
                                    <td>Hari</td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table class="tablex" border="0" width="100%">
                                <tr>
                                    ...
                                    <td><input type="text" value="{!! $rs->k_penting_bulan !!}" name="k_penting_bulan" class="form-control num" size=4></td>
                                    <td>Bulan</td>

                                    <td><input type="text" value="{!! $rs->k_penting_hari !!}" name="k_penting_hari" class="form-control num" size=4 ></td>
                                    <td>Hari</td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table class="tablex" border="0" width="100%">
                                <tr>
                                    <td><input type="text" value="{!! $rs->k_cltn_tahun !!}" name="k_cltn_tahun" class="form-control num" size=4></td>
                                    <td>Tahun</td>

                                    <td><input type="text" value="{!! $rs->k_cltn_bulan !!}" name="k_cltn_bulan" class="form-control num" size=4></td>
                                    <td>Bulan</td>

                                    <td><input type="text" value="{!! $rs->k_cltn_hari !!}" name="k_cltn_hari" class="form-control num" size=4 ></td>
                                    <td>Hari</td>
                                </tr>
                            </table>
                        </td>
