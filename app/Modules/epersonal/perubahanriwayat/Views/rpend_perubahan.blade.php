                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="box box-success">
                                                    ...
                                                    $dokumenijazah = \DB::connection('efile_2017')->table('files_temp')
                                                        ->where('subjenis', '=', $item->id)
                                                        ->where('nip', '=', $item->nip)
                                                        ->where('jenis', '=', '8')
                                                        ->first();
                                                    $dokumentranskrip = \DB::connection('efile_2017')->table('files_temp')
                                                        ->where('subjenis', '=', $item->id)
                                                        ->where('nip', '=', $item->nip)
                                                        ->where('jenis', '=', '77')
                                                        ->first();
                                                    ...
                                                    <!-- candra rubah,pindah ke atas -->
                                                    @if((Input::get('flag') == 1) or (Input::get('flag') == 3))
                                                    <!-- candra pindah ke atas -->
                                                    <div class="col-md-6">
                                                        <div class="box-header">
                                                            <h3 class="box-title"><i class="fa fa-fw fa-child"></i> DOKUMEN PENDUKUNG</h3>
                                                        </div>
                                                        <div class="box-body">
                                                            <div class="col-md-12 data-awal">
                                                                <div class="accordion" id="accordionExample">
                                                                    <div class="card">
                                                                        ...
                                                                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                                                            <div class="card-body">
                                                                                <?php
                                                                                $destinationPath = url() . '/efile/packages/upload/files/' . substr($dokumenijazah->nip, 0, 4) . '/' . $dokumenijazah->nip;
                                                                                $imageijazah = $destinationPath . '/' . $dokumenijazah->filename;

                                                                                if ($imageijazah != '') {
                                                                                    echo '<iframe src="' . $imageijazah . '"
                                                                                    width="800" height="500" id="ijazah"></iframe>';
                                                                                }
                                                                                ?>
                                                                    ...
                                                                    <div class="card">
                                                                        ...
                                                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                                                            <div class="card-body">
                                                                                <?php
                                                                                $destinationPath = url() . '/efile/packages/upload/files/' . substr($dokumentranskrip->nip, 0, 4) . '/' . $dokumentranskrip->nip;
                                                                                $imagetranskrip = $destinationPath . '/' . $dokumentranskrip->filename;

                                                                                if ($imagetranskrip != '') {

                                                                                    echo '<iframe src="' . $imagetranskrip . '"
