...
<div>
    {!! Form::open(array('url' => url().'/pppk/perpanjangankontrak/simpanspkinduk', 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax'),'id'=>'form-spk-induk')) !!}
...
<script type="text/javascript">
    ...
    $('#form-spk-induk').on('submit',function(e){
        e.preventDefault();
        $.ajax({
            url : '{!! url('') !!}/pppk/perpanjangankontrak/simpanspkinduk',
            type : 'post',
            data: $(this).serialize(),
            beforeSend: function(){
                preloader.on();
