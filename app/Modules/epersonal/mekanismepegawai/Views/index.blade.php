<section class="content-header">
    <h1>
        Mekanisme Pegawai<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li class="active">Mekanisme Pegawai</li>
    </ol>
</section>
<section class="content">
    <div class="box box-primary row">
        <div class="col-md-12" style="margin-bottom: 30px; margin-top: 25px;">
            <div class="box-tools pull-right col-lg-9 pull-right">
                {!! Form::open(array('url' => \Request::path()."/filter", 'method' => 'POST', 'class' => 'form-'.\Config::get('claravel::ajax'),'id' => 'filter' )) !!}
                        ...
                        <td style="padding: 5px;" width="65%">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-success" type="button" id="prev-mekanisme"><span class="glyphicon glyphicon-search"></span> Preview</button>
                                </span>
                            </div>
                        </td>
                        <td>
                            <a class="btn btn-success" href="javascript:void(0)" id="excel-mekanisme" title="Download Mekanisme Pegawai"><i class="fa fa-file-excel-o"></i> Excel</a>
                        </td>
                    </tr>
                </table>
                {!! Form::close() !!}
        ...
        <div class="col-md-12">
            <div id="result" class="table-responsive">
                <div align="center">
                    REKAPITULASI : JUMLAH CALON / PEGAWAI NEGERI SIPIL PADA SEKRETARIAT DAERAH, LEMBAGA TEKNIS DAERAH<br/>
                    DINAS DAERAH DAN KECAMATAN DI {!!strtoupper(getUtility('kab_instansi'))!!}<br/>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#prev-mekanisme').on('click',function(e){
            e.preventDefault();
            $.ajax({
                url : '{!!url()!!}/epersonal/mekanismepegawai/filter',
                type : 'post',
        ...
        $('#excel-mekanisme').on('click', function(e){
            e.preventDefault();
            $('#filter').attr("action", "{!!url()!!}/epersonal/mekanismepegawai/excel/mekanisme");
            $('#filter').submit();
            //cetak_excel('result');
        });
    });
