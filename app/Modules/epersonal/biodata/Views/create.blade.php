      ...
      <div class="row">
        <div class="col-md-12">
            <div class="box-header with-border">
                <span class="pull-left"><h3 class="box-title">BIODATA PEGAWAI {!!\getGaji(11, '2')!!}</h3></span>
                            ...
                            <div id="riwayat" class="tab-pane">
                                ...
                                <div class="nav-tabs-custom" style="box-shadow:none;">
                                    <ul class="nav nav-tabs tab2" id="myTab">
                                        ...
                                        <li><a data-toggle="tab" href="#rbahasa"><i class="fa fa-fw fa-dot-circle-o"></i> PENGUASAAAN BAHASA</a></li>
