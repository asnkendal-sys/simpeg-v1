        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-tabs tab1" id="myTab">
                    ...
                    <li class="active"><a href="{!!url()!!}/pppk/perpanjangankontrak/indexnominatif"> <i class="fa fa-fw fa-list-ul"></i> PENETAPAN PERPANJANGAN PPPK</a></li>                    
                </ul>
                    ...
                    <p>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-left">
                                <li><a href="{!! url('pppk/perpanjangankontrak/create') !!}" id="buat"><i class='fa fa-plus-square'></i> Nominatif</a></li>                                
                                <li><a href="{!! url('pppk/perpanjangankontrak/createaps') !!}" id="buataps"><i class='fa fa-plus-square'></i> Non Nominatif</a></li>                                
                            </ul>
                        </div>
                    </p>                       
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>Status Usulan</td>
                                <td>:</td>
                                <td>{!! PerpanjangankontrakModel::comboStatususulan("status",Input::get('status'),"",".: Status Usulan :.")!!}</td>                                
                            </tr>
                            <tr>
                                <td>TTE</td>
                                <td>:</td>
                                ...
                                <td>
                                    ...
                                    @if(count($rpppk) > 0)
                                        @if(Input::get('bulan') != '' && Input::get('tahun') != '' && Input::get('idskpd') == '' && Input::get('statussk') == '' && Input::get('pencarian') == '' && Input::get('status_tte') == '')
                                            @if(PerpanjangankontrakModel::cekSkinduk(Input::get('bulan'), Input::get('tahun')) > 0)
                                            ...
                                            @endif
                                            <a class="btn btn-warning" href="{!! url('') !!}/pppk/perpanjangankontrak/cetak/nominatifsk/all/{!! Input::get('bulan') !!}/{!! Input::get('tahun') !!}" target="_blank" title="Cetak CPPPK"><i class="fa fa-print"></i> Cetak Nominatif</a>
                                            {{-- <a class="btn btn-success" href="{!! url('') !!}/pppk/perpanjangankontrak/cetak/sp/all/{!! Input::get('bulan') !!}/{!! Input::get('tahun') !!}" target="_blank" title="Cetak SP"><i class="fa fa-print"></i> Cetak SP</a>
                                            <a class="btn btn-success" href="{!! url('') !!}/pppk/perpanjangankontrak/cetak/spk/all/{!! Input::get('bulan') !!}/{!! Input::get('tahun') !!}" target="_blank" title="Cetak SPK"><i class="fa fa-print"></i> Cetak SPK</a> --}}
                                        @endif
                                    @endif
                                </td>
                            </tr>
                                                ...
                                                <div class="text-right">
                                                        {{-- <div class="btn-group">                                                            
                                                            ...
                                                            <ul class="dropdown-menu pull-right">
                                                                <li><a href="{!! url('') !!}/pppk/perpanjangankontrak/cetak/pengantarsk/kolektif/{!! $pppk->kdunit !!}/{!! $pppk->tmtawal !!}" target="_blank" title="Cetak Pengantar"><i class="fa fa-print"></i> Pengantar</a></li>
                                                                <li><a href="{!! url('') !!}/pppk/perpanjangankontrak/cetak/nominatifsk/kolektif/{!! $pppk->kdunit !!}/{!! $pppk->tmtawal !!}" target="_blank" title="Cetak Nominatif"><i class="fa fa-print"></i> Nominatif</a></li>                                                                    
                                                            </ul>
                                                        </div> --}}
                                                        ...
                                                        <div class="btn-group">                                                            
                                                            ...
                                                            <ul class="dropdown-menu pull-right">
                                                                <li><a href="{!! url('') !!}/pppk/perpanjangankontrak/cetak/nominatifsk/kolektif/{!! $pppk->kdunit !!}/{!! $pppk->tmtawal !!}" target="_blank" title="Cetak CPPPK"><i class="fa fa-print"></i> Cetak Nominatif</a></li>
                                                                ...
                                                                <li><a href="{!! url('') !!}/pppk/perpanjangankontrak/cetak/spk/kolektif/{!! $pppk->kdunit !!}/{!! $pppk->tmtawal !!}" target="_blank" title="Cetak SPK"><i class="fa fa-print"></i> Cetak SPK</a></li> --}}
                                                            </ul>
                                                        </div>
                                                        &nbsp;
                                                        @if(session('idskpd') <= 2)                                                        
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                ...
                                                @else
                                                    {{-- <li><a href="{!! url('') !!}/pppk/perpanjangankontrak/cetak/sp/{!! $pppk->id !!}/{!! $pppk->nip !!}" target="_blank" title="Cetak SP"><i class="fa fa-print"></i> Cetak SP</a></li>
                                                    <li><a href="{!! url('') !!}/pppk/perpanjangankontrak/cetak/spk/{!! $pppk->id !!}/{!! $pppk->nip !!}" target="_blank" title="Cetak SPK"><i class="fa fa-print"></i> Cetak SPK</a></li> --}}
                                                @endif
                                            </ul>
                                        </div>
...
<script>    
    ...
    $(document).ready(function(){
        ...
        $('#edit-sk-induk-all').on('click', function(e){
            ...
            claravel_modal('Edit No. SK Induk','Loading...','main_modal');
            $.ajax({
                url : '{{url()}}/pppk/perpanjangankontrak/editskinduk',
                type : 'get',
                data: {
                    'tipe': tipe,                     
                    'bulan': bulan,
        ...
        $('#edit-sp-induk-all').on('click', function(e){
            ...
            $.ajax({
                url : '{{url()}}/pppk/perpanjangankontrak/editspinduk',
                type : 'get',
                data: { 
                    'tipe': tipe,
                    'bulan': bulan,
        ...
        $('#edit-spk-induk-all').on('click', function(e){
            ...
            $.ajax({
                url : '{{url()}}/pppk/perpanjangankontrak/editspkinduk',
                type : 'get',
                data: { 
                    'tipe': tipe,
                    'bulan': bulan,
        ...
        $('.attrpengantaropd').on('click', function(e){
            ...
            $.ajax({
                type:'post',
                url : '{!!url()!!}/pppk/perpanjangankontrak/data/suratpengantar',
        ...
        $('#tabel').on('click','#hapus-pppk',function(e){
            ...
            bootbox.confirm('Hapus Usulan Perpanjangan PPPK ?',function(a){
                if(a == true){
                    $.ajax({
                        url : '{!!url()!!}/pppk/perpanjangankontrak/delete',
                        type : 'post',
        ...
        $('a.edit-pppk').on('click', function(e){
            ...
            $.ajax({
                type:'post',
                url : '{!!url()!!}/pppk/perpanjangankontrak/data/edit',
        ...
        $('a.verifikasi-pppk').on('click', function(e){
            ...
            $.ajax({
                type:'post',
                url : '{!!url()!!}/pppk/perpanjangankontrak/data/verifikasi',
                data: {'idpppk': $(this).attr('recidpppk'), 'nip': $(this).attr('recnip'), '_token' : '{!!csrf_token()!!}'},
                success:function(html){
                    $('#main_modal2 .modal-body').html(html);
                }
        ...
        $('#tabel').on('click','.ajukantte', function(e){
            ...
            bootbox.confirm('Ajukan TTE ?',function(r){
                if(r){ 
                    $.ajax({
                        url : '{!!url()!!}/pppk/perpanjangankontrak/ajukantte',
                        type : 'post',
        ...
        $('#excel-nominatif').on('click', function(e){
            ...
            if(bulan != '' && tahun !=''){
                let form = $('#cari');
                let url = '{!!url()!!}/pppk/perpanjangankontrak/excel/rekapusulan';
