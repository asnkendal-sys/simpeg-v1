...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#prev-nominatif').on('click', function(e){
            e.preventDefault();
            $.ajax({
                url : '{!!url()!!}/kenaikangajiberkala/nominatifpenjagaan/data/nominatif',
                type : 'post',
                ...
                beforeSend:function(){
                    if($('#bulan').val() != ''){
                        ...
                        bootbox.alert('Pilihan bulan harus diisi !');
                    }
        ...
        $('#cetak-nominatif').on('click', function(e){
            e.preventDefault();
            if($('#bulan').val() != ''){
                $('#nominatif-pegawai').attr("action", "{!!url()!!}/kenaikangajiberkala/nominatifpenjagaan/print/nominatif");
        ...
        $('#excel-nominatif').on('click', function(e){
            e.preventDefault();
            if($('#bulan').val() != ''){
                $('#nominatif-pegawai').attr("action", "{!!url()!!}/kenaikangajiberkala/nominatifpenjagaan/excel/nominatif");
                $('#nominatif-pegawai').submit();
            }else{
                bootbox.alert('Pilihan bulan harus diisi !');
            }
