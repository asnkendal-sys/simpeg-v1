<section class="content-header">
    <h1>
        Template SK Mutasi<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li class="active">Template SK Mutasi</li>
    </ol>
</section>
        ...
        <div class="box-header with-border row">
            <div class="col-md-12">
                <ul class="nav nav-tabs tab1" id="myTab">
                    ...
                    <li class="active"><a href="{!!url()!!}/emutasi/templateskmutasi/skmutasi"> <i class="fa fa-fw fa-list-ul"></i> SK Mutasi</a></li>
                    @endif
                </ul>

                <div class="tab-pane active"><br>

                    {!! Form::open(array('url' => url()."/emutasi/templateskmutasi/savetemplate", 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax'),'id'=>'simpan')) !!}
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                {!!TemplateskmutasiModel::comboJnsmutasi('jnssurat','','')!!}
                            </div>
                            <div class="col-sm-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea rows="10" cols="600" name="template" class="ckeditor form-control" id="template" placeholder="MUTASI">
                                    <?php
                                    $cek = TemplateskmutasiModel::getTemplate(session('idskpd'), 2,'template');
                                    if($cek != 0){
                                        echo TemplateskmutasiModel::getTemplate(session('idskpd'), 2,'template');
                                    }
                                    else{
                                        echo  TemplateskmutasiModel::getTemplate('all', 2,'template');
                                    }
                                    ?>
                                </textarea>
                            </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#idskpd').on('change', function(e){
            ...
            $.ajax({
                type : 'post',
                url: '{!!url()!!}/emutasi/templateskmutasi/template',
