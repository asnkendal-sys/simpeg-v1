<section class="content-header">
    <h1>
        Edit Manajemen User<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li><a href="#" id="back"> Manajemen User</a></li>
        <li class="active">Edit Manajemen User</li>
    </ol>
</section>
<section class="content">
  <div class="box box-primary">
    ...
    <div class="row">
      <div class="col-md-12">
        {!! Form::model($manajemenuser, array('url' => $uri, 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax') ,'id'=>'simpan')) !!}
        {!! Form::hidden('id') !!}
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    {!! comboRole("role_id",$manajemenuser->role_id,"") !!}
                </div>
            </div>
            <div id="xmenu"></div>
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    {!!comboSkpd2("idskpd",$manajemenuser->idskpd,"")!!}
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <div class='input-group date' id='datetimepicker1'>
                        <input type='text' id="datetime1" name="aktif_mulai" class="form-control datetime" value="{!!$manajemenuser->aktif_mulai!!}" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <div class='input-group date' id='datetimepicker2'>
                        <input type='text' id="datetime2" name="aktif_selesai" class="form-control datetime" value="{!!$manajemenuser->aktif_selesai!!}" />
                    <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                    </div>
    ...
    $(document).ready(function(){
        ...
        $('#role_id').on('change', function(e){
            ...
            $.ajax({
                ...
                type : 'POST',
                data : {'role_id': role_id, 'context_id': '{!!$manajemenuser->idcontexts!!}', '_token': '{!!csrf_token()!!}' },
                beforeSend: function(){
                    preloader.on();
                },
                success:function(html){
