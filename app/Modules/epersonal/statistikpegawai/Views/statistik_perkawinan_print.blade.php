...
<?php
    $where = " tb_01.idjenkedudupeg not in (99,21) and tb_01.idstskawin='".Input::get('idstskawin')."' and tb_01.idstspeg in (".Input::get('idstspeg').")";
    $skpd = getSkpd(Input::get('idskpd'));
    $golru = getAttr('a_golruang', 'idgolru', Input::get('idgolru'), 'golru');
    $stskawin = getAttr('a_stskawin', 'idstskawin', Input::get('idstskawin'), 'stskawin');
...
<h3>BERDASARKAN  STATUS PERKAWINAN {!!$stskawin!!}</h3>
</div><br>
    <table border="1">
