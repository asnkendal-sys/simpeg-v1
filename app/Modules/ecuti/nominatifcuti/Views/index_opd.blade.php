...
<section class="content">
        ...
        <div class="table-responsive">
            <div class="box-body no-padding">
                <table class="table table-striped table-hover table-condensed table-bordered" id='tabel'>
                            ...
                            <tr>
                                ...
                                <th style="position:relative;" colspan="6">
                                    <div class="text-right">
                                        ...
                                        rectglusul="{!!$nominatifcuti->tgl_usul!!}" 
                                        style="color: green;"><i class="fa fa-plus"> Tambah</i></a> |

                                        <!-- &nbsp;<a href="javascript::void(0)" target="_blank" class="cetaknominatif" 
                                            recnousul="{!!$nominatifcuti->nousul!!}" ><i class="fa fa-print"> Cetak</i></a> |&nbsp; -->

                                            <?php // if(CekNominatifSudahAdaYangDisetujui($nominatifcuti->nousul) == 0) ?>
                                            <a href="javascript:void(0)" class="hapusnominatif" recnousul="{!!$nominatifcuti->nousul!!}"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">{!!$nominatifcuti->lama_cuti!!}</td>

                                    <td class="text-center verusulanx editusulan" recidusul="{!!$nominatifcuti->id!!}" 
                                        recnip="{!!$nominatifcuti->nip!!}" 
                                        recnousul="{!!$nominatifcuti->nousul!!}" 
                                        recnama="{!!$nominatifcuti->namalengkap!!}"
                                        style="vertical-align: middle;">{!! getStatusCuti($nominatifcuti->opd_status) !!}
                                    </td>

                                    <td class="text-center verusulanx penykuotax" 
                                    recidusul="{!!$nominatifcuti->id!!}" 
                                    recnip="{!!$nominatifcuti->nip!!}" 
                                    recnousul="{!!$nominatifcuti->nousul!!}" 
                                    recnama="{!!$nominatifcuti->namalengkap!!}" 
                                    style="vertical-align: middle;">{!! getStatusCuti($nominatifcuti->atasan_status) !!}
                                </td>

                                <td class="text-center verusulanx" recidusul="{!!$nominatifcuti->id!!}" 
                                    recnip="{!!$nominatifcuti->nip!!}" 
                                    recnousul="{!!$nominatifcuti->nousul!!}" style="vertical-align: middle;">{!! getStatusCuti($nominatifcuti->wewenang_status) !!}</td>
                                    <td style="vertical-align: middle;">
                                        <div class="btn-group">
                                           ...
                                           <ul class="dropdown-menu pull-right">
                                            @if($nominatifcuti->wewenang_status != 1 || $nominatifcuti->atasan_status != 1)
                                            <!-- <li>
                                            ...
                                            @else
                                            <li>
                                                <a href="javascript:void(0)" class="text-info sudahver" style="color: red; cursor: not-allowed;">
                                                    <i class="fa fa-pencil-square-o"></i>Edit</a>
                                                </li>
                                                @endif
                                                <li>
                                                    ...
                                                    recnip="{!!$nominatifcuti->nip!!}" 
                                                    recnousul="{!!$nominatifcuti->nousul!!}">
                                                    <i class="fa fa-check"></i>Verifikasi Usulan</a>
                                                    @else
                    ...
                    <!-- <tr>
                        <td style="height: 10px;" colspan="11"><em>Pengajuan Cuti Terhadap Tanggal Mulai : <b></b></em> Hari</td>
                    </tr> -->
    ...
    <div class="box-footer clearfix">
      ...
      <div class="col-sm-6">
          <?php echo $nominatifcutis->appends(array(
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('.tambahnominatif').on('click', function(e){
            e.preventDefault();
            $.ajax({
        ...
        $('.verusulan').on('click', function(e){
            e.preventDefault();
            claravel_modal('Verifikasi Nominatif Usulan Cuti','Loading...','main_modal2');
            $.ajax({
                type:'post',
                url : '{!!url()!!}/ecuti/nominatifcuti/modal/verifikasiopd',
        ...
        $('.hapusnominatif').on('click', function(e){
            e.preventDefault();
            var $this =$(this);
            var nousul =  $this.attr('recnousul');
            bootbox.confirm('Hapus?',function(a){
                if(a == true){
                    $.ajax({
                        url : '{!!url()!!}/ecuti/nominatifcuti/hapusnominatif',
                        type : 'post',
