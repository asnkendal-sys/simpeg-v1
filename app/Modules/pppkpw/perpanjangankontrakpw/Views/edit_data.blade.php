<form id="form-edit" class="form-horizontal" method="POST" action="{!!url()!!}/pppkpw/perpanjangankontrakpw/updatepppkpw" accept-charset="UTF-8">
                        ...
                        <span class="xstatus">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class='input-group datepicker'>
                                        {!! Form::text('tmtawal', null, array('class'=> 'form-control date', 'readonly' => 'readonly', 'id' => 'tmtawal', 'placeholder'=> 'dd-mm-yyyy')) !!}
                                ...
                                <div class="col-sm-3">
                                    <div class='input-group datepicker'>
                                        {!! Form::text('tmtakhir', null, array('class'=> 'form-control date', 'readonly' => 'readonly', 'id' => 'tmtakhir', 'placeholder'=> 'dd-mm-yyyy')) !!}
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <input type="text" id="idgolru" name="idgolru" value="PW" class="form-control" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    {!! Form::text('thkerja', null, array('class'=> 'form-control num', 'readonly' => 'readonly', 'maxlength'=> '2', 'placeholder'=> '00')) !!}
                                </div>
                                <div class="col-sm-1" style="margin-top: 7px;">
                                    Tahun
                                </div>
                                <div class="col-sm-2">
                                    {!! Form::text('blkerja', null, array('class'=> 'form-control num', 'readonly' => 'readonly', 'id'=> 'blkerja', 'maxlength'=> '2', 'placeholder'=> '00')) !!}
                                </div>
                                <div class="col-sm-1" style="margin-top: 7px;">
                                    Bulan
                                </div>
...
<script type="text/javascript">
    ...
    function cekBerkas(nip) {
        $.ajax({
            url: '{{url('')}}/pppkpw/perpanjangankontrakpw/cekberkas',
            type: 'post',
            data: {
                'nip': nip,
                '_token': '{!!csrf_token()!!}'
