        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-tabs tab1" id="myTab">
                    ...
                    <li class="active"><a href="{!!url()!!}/epersonal/statistikpegawai/rekappegawai"> <i class="fa fa-fw fa-list-ul"></i> REKAP PEGAWAI</a></li>
...
<li class=""><a href="{!!url()!!}/epersonal/statistikpegawai/statistikabk"> <i class="fa fa-fw fa-list-ul"></i> STATISTIK ABK</a></li>
                ...
                {!! Form::open(array('url' => \Request::path(), 'method' => 'POST', 'class' => 'form-horizontal  form-'.\Config::get('claravel::ajax'),'id' => 'cari_rekap', 'target'=>'_blank' )) !!}
                {!!csrf_field()!!}
                <div class="box-body">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#prev-statistik').on('click', function(e){
            e.preventDefault();
            $.ajax({
                url:'{{url()}}/epersonal/statistikpegawai/data/statistikrekap',
                type:'post',
                data:{ 'idskpd':$('#idskpd').val(),'idkategori':$('#idkategori').val(),'_token' : '{!!csrf_token()!!}'},
                beforeSend:function(){
        ...
        $('#cetak-statistik').on('click', function(e){
            e.preventDefault();
            $('#cari_rekap').attr("action", "{!!url()!!}/epersonal/statistikpegawai/print/statistikrekap");
            $('#cari_rekap').submit();
        });
