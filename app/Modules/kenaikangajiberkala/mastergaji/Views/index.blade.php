...
<section class="content">
    <div class="box box-primary">
        <ul class="nav nav-tabs tab1" id="myTab">
            <li class="active"><a href="{!!url()!!}/kenaikangajiberkala/mastergaji"> <i class="fa fa-fw fa-list-ul"></i> MASTER GAJI PNS</a></li>
            <li class=""><a href="{!!url()!!}/kenaikangajiberkala/mastergaji/datagajip3k"> <i class="fa fa-fw fa-list-ul"></i> MASTER GAJI PPPK</a></li>
        </ul><br>
        <div class="box-header with-border">
            {!! ClaravelHelpers::btnCreate() !!}
            <a id="ubahtahun" href="javascript:void(0)" class="btn btn-success"><i class="fa fa-pencil"></i> Master Gaji Aktif <b>{!!MastergajiModel::getTahunkgb()!!}</b></a>
        ...
        <div class="table-responsive">
            <div class="box-body no-padding">
                <table class="table table-striped table-hover table-condensed table-bordered" id='tabel'>
                    ...
                    <tbody>
                    @foreach ($mastergajis as $mastergaji)
                    <tr>
                        <td><center>{!! ClaravelHelpers::ckDelete($mastergaji->status); !!}</center></td>
                        <td>{!!$mastergaji->golru!!}</td>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li>{!! ClaravelHelpers::btnEdit($mastergaji->id) !!}</li>
                                    <li>{!! ClaravelHelpers::btnDelete($mastergaji->id) !!}</li>
                                </ul>
                            </div>
                        </td>
                    </tr>
        ...
        <div class="box-footer clearfix">
          <div class="row">
            ...
            <div class="col-sm-6">
              <?php echo $mastergajis->appends(array('search' => Input::get('search')))->render(); ?>
            </div>
          </div>
        </div>
        {!! Form::close() !!}
