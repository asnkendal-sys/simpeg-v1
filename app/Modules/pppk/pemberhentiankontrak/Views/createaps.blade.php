<section class="content-header">
    <h1>
        Buat Pemberhentian Non Nominatif<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li><a href="#" id="back"> Pemberhentian Non Nominatif</a></li>
        <li class="active">Buat Pemberhentian Non Nominatif</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            ...
            <div class="callout callout-success">
                ...
                <ul style="padding-left: 15px">
                    ...
                    <li>Isikan atribut status pemberhentian APS/JADUD/UZUR/TEWAS/PDHTAPS</li>
                    <li>Isian Nominatif dapat lebih dari 1 orang</li>
                    <li>Untuk menyimpan nominatif pensiun pilih tombol simpan</li>
                </ul>

                " Pemberhentian Non Nominatif digunakan melakukan penetapan pemberhentian kontrak pegawai PPPK Atas Permintaan Sendiri/Janda/Duda/Keuzuran/Tewas/Pemberhentian Dengan Hormat Tidak Atas Permintaan Sendiri "
            </div>
        ...
        function addList(){
            if($('#simpan .nip').val() != ''){
                ...
                if(!$('#'+$('#simpan .nip').val()).html()){
                    ...
                    $.ajax({
                        url:'{!!url()!!}/pppk/pemberhentiankontrak/ceknominatif',
                        type:'post',
                            ...
                            if(response == 1){
                                ...
                                bootbox.confirm("<b>Perhatian. </b>Tambahkan ke Data..?", function(r) {
                                    if(r===true){
                                        count += 1;
                                        $.ajax({
                                            url:'{!!url()!!}/pppk/pemberhentiankontrak/view/nonnominatif',
                                            type:'post',
                                            data:{ 'nip':$('#simpan .nip').val(), '_token' : '{!!csrf_token()!!}', 'n':count },
                                            beforeSend:function(){},
                                            success:function(response){
