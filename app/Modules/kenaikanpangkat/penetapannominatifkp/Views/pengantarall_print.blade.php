...
<body>
    ...
    \DB::table('tr_kenaikan_pangkat')->where('tmt', 'like', $tmt.'%')->where('idskpd', 'like', $idskpd. '%')->update($data);
    ...
    ->where('tr_kenaikan_pangkat.tmt', 'like', $tmt.'%')->where('tr_kenaikan_pangkat.idskpd', 'like', $idskpd. '%')
    ->take(1)
    ->get();
