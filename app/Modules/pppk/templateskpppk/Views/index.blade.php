<section class="content-header" style="margin-bottom: 0 !important;">
    <h1>
        Template SK PPPK<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li class="active">Template SK PPPK</li>
    </ol>
</section>
...
<script>
    ...
    function getTemplatecpppk(){
        ...
        $.ajax({
            type:'post',
            url:'{!!url()!!}/pppk/templateskpppk/data/templatecpppk',
    ...
    function getTemplatesp(){
        ...
        $.ajax({
            type:'post',
            url:'{!!url()!!}/pppk/templateskpppk/data/templatesp',
            data: {'_token': '{!!csrf_token()!!}'},
            beforeSend:function(){
                preloader.on();
            },
    ...
    function getTemplateberhenti(){
        ...
        $.ajax({
            type:'post',
            url:'{!!url()!!}/pppk/templateskpppk/data/templateberhenti',
            data: {'_token': '{!!csrf_token()!!}'},
            beforeSend:function(){
                preloader.on();
            },
    ...
    function getTemplatespk(){
        ...
        $.ajax({
            type:'post',
            url:'{!!url()!!}/pppk/templateskpppk/data/templatespk',
            data: {'_token': '{!!csrf_token()!!}'},
            beforeSend:function(){
                preloader.on();
            },
    ...
    function getTemplatepetikan(){
        ...
        $.ajax({
            type:'post',
            url:'{!!url()!!}/pppk/templateskpppk/data/templatepetikan',
            data: {'_token': '{!!csrf_token()!!}'},
            beforeSend:function(){
                preloader.on();
            },
    ...
    function getTemplatepengantar(){
        ...
        $.ajax({
            type:'post',
            url:'{!!url()!!}/pppk/templateskpppk/data/templatepengantar',
            data: {'_token': '{!!csrf_token()!!}'},
            beforeSend:function(){
                preloader.on();
            },
    ...
    function getTemplatepetikanperpanjangan(){
        ...
        $.ajax({
            type:'post',
            url:'{!!url()!!}/pppk/templateskpppk/data/templatepetikanperpanjangan',
            data: {'_token': '{!!csrf_token()!!}'},
            beforeSend:function(){
                preloader.on();
            },
    ...
    function getTemplatepemberhentianbup(){
        ...
        $.ajax({
            type:'post',
            url:'{!!url()!!}/pppk/templateskpppk/data/templatepemberhentianbup',
            data: {'_token': '{!!csrf_token()!!}'},
            beforeSend:function(){
                preloader.on();
            },
    ...
    function getTemplatepemberhentiannonbup(){
        ...
        $.ajax({
            type:'post',
            url:'{!!url()!!}/pppk/templateskpppk/data/templatepemberhentiannonbup',
            data: {'_token': '{!!csrf_token()!!}'},
            beforeSend:function(){
                preloader.on();
            },
    ...
    function getTemplatepemberhentiankeuzuran(){
        ...
        $.ajax({
            type:'post',
            url:'{!!url()!!}/pppk/templateskpppk/data/templatepemberhentiankeuzuran',
            data: {'_token': '{!!csrf_token()!!}'},
            beforeSend:function(){
                preloader.on();
            },
    ...
    function getTemplatepemberhentianhukdis(){
        ...
        $.ajax({
            type:'post',
            url:'{!!url()!!}/pppk/templateskpppk/data/templatepemberhentianhukdis',
            data: {'_token': '{!!csrf_token()!!}'},
            beforeSend:function(){
                preloader.on();
            },
