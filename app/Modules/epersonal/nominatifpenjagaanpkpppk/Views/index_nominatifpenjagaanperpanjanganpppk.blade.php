<section class="content-header">
    <h1>
        Nominatif Penjagaan Perpanjangan PPPK<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li class="active">Nominatif Penjagaan Perpanjangan PPPK</li>
    </ol>
</section>
        ...
        <div class="row">
            <div class="col-md-12">
                  <ul class="nav nav-tabs tab1" id="myTab">
                        <li><a href="{!!url()!!}/epersonal/nominatifpenjagaanpkpppk"> <i class="fa fa-fw fa-list-ul"></i> NOMINATIF PENJAGAAN PK PPPK</a></li>
                        @if(session('role_id') <= 3)
                        <li class="active"><a href="{!!url()!!}/epersonal/nominatifpenjagaanpkpppk/nominatifpenjagaanperpanjanganpppk"> <i class="fa fa-fw fa-list-ul"></i> NOMINATIF PENJAGAAN PERPANJANGAN PPPK</a></li>
                        @endif
                  </ul>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        {!! Form::label('tahunperpanjangan', 'Perpanjangan:', array('class' => 'col-sm-3 control-label')) !!}
                        <div class="col-sm-2">
                            {!! comboTambahangka("tahunperpanjangan","","") !!}
                        </div>                  
                    </div>
                </div>
    ...
    $(document).ready(function(){
      ...
      //   });
        ...
        $('#prev-nominatif').on('click', function(e){
            e.preventDefault();
            $.ajax({
                url : '{!!url()!!}/epersonal/nominatifpenjagaanpkpppk/data/nominatif_penjagaanperpanjangan',
                type : 'post',
        ...
        $('#cetak-nominatif').on('click', function(e){
            e.preventDefault();
            $('#nominatif-pegawai').attr("action", "{!!url()!!}/epersonal/nominatifpenjagaanpkpppk/print/nominatif_penjagaanperpanjangan");
            $('#nominatif-pegawai').submit();
        });

        $('#excel-nominatif').on('click', function(e){
            e.preventDefault();
            $('#nominatif-pegawai').attr("action", "{!!url()!!}/epersonal/nominatifpenjagaanpkpppk/excel/nominatif_penjagaanperpanjangan");
            $('#nominatif-pegawai').submit();
            /*cetak_excel('result');*/
        });
    });
