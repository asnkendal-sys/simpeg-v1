<section class="content-header">
    <h1>
        Buat Nominatif Dalam OPD Baru<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li><a href="#" id="back"> Nominatif Dalam OPD</a></li>
        <li class="active">Buat Nominatif Dalam OPD Baru</li>
    </ol>
</section>
                ...
                if(!$('#'+$('#simpan .nip').val()).html()){
                    bootbox.confirm("<b>Perhatian. </b>Tambahkan ke Data..?", function(r) {
                        if(r===true){
                            count += 1;
                            $.ajax({
                                url:'{!!url()!!}/emutasi/nominatifdalamskpd/view/dalamskpd',
                                type:'post',
