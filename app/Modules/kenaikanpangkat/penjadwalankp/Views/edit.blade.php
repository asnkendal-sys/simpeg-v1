<section class="content-header">
    <h1>
    Edit Penjadwalan KP<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li><a href="#" id="back"> Penjadwalan KP</a></li>
        <li class="active">Edit Penjadwalan KP</li>
    </ol>
</section>
<section class="content">
    ...
    ?>
    {!! Form::model($penjadwalankp, array('url' => $uri, 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax') ,'id'=>'jadwal-kp')) !!}
    {!! Form::hidden('id') !!}
            ...
            <div class="col-md-12">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!! PenetapannominatifkpModel::comboKp("bulan",$penjadwalankp->bulan,"") !!}
                        </div>
                    </div>
                    <div class="form-group">
