                    ...
                    <tbody>
                            ...
                            <tr>
                                <th style="position:relative;" colspan="6">
                                    <div class="text-left">
                                        ...
                                        <i class="fa fa-calendar"></i> <?php echo date("d-m-Y", strtotime($skmutasiantarskpd->tglusul))?>
                                        &nbsp;
                                        <?php 
                                    ...
                                    <div class="text-right">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                @if(($skmutasiantarskpd->statususul == 1) or ($skmutasiantarskpd->statussk == 1))
                                                <li><a href="<?php echo url()."/emutasi/skmutasiantarskpd/cetak/skperintahkolektif/".$skmutasiantarskpd->nousul?>" target="_blank" class="cetak" title="Cetak Pengantar Ke Sekda"><i class="fa fa-print"> </i> Surat Perintah Kolektif</a></li>
                                                <li><a href="<?php echo url()."/emutasi/skmutasiantarskpd/cetak/skkolektif_daftar/".$skmutasiantarskpd->nousul?>" class="cetak" title="Cetak SK Daftar Kolektif" data-nousul="<?=$skmutasiantarskpd->tglusul?>" target="_blank"><i class="fa fa-list"></i> Lampiran SP Kolektif</a></li>
                                                ...
                                                @else
                                                <li><a href="javascript:void(0)" class="cetak" style="color: red" title="SK Kolektif Status Belum diproses" data-nousul="<?=$skmutasiantarskpd->tglusul?>"><i class="fa fa-print"></i> Surat Perintah Kolektif</a></li>
                                                <li><a href="javascript:void(0)" class="cetak" style="color: red" title="SK Daftar Kolektif Status Belum diproses" data-nousul="<?=$skmutasiantarskpd->tglusul?>"><i class="fa fa-list"></i> Lampiran SP Kolektif</a></li>
                                                @endif

                                                <li><a href="<?php echo url()."/emutasi/skmutasiantarskpd/cetak/skperintahall/".$skmutasiantarskpd->nousul?>" class="cetak" title="Cetak Semua SP" target="_blank"><i class="fa fa-print"></i> Cetak Semua SP</a></li>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                @if(($skmutasiantarskpd->statususul == 1) or ($skmutasiantarskpd->statussk == 1))
                                                <li><a href="javascript::void(0)" class="printnota" recnousul="{!!$skmutasiantarskpd->nousul!!}" title="Cetak Pengantar Ke Sekda"><i class="fa fa-print"> </i> Nota Dinas</a></li>
                                                <li><a href="<?php echo url()."/emutasi/skmutasiantarskpd/cetak/skkolektif_daftar/".$skmutasiantarskpd->nousul?>" class="cetak" title="Cetak SK Daftar Kolektif" data-nousul="<?=$skmutasiantarskpd->tglusul?>" target="_blank"><i class="fa fa-list"></i> Lampiran Pengantar</a></li>
                                                @else
                                                <li><a href="javascript:void(0)" title="Cetak Pengantar Ke Sekda" class="cetak" style="color: red"><i class="fa fa-print"> </i> Nota Dinas</a></li>
                                                <li><a href="javascript:void(0)" class="cetak" style="color: red" title="SK Daftar Kolektif Status Belum diproses" data-nousul="<?=$skmutasiantarskpd->tglusul?>"><i class="fa fa-list"></i> Lampiran Pengantar</a></li>
                                                @endif
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <tr>
                            ...
                            <td>{!!$skmutasiantarskpd->nip!!}<br>{!!$skmutasiantarskpd->namalengkap!!}
                                ...
                                <td>{!!$skmutasiantarskpd->golru!!}<br>{!!($skmutasiantarskpd->tmtpkt!='0000-00-00')?date('d-m-Y', strtotime($skmutasiantarskpd->tmtpkt)):''!!}</td>
                                <td>{!!$skmutasiantarskpd->tkpendid!!}<br>{!!$skmutasiantarskpd->jenjurusan!!}</td>
                                <td>{!!$skmutasiantarskpd->skpdlama!!}</td>

                                <td>{!!$skmutasiantarskpd->jabatan!!}<br>{!!($skmutasiantarskpd->tmtjbt!='0000-00-00')?date('d-m-Y', strtotime($skmutasiantarskpd->tmtjbt)):''!!}</td>
                                    ...
                                    <div align="center">
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo url()."/emutasi/skmutasiantarskpd/cetak/skperintah/".$skmutasiantarskpd->nousul."/".$skmutasiantarskpd->nip?>" target="blank" title="Cetak Surat Perintah"><i class="fa fa-print"></i></a>
                                                @else
