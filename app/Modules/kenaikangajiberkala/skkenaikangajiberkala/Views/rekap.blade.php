<section class="content-header">
    <h1>
        Rekap Kenaikan Gaji Berkala<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li class="active">Rekap Kenaikan Gaji Berkala</li>
    </ol>
</section>
    ...
    <div id="rekap" class="tab-pane">
        ...
        <div class="nav-tabs-custom" style="box-shadow:none;">
            <ul class="nav nav-tabs tab2" id="myTab">
                <li><a data-toggle="tab" href="{!!url()!!}/kenaikangajiberkala/skkenaikangajiberkala"><i class="fa fa-fw fa-dot-circle-o"></i> DATA KGB</a></li>
                <li class="active"><a data-toggle="tab" href="{!!url()!!}/kenaikangajiberkala/skkenaikangajiberkala/rekap"><i class="fa fa-fw fa-dot-circle-o"></i> REKAP KGB</a></li>
            </ul>
                ...
                <div id="profesikeb" class="tab-pane active">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        {!! PenetapannominatifModel::comboJeniskgb("jnskgb",Input::get('jnskgb'),"",".: Proses :.") !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                    {!! Form::label('tanggal1', 'Tanggal SK:', array('class' => 'col-sm-3 control-label')) !!}
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    {!! Form::label('tmt1', 'TMT KGB:', array('class' => 'col-sm-3 control-label')) !!}
                                    <div class="col-sm-2">
                                        <div class='input-group datepicker'>
                                            <input type="text" name="tmt1" id="tmt1" class="form-control date awal" value="{!!Input::get('tmt1')!!}" placeholder="dd-mm-yyyy">
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"></span>
                                            </span>
                                        </div>
                                    ...
                                    <div class="col-sm-2">
                                        <div class='input-group datepicker'>
                                            <input type="text" name="tmt2" id="tmt2" class="form-control date awal" value="{!!Input::get('tmt2')!!}" placeholder="dd-mm-yyyy">
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"></span>
                                            </span>
                                        </div>
                            ...
                            <div class="box-footer">
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-9">
                                        <button class="btn btn-success" type="submit" id="cari-nominasi"><span class="fa fa-fw fa-filter"></span> Filter KGB</button>&nbsp;
                                        <button class="btn btn-success" type="button" id="cetak-sk"><span class="fa fa-fw fa-print"></span> Cetak SK KGB</button>&nbsp;
                                        <button class="btn btn-success" type="button" id="cetak-nominatif"><span class="fa fa-fw fa-print"></span> Cetak Nominatif KGB</button>&nbsp;
                                    </div>
                                </div>
                            </div>
                            {!! Form::close() !!}
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small>
                                                <div class="text-left">{!! $skkenaikangajiberkala->tmplahir !!}, {!! tglina($skkenaikangajiberkala->tgllahir) !!}</div>
                                            </small>
                                        ...
                                        <td>
                                            <small>
                                                <div class="text-left">{!! ucword($skkenaikangajiberkala->nmajab) !!} {!! ucword($skkenaikangajiberkala->tmpskpdskr) !!}</div>
                    ...
                    <div class="box-footer clearfix">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <?php echo $skkenaikangajiberkalas->appends(array('tanggal1' => Input::get('tanggal1'), 'tanggal2' => Input::get('tanggal2'), 'idskpd' => Input::get('idskpd'), 'jnskgb' => Input::get('jnskgb')))->render(); ?>
                            </div>
                        </div>
                    </div>
                    {!! Form::close() !!}
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#cari-nominasi').on('click', function(e) {
            ...
            $.ajax({
                url: '{!!url()!!}/kenaikangajiberkala/skkenaikangajiberkala/rekap',
                data: $('#cari').serialize(),
                type: 'get',
                beforeSend: function() {
                    preloader.on();
        ...
        $('#cetak-sk').on('click', function(e) {
            ...
            $('.cetak-rekap').attr("action", "{!!url()!!}/kenaikangajiberkala/skkenaikangajiberkala/rekapsk");
            $('.cetak-rekap').submit();
        });
        ...
        $('#cetak-nominatif').on('click', function(e) {
            ...
            $('.cetak-rekap').attr("method", "post");
            $('.cetak-rekap').attr("action", "{!!url()!!}/kenaikangajiberkala/skkenaikangajiberkala/rekapnominatif");
            $('.cetak-rekap').submit();
        });
    });
</script>