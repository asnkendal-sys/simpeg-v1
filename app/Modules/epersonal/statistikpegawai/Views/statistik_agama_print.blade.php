...
<?php
    $where = " tb_01.idjenkedudupeg not in (99,21) and tb_01.idagama='".Input::get('idagama')."' and tb_01.idstspeg in (".Input::get('idstspeg').")";
    $skpd = getSkpd(Input::get('idskpd'));
    $golru = getAttr('a_golruang', 'idgolru', Input::get('idgolru'), 'golru');
    $agama = getAttr('a_agama', 'idagama', Input::get('idagama'), 'agama');
