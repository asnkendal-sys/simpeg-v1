            ...
            <tr>
                <td colspan="8">
                    <table width="100%" border="0">
                        ...
                        <tr>
                            <td>
                                {!!NominatifdalamskpdModel::comboJnsjabatan('[idjenjabbaru]',$item->idjenjab,'','idjenjabbaru',Input::get('n'))!!}
                            </td>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        /*select jabjbt xjab1*/
        autoComplete(".idjabjbtbaru{!!Input::get('n')!!}", '{{url()}}/emutasi/nominatifdalamskpd/listjabstruk2', 'Jabatan Struktural ..', null, '{!!$item->idjabjbt!!}', '{!!$item->jabatan!!}');

               //jabatan fungsional xjab2
               autoComplete("#idjabfungbaru{!!Input::get('n')!!}", '{{url()}}/emutasi/nominatifdalamskpd/listjabfung2', 'Jabatan Fungsional ..', null, '{!!$item->idjabfung!!}', '{!!$item->jabatan!!}');

                //jabatan fungsional xjab3 idjabfungumbaru
                autoComplete("#idjabfungumbaru{!!Input::get('n')!!}", '{{url()}}/emutasi/nominatifdalamskpd/listjabfungum2', 'Jabatan Fungsional Umum ..', null, '{!!$item->idjabfungum!!}', '{!!$item->jabatan!!}');

                autoComplete("#idskpdbaru{!!Input::get('n')!!}", '{{url()}}/emutasi/nominatifdalamskpd/cariwhereskpd2', 'Satker ..', null, '{!!$item->idskpd!!}', '{!!$item->skpd!!}','{!! substr($item->idskpd,0,2) !!}');
            });
        </script>
