...
<form id="form-edit" class="form-horizontal" method="POST" action="{!!url()!!}/emutasi/nominatifantarskpd/verifikasimutasiantarskpd" accept-charset="UTF-8">
  <div class="row">
    <div class="col-md-12">
      <div class="col-md-6">
      ...
      <div class="col-md-6">
       <div class="box-header">
        <h3 class="box-title"><i class="fa fa-fw fa-paper-plane"></i> ATRIBUT MUTASI ANTAR OPD </h3>
      </div>
      <div class="box box-warning">
       <div class="box-body">
         <div class="col-md-12 data-atribut">
           ...
           <table class="table table-hovered table-stripped" width="100%">
             ...
             <tr class="fnonpenyegaran">
               <td width="18%"><label class="control-label">Nomor Surat<br>Rekomendasi</label></td>
               <td class="text-center" width="2%"> : </td>
               <td width="38%"><input name="no_suratrek" value="" id="no_suratrek" class="form-control" type="text"></td>
             </tr>
             <tr class="fnonpenyegaran">
               <td width="18%"><label class="control-label">Asal Surat<br>Rekomendasi</label></td>
               <td class="text-center" width="2%"> : </td>
               <td width="38%">{!!comboAsalMutasi('surat_dari','','','surat_dari','')!!}</td>
             </tr>
             <tr class="fnonpenyegaran">
               <td width="18%"><label class="control-label">Tanggal Surat<br>Rekomendasi</label></td>
               <td class="text-center" width="2%"> : </td>
               <td width="38%"><input name="tgl_suratrek" value="" id="tgl_suratrek" class="form-control" type="text" ></td>
             </tr>
             <tr class="fnonpenyegaran">
               <td width="18%"><label class="control-label">Perihal Surat<br>Rekomendasi</label></td>
               <td class="text-center" width="2%"> : </td>
               <td width="38%"><input name="perihalrek" value="" id="perihalrek" class="form-control" type="text"></td>
             </tr>
             <tr>
               <td width="18%"><label class="control-label">Jenis Jabatan</label></td>
               <td class="text-center" width="2%"> : </td>
               <td width="38%">{!!NominatifantarskpdModel::comboJnsjabatan('idjenjabbaru','','','idjenjabbaru','')!!}</td>
             </tr>
             <tr>
      ...
      <tr class="fdiperbantukan">
        <td width="18%"><label class="control-label">Status Diperbantukan</label></td>
        <td class="text-center" width="2%"> : </td>
        <td width="38%">
          <select id="isdiperbantukan" name="isdiperbantukan" class="input-large form-control isdiperbantukan" required style="width: 100%">
            <option value="0">.: Status Diperbantukan :.</option>
            <option value="1">Ya</option>
            <option value="2">Tidak</option>
          </select></td>
        </tr>
        <tr class="fdiperbantukan">
          <td width="18%"><label class="control-label">Diperbantukan Di</label></td>
          <td class="text-center" width="2%"> : </td>
          <td width="38%">{!!NominatifantarskpdModel::comboDiperbantukan('iddiperbantukan','','','iddiperbantukan','')!!}</td>
        </td>
      </tr>
      <tr>
       ...
       <td class="text-center" width="2%"> : </td>
       <td width="38%">
        <textarea rows="2" cols="3" class="form-control" name="keterangan" id="keterangan"></textarea>
      </td>
    </tr>
    <tr>
    ...
    <tr id="ftampilpenetap">
     ...
     <td class="text-center" width="2%"> : </td>
     <td width="38%"><input name="kepalabkd" id="kepalabkd" class="form-control" type="text" ></td>
   </tr>
   <tr id="ftampilpenetap">
     <td width="18%"><label class="control-label">NIP Penetap</label></td>
     <td class="text-center" width="2%"> : </td>
     <td width="38%"><input name="nipkepalabkd" id="nipkepalabkd" class="form-control" type="text" ></td>
   </tr>
   <tr id="ftampilpenetap">
     <td width="18%"><label class="control-label">Jab Penetap</label></td>
     <td class="text-center" width="2%"> : </td>
     <td width="38%"><input name="jabkepalabkd" id="jabkepalabkd" class="form-control" type="text" ></td>
   </tr>
   <tr id="ftampilpenetap">
     <td width="18%"><label class="control-label">Pangkat Penetap</label></td>
     <td class="text-center" width="2%"> : </td>
     <td width="38%"><input name="pangkatbkd" id="pangkatbkd" class="form-control" type="text" ></td>
   </tr>
 </td>
</tr>
</table>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('.data-atribut #fdiperbantukan').hide();
    $('.data-atribut .fnonpenyegaran').hide();
    /*Disabled FORM*/
    var cek_role =  {!! Session::get('role_id') !!};
    if (cek_role!=1 && cek_role!=2 ) {
    ...
    $.ajax({
      url:'{!!url()!!}/emutasi/nominatifantarskpd/verantarskpd',
      ...
      success:function(response){
        ...
        /*UNTUK FORM*/
                ...
                $('.data-atribut #isdiperbantukan').val(ret.isdiperbantukan);
                $('.data-atribut .isdiperbantukan').trigger('change');

                $('.data-atribut #iddiperbantukan').val(ret.iddiperbantukan);
                $('.data-atribut .iddiperbantukan').trigger('change');
                ...
                $('.data-atribut #no_suratrek').val(ret.no_suratrek);
                $('.data-atribut #surat_dari').val(ret.surat_dari);
                var strzz = ret.tgl_suratrek;
                var reszz = strzz.split("-");
                $('.data-atribut #tgl_suratrek').val(reszz[2]+'-'+reszz[1]+'-'+reszz[0]);
                $('.data-atribut #perihalrek').val(ret.perihalrek);
                var NonPenyegaran1 = ret.no_suratrek;
                var NonPenyegaran2 = ret.surat_dari;
                var NonPenyegaran4 = ret.perihalrek;
                if(NonPenyegaran1 !='' || NonPenyegaran2 !='' || NonPenyegaran4 !=''){
                  $('.data-atribut .fnonpenyegaran').show();
                  // alert("JOS");
                }else{
                  $('.data-atribut .fnonpenyegaran').hide();
                  // alert("OrakJos "+NonPenyegaran1+"  "+NonPenyegaran2+" "+NonPenyegaran4);
                }
                /*PENETAP*/
                ...
                var str1 = ret.tmt;
                var res1 = str1.split("-");
                $('.data-atribut #tmt').val(res1[2]+'-'+res1[1]+'-'+res1[0]);
                ...
                var jos = ret.idskpd;
                var jos2 = ret.idskpdbaru;
                // alert(jos.substr(0,2)+" "+jos2.substr(0,2));
                if(jos.substr(0,2) == "04" || jos2.substr(0,2) == "04")
                {
                  $('.data-atribut .fdiperbantukan').show();
                }
                else
                {
                  $('.data-atribut .fdiperbantukan').hide();                  
                ...
                var str5 = ret.tmtpkt;
                var res5 = str5.split("-");
                ret.tmtpkt= res5[2]+'-'+res5[1]+'-'+res5[0];
                ...
                if(ret.idjenjabbaru == 2){
                  autoComplete(".data-atribut #idjabfungbaru", '{{url()}}/emutasi/nominatifantarskpd/listjabfung2', 'Jabatan Fungsional ..', null, ret.idjabfungbaru, ret.jabatanbaru);
                }
                else if(ret.idjenjabbaru == 3){
                  autoComplete(".data-atribut #idjabfungumbaru", '{{url()}}/emutasi/nominatifantarskpd/listjabfungum2', 'Jabatan Fungsional ..', null, ret.idjabfungumbaru, ret.jabatanbaru);
                }
                else{
                  autoComplete(".data-atribut #idjabjbtbaru", '{{url()}}/emutasi/nominatifantarskpd/listjabstruk2', 'Jabatan Struktural ..', null, ret.idjabjbtbaru, ret.jabatanbaru);
                }

                autoComplete(".data-atribut #idskpdbaru", '{{url()}}/emutasi/nominatifantarskpd/cariwhereskpd2', 'Satker ..', null,  ret.idskpdbaru, ret.skpdbaru);
              }
            });
autoComplete(".data-atribut #idjabfungbaru", '{{url()}}/emutasi/nominatifantarskpd/listjabfung2', 'Jabatan Fungsional ..', null, '', '');
autoComplete(".data-atribut #idjabfungumbaru", '{{url()}}/emutasi/nominatifantarskpd/listjabfungum2', 'Jabatan Fungsional ..', null, '', '');
autoComplete(".data-atribut #idjabjbtbaru", '{{url()}}/emutasi/nominatifantarskpd/listjabstruk2', 'Jabatan Struktural ..', null, '', '');
autoComplete(".data-atribut #idskpdbaru", '{{url()}}/emutasi/nominatifantarskpd/cariwhereskpd2', 'Satker ..', null,  '','');

/*select jabjbt xjab1*/
        // autoComplete("#idjabfungbaru", '{{url()}}/emutasi/nominatifantarskpd/listjabfung2', 'Jabatan Fungsional ..', null, '', '');

        $('#form-edit').on('submit',function(e){
          var $this = $(this);
          e.preventDefault();
          bootbox.confirm('Update Data Nominatif Mutasi Antar OPD ?',function(a){
            if (a == true){
              $.ajax({
        ...
        $('.data-atribut #iddiperbantukan').hide();

        // $('.data-atribut .isdiperbantukan').change(function(){
        //     if($('.data-atribut .isdiperbantukan').val() == 1){
        //         $('.data-atribut #fdiperbantukan').show();
        //     }else{
        //         $('.data-atribut #fdiperbantukan').hide();
        //     }
