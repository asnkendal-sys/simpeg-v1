<section class="content-header" style="margin-bottom:0px">
    <h1>
        Pemberhentian PPPK<small> TTE</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li class="active">Pemberhentian PPPK</li>
    </ol>
</section>
            ...
            <div class="box-body no-padding">
                <table class="table table-striped table-hover table-condensed table-bordered" id='tabel'>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{!!$tte->jenpens!!}</td>                                  
                        <td class="text-center">
                            {!! date('d-m-Y', strtotime($tte->bup)) !!} <br>
                            {!!substr($tte->usia,0,2)." thn ".substr($tte->usia,2,2)." bln"!!}
                        </td>
    ...
    $(document).ready(function(){
        ...
        $('#data').on('submit',function(e){ 
            ...
            claravel_modal('Preview SK TTE', 'Loading...', 'main_modal2');
                $.ajax({
                    url  : '{{url('')}}/tte/pemberhentianpppk/modalpreviewpppk',
                    type : 'get',
                    data : iki.serialize(),
       ...
       $('#preview_sk_all').on('click', function(e){
            ...
            $.ajax({
                type:'post',
                url : '{!!url()!!}/tte/pemberhentianpppk/data/previewpppk',
