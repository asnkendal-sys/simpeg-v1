    ...
    foreach($rs as $item){
        ...
        $arrreplace = array("replace",
            ...
            (($item->no_suratrek!='')?"<li style='text-align: justify;'>
             ...
             Surat ".ucword($item->surat_dari)." Kabupaten Kendal Nomor : ".$item->no_suratrek." Tanggal ".formatTanggalPanjang($item->tgl_suratrek)." Perihal : ".$item->perihalrek."</span></li>":'')
            ,'<div class="qrcode'.$no.'"></div>',
            $tembusanantaropd
        );
