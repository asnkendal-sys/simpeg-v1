	...
	<tbody>
        ...
        @if(count($rs) > 0)
            ...
            <tr>
                ...
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" data="" edata="11" title="Lihat Detail"><div align='center'>{!!$item->_e11!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" data="" edata="12" title="Lihat Detail"><div align='center'>{!!$item->_e12!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" data="" edata="21" title="Lihat Detail"><div align='center'>{!!$item->_e21!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" data="" edata="22" title="Lihat Detail"><div align='center'>{!!$item->_e22!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" data="" edata="31" title="Lihat Detail"><div align='center'>{!!$item->_e31!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" data="" edata="32" title="Lihat Detail"><div align='center'>{!!$item->_e32!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" data="" edata="41" title="Lihat Detail"><div align='center'>{!!$item->_e41!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" data="" edata="42" title="Lihat Detail"><div align='center'>{!!$item->_e42!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" data="" edata="51" title="Lihat Detail"><div align='center'>{!!$item->_e51!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" data="" edata="52" title="Lihat Detail"><div align='center'>{!!$item->_e52!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" data="" edata="null" title="Lihat Detail"><div align='center'>{!!$item->_e60!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="notnull" title="Lihat Detail"><div align='center'>{!!$item->gol!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="null" title="Lihat Detail"><div align='center'>{!!$item->golempty!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="11" title="Lihat Detail"><div align='center'>{!!$item->_11!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="12" title="Lihat Detail"><div align='center'>{!!$item->_12!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="13" title="Lihat Detail"><div align='center'>{!!$item->_13!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="14" title="Lihat Detail"><div align='center'>{!!$item->_14!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="21" title="Lihat Detail"><div align='center'>{!!$item->_21!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="22" title="Lihat Detail"><div align='center'>{!!$item->_22!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="23" title="Lihat Detail"><div align='center'>{!!$item->_23!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="24" title="Lihat Detail"><div align='center'>{!!$item->_24!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="31" title="Lihat Detail"><div align='center'>{!!$item->_31!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="32" title="Lihat Detail"><div align='center'>{!!$item->_32!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="33" title="Lihat Detail"><div align='center'>{!!$item->_33!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="34" title="Lihat Detail"><div align='center'>{!!$item->_34!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="41" title="Lihat Detail"><div align='center'>{!!$item->_41!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="42" title="Lihat Detail"><div align='center'>{!!$item->_42!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="43" title="Lihat Detail"><div align='center'>{!!$item->_43!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="44" title="Lihat Detail"><div align='center'>{!!$item->_44!!}</div></div></td>
                <td><div class="link text-center" ed1="{!!$item->iddikstru!!}" ed2="{!!Input::get('idskpd')!!}" edata="" data="45" title="Lihat Detail"><div align='center'>{!!$item->_45!!}</div></div></td>
            </tr>
        @endforeach
        @else
            <tr>
