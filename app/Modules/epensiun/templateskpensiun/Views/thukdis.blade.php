        ...
        <!-- <div class="box-header with-border">
            ...
            <div class="col-md-12">
                <ul class="nav nav-tabs tab1" id="myTab">
                    ...
                    <li class="active"><a href="{!!url()!!}/epensiun/templateskpensiun/thukdis"> <i class="fa fa-fw fa-list-ul"></i> TIDAK PERNAH HUKDIS BKD</a></li>
                ...
                <div class="tab-pane active"><br>
                    ...
                    <div class="box-body">
                        ...
                        <input type="hidden" name="jenis" class="jenis" id="jenis" value="3">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea rows="10" cols="600" name="template" class="ckeditor form-control" id="template" placeholder="Template Kenaikan Gaji Berkala">
                                    <?php
                                    $cek = TemplateskpensiunModel::getTemplate(session('idskpd'), 3);
                                    if($cek != 0){
                                        echo TemplateskpensiunModel::getTemplate(session('idskpd'), 3);
                                    }else{
                                        echo  TemplateskpensiunModel::getTemplate('all', 3);
                                    }
                                    ?>
                                </textarea>
                            </div>
