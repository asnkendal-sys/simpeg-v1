<html>
<head>
<title>{!!ucfirsts(getUtility('alias_aplikasi'))!!} Nominatif Ultah</title>
...
?>
<div align="center">
<h3>DAFTAR NOMINATIF PEGAWAI ULANG TAHUN</h3>
<h3>
    {!!((Input::get('idskpd') != '')?'PADA '.strtoupper(getSkpd(Input::get('idskpd')))." ".$titlewk:'')!!}
</h3>
</div><br>
