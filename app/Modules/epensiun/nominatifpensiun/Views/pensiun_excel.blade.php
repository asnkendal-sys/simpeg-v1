...
$w="<?xml version=\"1.0\"?>
     ...
     <Worksheet ss:Name=\"Sheet1\">
      <Table ss:ExpandedColumnCount=\"13000000\" ss:ExpandedRowCount=\"6000000\" x:FullColumns=\"1\"
       ...
       <Row ss:AutoFitHeight=\"0\" ss:Height=\"20.25\">1
        ...
        <Cell ss:StyleID=\"s81\"><Data ss:Type=\"String\">Tingkat</Data></Cell>9
    ...
    { $n++;  
      $w.="<Row ss:Height=\"33.75\">
        ...
        <Cell ss:StyleID=\"s84\"><Data ss:Type=\"String\">".$entripensiun->tkpendid."&#10;".$entripensiun->jenjurusan."</Data></Cell>
        <Cell ss:StyleID=\"s84\"><Data ss:Type=\"String\">".$entripensiun->agama."&#10;".substr($entripensiun->usia,0,2)." thn ".substr($entripensiun->usia,2,2)."bln</Data></Cell>
...
force_download("Entri_pensiun".date('Ymds').".xls", $w);
?>
