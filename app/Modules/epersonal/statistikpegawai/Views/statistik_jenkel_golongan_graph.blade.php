...
<script>
	$(document).ready(function(){
		...
		$.ajax({
			url:'{{url()}}/epersonal/statistikpegawai/graphjenkelgol1',
			type:'post',
		...
		$.ajax({
			url:'{{url()}}/epersonal/statistikpegawai/graphjenkelgol2',
			type:'post',
            data:{ 'idskpd':$('#idskpd').val(), 'idstspeg':idstspeg, '_token':'{!!csrf_token()!!}' },
            beforeSend:function(){
		...
		$.ajax({
			url:'{{url()}}/epersonal/statistikpegawai/graphjenkelgol3',
			type:'post',
            data:{ 'idskpd':$('#idskpd').val(), 'idstspeg':idstspeg, '_token':'{!!csrf_token()!!}' },
            beforeSend:function(){
		...
		$.ajax({
			url:'{{url()}}/epersonal/statistikpegawai/graphjenkelgol4',
			type:'post',
            data:{ 'idskpd':$('#idskpd').val(), 'idstspeg':idstspeg, '_token':'{!!csrf_token()!!}' },
            beforeSend:function(){
...
<div id="graph-jenkelgol1" style="width:100%"></div>
<div id="graph-jenkelgol2" style="width:100%"></div>
<div id="graph-jenkelgol3" style="width:100%"></div>
<div id="graph-jenkelgol4" style="width:100%"></div>