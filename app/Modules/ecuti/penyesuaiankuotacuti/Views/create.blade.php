<section class="content-header">
    <h1>
        Buat Penyesuaiankuotacuti Baru<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li><a href="#" id="back"> Penyesuaiankuotacuti</a></li>
        <li class="active">Buat Penyesuaiankuotacuti Baru</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            ...
            <div class="box-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						{!! Form::text('hari_kerja', null, array('class'=> 'form-control', 'placeholder'=>'Hari Kerja')) !!}
					</div>
				</div>
