	...
	<tbody>
        ...
        @if(count($rs) > 0)
            ...
            <tr>
                ...
                <td><div class="link text-center" data="notnull" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->gol!!}</div></div></td>
                <td><div class="link text-center" data="null" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->golempty!!}</div></div></td>
                <td><div class="link text-center" data="11" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->ia!!}</div></div></td>
                <td><div class="link text-center" data="12" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->ib!!}</div></div></td>
                <td><div class="link text-center" data="13" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->ic!!}</div></div></td>
                <td><div class="link text-center" data="14" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->id!!}</div></div></td>
                <td><div class="link text-center" data="21" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->iia!!}</div></div></td>
                <td><div class="link text-center" data="22" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->iib!!}</div></div></td>
                <td><div class="link text-center" data="23" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->iic!!}</div></div></td>
                <td><div class="link text-center" data="24" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->iid!!}</div></div></td>
                <td><div class="link text-center" data="31" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->iiia!!}</div></div></td>
                <td><div class="link text-center" data="32" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->iiib!!}</div></div></td>
                <td><div class="link text-center" data="33" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->iiic!!}</div></div></td>
                <td><div class="link text-center" data="34" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->iiid!!}</div></div></td>
                <td><div class="link text-center" data="41" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->iva!!}</div></div></td>
                <td><div class="link text-center" data="42" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->ivb!!}</div></div></td>
                <td><div class="link text-center" data="43" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->ivc!!}</div></div></td>
                <td><div class="link text-center" data="44" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->ivd!!}</div></div></td>
                <td><div class="link text-center" data="45" ed1="{!!$item->tahun!!}" ed2="{!!Input::get('idskpd')!!}" title="Lihat Detail"><div align='center'>{!!$item->ive!!}</div></div></td>
            </tr>
        @endforeach
        @else
        <tr>
