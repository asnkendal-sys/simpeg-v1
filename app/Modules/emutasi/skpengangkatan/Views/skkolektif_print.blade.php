...
<head>
    ...
    <title>Surat Keputusan Kolektif</title>
...
<body>
    ...
    $template = TemplateskpengangkatanModel::getTemplate('all', '5.2', 'template');
    ...
    $arrsearch = array("search","[nosk]","[no_suratrek]","[surat_dari]","[tgl_suratrek]","[perihalrek]","[urutan]","[namalengkap]","[tkpendid]","[nip]","[tmlhr]","[tglhr]","[pangkat]","[gol]","[jablama]","[skpdlama]","[jabbaru]",
            "[skpdbaru]","[tgl_sp]","[jurusan]","[tmt]","[tglsurat]","[namasekda]","[pangkatsekda]","[nipsekda]","[kepalabkd]","[pangkatbkd]","[nipkepalabkd]","[jabkepalabkd]","[bupati]","[tembusan_skpd_baru]","[tembusan_skpd_lama]","[copyright]","[qrcode]","[dasar2]",
        ...
        $arrreplace = array("replace",
            ...
            ucword($item->jabatanbaru." ".NominatifpengangkatanModel::isSekdes($item->nip,$item->idjabfungumbaru)),
