...
<?php
    $where = " tb_01.idjenkedudupeg not in (99,21) and tb_01.idjenjab='2' and tb_01.idgolrupkt='".Input::get('idgolru')."'";
...
<div align="center">
<h3>DAFTAR PEGAWAI BERDASARKAN JABATAN FUNGSIONAL PADA GOLONGAN {!!$golru!!}</h3>
</div><br>
    <table border="1">
