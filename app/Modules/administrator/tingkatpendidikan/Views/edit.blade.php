<section class="content-header">
    <h1>
        Edit Tingkat Pendidikan<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li><a href="#" id="back"> Tingkatpendidikan</a></li>
        <li class="active">Edit Tingkatpendidikan</li>
    </ol>
</section>
<section class="content">
  <div class="box box-primary">
    ...
    <div class="row">
      <div class="col-md-12">
        {!! Form::model($tingkatpendidikan, array('url' => $uri, 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax') ,'id'=>'simpan')) !!}
        {!! Form::hidden('idtkpendid') !!}
        <div class="box-body">
            <div class="form-group">
                {!! Form::label('idtkpendid', 'Kode Tingkat Pendidikan:', array('class' => 'col-sm-3 control-label')) !!}
                <div class="col-sm-2">
                    {!! Form::text('idtkpendid', null, array('class'=> 'form-control','placeholder'=>'Kode Tk Pendidikan', 'disabled'=>'disabled')) !!}
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    {!! comboGolru("maxgol",$tingkatpendidikan->maxgol,"") !!}
                </div>
            </div>
            <div class="form-group">
