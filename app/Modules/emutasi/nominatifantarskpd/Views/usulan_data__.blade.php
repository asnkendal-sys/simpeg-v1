<script type="text/javascript">
    $(document).ready(function(){
        /*$.each($("a[title=popdetil]"), function(index,item){
            $(item).click(function()
            {
                var vId1 = $("span[id=ed1]:eq("+index+")").html();
                var href = '{!!url()!!}/ejabatan/page/popdetil/'+vId1;
                if (href.indexOf('#') == 0) {
                    $(href).modal('show');
                } else {
        ...
        <tbody>
            <tr>
                <td rowspan="2" align="center" width="5%">
                    <div align="center"><img src="{!!url()!!}/packages/upload/photo/default.jpg" width="100"></div>
                </td>
                    ...
                    <table width="100%" border="0">
                        <tr style="background-color: #ececec">
                            <td width="10%" rowspan="2" style="vertical-align:middle">
                                <div align="center">Atribut Mutasi {!!Input::get('n')!!}</div>
                            </td>
                            <td width="15%">Jenis Jabatan</td>
                            <td width="15%">Jabatan Baru</td>
                            <td width="15%">Bidang Baru</td>
                        ...
                        <tr>
                            <td>
                                {!!NominatifantarskpdModel::comboJnsjabatan('[idjenjabbaru]',$item->idjenjab,'','idjenjabbaru',Input::get('n'))!!}
                            </td>

                            <td>
                                <span id="xjab">
                                    <select name="<?php echo Input::get('n')."[idjabjbtbaru]"?>" id="idjabjbtbarux" class="idjabjbtbaru{!!Input::get('n')!!} input-xlarge form-control" style="width: 100%">
                                ...
                                <input type="hidden" name="{!!Input::get('n')!!}[idskpd]" value="<?php echo $item->idskpd?>" id="idskpd{!!Input::get('n')!!}" required class="input-xlarge">
                                ...
                                ?>
                                <!-- KEPALA BKD -->
                                <input type="hidden" class="input-large" name="{!!Input::get('n')!!}[kepalabkd]" value="<?php echo NominatifdalamskpdModel::attrPengantarskpd($idskpd, 'namalengkap')?>">
                                <input type="hidden" class="input-large" name="{!!Input::get('n')!!}[jabkepalabkd]" value="<?php echo NominatifdalamskpdModel::attrPengantarskpd($idskpd, 'jab')?>">
                                <input type="hidden" class="input-large" name="{!!Input::get('n')!!}[nipkepalabkd]" value="<?php echo NominatifdalamskpdModel::attrPengantarskpd($idskpd, 'nip')?>">
                                <input type="hidden" class="input-large" name="{!!Input::get('n')!!}[pangkatbkd]" value="<?php echo NominatifdalamskpdModel::attrPengantarskpd($idskpd, 'pangkat')?>">
                                <!-- BUPATI -->
                                ...
                                <input type="hidden" class="form-control" name="{!!Input::get('n')!!}[jabkepalabkd]" value="{!! getKepskpd('01','jab') !!}">
                            ...
                            <td>
                                <select id="idskpdbaru{!!Input::get('n')!!}" class="input-xlarge form-control" name="<?php echo Input::get('n')."[idskpdbaru]"?>"/>
                                </select>
                            </td>
                            <td>
                                <input type="text" name="{!!Input::get('n')!!}[keterangan]" required class="input-xlarge form-control" placeholder="Keterangan Mutasi">
       ...
       $('#xjab1,#xjab2,#xjab3').hide();  
        ...
        $.each($('.idjenjabbaru'), function(index,item){
            $(item).change(function(){
                ...
                /*select jabjbt xjab1*/
                autoComplete(".idjabjbtbaru{!!Input::get('n')!!}", '{{url()}}/emutasi/nominatifantarskpd/listjabstruk2', 'Jabatan Struktural ..', null, '{!!$item->idjabjbt!!}', '{!!$item->jabatan!!}');

               //jabatan fungsional xjab2
               autoComplete("#idjabfungbaru{!!Input::get('n')!!}", '{{url()}}/emutasi/nominatifantarskpd/listjabfung2', 'Jabatan Fungsional ..', null, '{!!$item->idjabfung!!}', '{!!$item->jabatan!!}');

                //jabatan fungsional xjab3 idjabfungumbaru
                autoComplete("#idjabfungumbaru{!!Input::get('n')!!}", '{{url()}}/emutasi/nominatifantarskpd/listjabfungum2', 'Jabatan Fungsional Umum ..', null, '{!!$item->idjabfungum!!}', '{!!$item->jabatan!!}');

                autoComplete("#idskpdbaru{!!Input::get('n')!!}", '{{url()}}/emutasi/nominatifantarskpd/cariwhereskpd2', 'Satker ..', null, '{!!$item->idskpd!!}', '{!!$item->skpd!!}');
    });
</script>
