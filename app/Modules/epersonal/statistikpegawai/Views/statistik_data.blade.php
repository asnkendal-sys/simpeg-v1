	...
	<div class="tab-pane active" id="statistik">
		<div class="row-fluid">
			...
			switch(Input::get('idkategori')){
				...
				case 12: echo View::make('statistikpegawai::statistik_jabfungguru_golongan'); break;
				case 13: echo View::make('statistikpegawai::statistik_jabfungguru_unker'); break;
				case 14: echo View::make('statistikpegawai::statistik_jabpelaksana_golongan'); break;
				case 15: echo View::make('statistikpegawai::statistik_jabfungkesehatan_golongan'); break;
				case 16: echo View::make('statistikpegawai::statistik_jabfungteknis_golongan'); break;
		...
		<div class="row-fluid">
			<div class="span12" id="result-graph">
				...
				switch(Input::get('idkategori')){
					...
					case 12: echo View::make('statistikpegawai::statistik_jabfungguru_golongan_graph'); break;
					case 13: echo View::make('statistikpegawai::statistik_jabfungguru_unker_graph'); break;
					case 14: echo View::make('statistikpegawai::statistik_jabpelaksana_golongan_graph'); break;
					case 15: echo View::make('statistikpegawai::statistik_jabfungkesehatan_golongan_graph'); break;
					case 16: echo View::make('statistikpegawai::statistik_jabfungteknis_golongan_graph'); break;
