...
<html>
<head>
<title>Simpeg Kendal Statistik Jabatan Fungsional Tertentu Guru</title>
...
<?php
	...
	$itemtkpendid = $this->epersonal_list->getTkpendid($this->input->post('idtkpendid'));

    switch($this->input->post('issek')){
        case "1":
            $jenjang = 'TK';
            break;
        case "2":
	...
	$where.= " where a.idjenkedudupeg not in('99','21') and a.idjenjab = 2 and LEFT(a.idjabfung,3) = '004' and ( $whereskpd d.issek='".$this->input->post('issek')."' $wheregolru )";
...
<h3>BERDASARKAN JABATAN FUNGSIONAL TERTENTU GURU <?=strtoupper($jenjang)?></h3>
</center><br>
<table border="1">
  <colgroup>
