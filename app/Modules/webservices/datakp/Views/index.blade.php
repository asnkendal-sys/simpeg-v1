<section class="content-header">
    <h1>
        Data Kenaikan Pangkat<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li class="active">Data Kenaikan Pangkat</li>
    </ol>
</section>
                ...
                <div class="box-footer">
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-7">
                            <button class="btn btn-success" type="button" id="prev-nominatif"><i class="fa fa-list-ul"></i> Lihat</button>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#prev-nominatif').on('click', function(e){
            e.preventDefault();
            $.ajax({
                url : '{!!url()!!}/webservices/datakp/data/kpo',
                type : 'post',
        ...
        $('#excel-nominatif').on('click', function(e){
            e.preventDefault();
            $('#nominatif-pegawai').attr("action", "{!!url()!!}/webservices/datakp/excel/kpo");
            $('#nominatif-pegawai').submit();
            /*cetak_excel('result');*/
        });
    });
