        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-tabs tab1" id="myTab">
                    <li class="active"><a href="{!!url()!!}/pppk/pemberhentiankontrak"> <i class="fa fa-fw fa-list-ul"></i> PENJAGAAN PEMBERHENTIAN PPPK</a></li>                    
                    <li class=""><a href="{!!url()!!}/pppk/pemberhentiankontrak/indexnominatif"> <i class="fa fa-fw fa-list-ul"></i> PENETAPAN PEMBERHENTIAN PPPK</a></li>                    
                </ul>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#prev-nominatif').on('click', function(e){
            e.preventDefault();
            $.ajax({
                url : '{!!url()!!}/pppk/pemberhentiankontrak/data/nominatif',
                type : 'post',
        ...
        $('#cetak-nominatif').on('click', function(e){
            e.preventDefault();
            $('#nominatif-pegawai').attr("action", "{!!url()!!}/pppk/pemberhentiankontrak/print/nominatif");
            $('#nominatif-pegawai').submit();
        });

        $('#excel-nominatif').on('click', function(e){
            e.preventDefault();
            $('#nominatif-pegawai').attr("action", "{!!url()!!}/pppk/pemberhentiankontrak/excel/nominatif");
            $('#nominatif-pegawai').submit();
            /*cetak_excel('result');*/
        });
    });
