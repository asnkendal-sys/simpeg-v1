<html>
<head>
<title>{!!ucfirsts(getUtility('alias_aplikasi'))!!} Statistik Unit Kerja Pendidikan Formal</title>
...
<?php
    $where = " tb_01.idjenkedudupeg not in (99,21) and tb_01.idstspeg in (".Input::get('idstspeg').")";
    $skpd = getSkpd(Input::get('idskpd'));
    $tkpendid = getAttr('a_tkpendid', 'idtkpendid', Input::get('idtkpendid'), 'tkpendid');
	...
	switch(Input::get('idtkpendid')){
		case "notnull":
            $where .= " ";
            $titleadd = "BERDASARKAN TINGKAT PENDIDIKAN";
		break;
		case "null":
            $where .= " and tb_01.idtkpendid='' ";
            $titleadd = "BERDASARKAN TINGKAT PENDIDIKAN YANG KOSONG";
		break;
		default:
            $where .= " and tb_01.idtkpendid='".Input::get('idtkpendid')."' ";
            $titleadd = "BERDASARKAN TINGKAT PENDIDIKAN ".strtoupper($tkpendid);
		break;
