        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-tabs tab1" id="myTab">
                    <li class="active"><a href="{!!url()!!}/pppk/perpanjangankontrak"> <i class="fa fa-fw fa-list-ul"></i> PENJAGAAN PERPANJANGAN PPPK</a></li>                    
                    <li class=""><a href="{!!url()!!}/pppk/perpanjangankontrak/indexnominatif"> <i class="fa fa-fw fa-list-ul"></i> PENETAPAN PERPANJANGAN PPPK</a></li>                    
                </ul>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#prev-nominatif').on('click', function(e){
            e.preventDefault();
            $.ajax({
                url : '{!!url()!!}/pppk/perpanjangankontrak/data/nominatif',
                type : 'post',
        ...
        $('#cetak-nominatif').on('click', function(e){
            e.preventDefault();
            $('#nominatif-pegawai').attr("action", "{!!url()!!}/pppk/perpanjangankontrak/print/nominatif");
            $('#nominatif-pegawai').submit();
        });

        $('#excel-nominatif').on('click', function(e){
            e.preventDefault();
            $('#nominatif-pegawai').attr("action", "{!!url()!!}/pppk/perpanjangankontrak/excel/nominatif");
            $('#nominatif-pegawai').submit();
            /*cetak_excel('result');*/
        });
    });
