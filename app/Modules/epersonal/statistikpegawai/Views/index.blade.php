...
<section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-tabs tab1" id="myTab">
                    <li class="active"><a href="{!!url()!!}/epersonal/statistikpegawai"> <i class="fa fa-fw fa-list-ul"></i> STATISTIK PEGAWAI</a></li>
 ...
 <li class=""><a href="{!!url()!!}/epersonal/statistikpegawai/statistikabk"> <i class="fa fa-fw fa-list-ul"></i> STATISTIK ABK</a></li>
                ...
                {!! Form::open(array('url' => \Request::path()."/print/statistik", 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax'),'id'=>'simpan','target'=>'_blank')) !!}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        {!! Form::label('idkategori', 'Kategori:', array('class' => 'col-sm-3 control-label')) !!}
                        <div class="col-sm-3">
                            {!! comboKategori("idkategori","","") !!}
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="box-footer">
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-7">
                            ...
                            &nbsp;&nbsp;
                            <button class="btn btn-success" type="submit" id="cetak-nominatif"><i class="fa fa-print"></i> Cetak Statistik</button>
                        </div>
                    </div>
                </div>
                {!! Form::close() !!}
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#prev-statistik').on('click', function(e){
            ...
            $.ajax({
                url:'{{url()}}/epersonal/statistikpegawai/data/statistik',
                type:'post',
                data:{ 'idskpd':$('#idskpd').val(),'idkategori':$('#idkategori').val(),'idstspeg':idstspeg,'_token' : '{!!csrf_token()!!}'},
                beforeSend:function(){
