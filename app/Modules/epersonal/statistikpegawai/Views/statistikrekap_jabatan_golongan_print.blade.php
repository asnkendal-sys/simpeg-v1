...
<?php
    ...
    switch(Input::get('idjenjab')){
        case "20":
            $jenjab = 'JABATAN STRUKTURAL';
            $where .= " and tb_01.idjenjab >= '20' ";
            break;
        case "2":
            $jenjab = 'JABATAN FUNGSIONAL';
            $where .= " and tb_01.idjenjab >= '2' ";
            break;
        case "3":
            $jenjab = 'JABATAN PELAKSANA';
            $where .= " and tb_01.idjenjab = '3' ";
            break;
        default:
            $jenjab = 'SEMUA JABATAN';
            $where .= " ";
            break;
    }
    ...
    switch(Input::get('idgolru')){
        ...
        case "nullgol":
            ...
            break;
        case "nulljab":
            $where .= " and tb_01.idjenjab='' ";
            $titleadd = strtoupper($skpd)." YANG JENIS JABATAN KOSONG ";
            break;
        case "1":
            $where .= " and LEFT(tb_01.idgolrupkt,1)='1' ";
            $titleadd = strtoupper($skpd)." GOLONGAN I ";
            break;
        case "2":
            $where .= " and LEFT(tb_01.idgolrupkt,1)='2' ";
            $titleadd = strtoupper($skpd)." GOLONGAN II ";
            break;
        case "3":
            $where .= " and LEFT(tb_01.idgolrupkt,1)='3' ";
            $titleadd = strtoupper($skpd)." GOLONGAN III ";
            break;
        case "4":
            $where .= " and LEFT(tb_01.idgolrupkt,1)='4' ";
            $titleadd = strtoupper($skpd)." GOLONGAN IV ";
            break;
        case "5":
            $where .= " and LEFT(tb_01.idgolrupkt,1)='5' ";
            $titleadd = strtoupper($skpd)." GOLONGAN V ";
            break;
        default:
