        ...
        <div class="col-md-12">
            ...
            <div class="row-fluid">
                    ...
                    <div class="col-md-6">
                        <p>
                            <div class="box-header with-border">
                                <b class="box-title"><small>PPPK</small></b>
                            </div>
                        </p>
                        <p>
                            <div class="box-header with-border">
                                <b class="box-title"><small>PENGANGKATAN</small></b>
                            </div>
                        </p>
                        <div class="form-group div-disabled">
                            <label class="col-sm-3 control-label" for="idgolrucpn">Gol. Ruang</label>
                            <div class="controls col-sm-7">
                                {!! comboGolrupppk("idgolrucpn","","") !!}
                            </div>
                        </div>
                        <div class="form-group div-disabled">
                        ...
                        <p>
                            <div class="box-header with-border">
                                <b class="box-title"><small>PERPANJANGAN</small></b>
                            </div>
                        </p>
                        <div class="form-group div-disabled">
                            <label class="col-sm-3 control-label" for="idgolrupkt">Gol. Ruang</label>
                            <div class="controls col-sm-7">
                                {!! comboGolrupppk("idgolrupkt","","") !!}
                            </div>
                        </div>
                        <div class="form-group div-disabled">
                        ...
                        <p>
                            <div class="box-header with-border">
                                <b class="box-title"><small>UNIT KERJA</small></b>
                            </div>
                        </p>
                        <div class="form-group div-disabled">
                    ...
                    <div class="col-md-6">
                        <div class="accordion-heading">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls col-sm-7">
                                    <div class="checkbox">
                                        ...
                                        <input name="idacuan" value="2" id="idacuan2" class="idacuan" type="radio"> PPPK
                                        &nbsp; <span id="resacuan"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="golru">Pangkat/Golru</label>
                                <div class="controls col-sm-7">
                                    {!! comboGolru("golru","","",3) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="tmt">TMT KGB</label>
                                <div class="controls col-sm-7">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="nosk">No. SK KGB</label>
                                <div class="controls col-sm-7">
                                    <input name="nosk" value="" id="nosk" maxlength="45" class="form-control" type="text">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="tgsk">Tanggal SK KGB</label>
                                <div class="controls col-sm-7">
    ...
    function loadBiodata2(){
        ...
        $.ajax({
            ...
            success:function(response){
                preloader.off();
                var ret = $.parseJSON(response);
                var arrdate = new Array("tglhr","tmtjbt","tgskcpn","tmtcpn","tmtpkt");
                var arraytext = new Array("skpdunit");
                var arrayradio = new Array("idjenkel","idacuan");
                var arrselect2 = new Array("idagama","idstspeg","idstskawin","idskpd","kdunit","idgolrucpn","idgolrupkt");
                ...
                if(ret){
                    ...
                    $("#simpan").find('#idagama, #idstspeg, #idstskawin, #idgoldarah, #kdunit, #idjenkepeg, #idjenkedudupeg, #idjenjab, #pejmencpn, #idgolrucpn,#pejmenpns, #idgolrupkt, #pejmenpkt, #pejmenkgb, #idgolkgb, #idtkpendidawal, #idtkpendid, #idtugasgurudosen').val('').trigger('change');
