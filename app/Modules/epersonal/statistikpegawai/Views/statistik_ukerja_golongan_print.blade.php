<html>
<head>
<title>{!!ucfirsts(getUtility('alias_aplikasi'))!!} Statistik Unit Kerja Golongan</title>
...
<?php
	...
	switch(Input::get('idgolru')){
		case "notnull":
			...
			$titleadd = "BERDASARKAN SEMUA GOLONGAN ";
		break;
		case "null":
            $where .= " and tb_01.idgolrupkt='' ";
			$titleadd = "BERDASARKAN YANG GOLONGANNYA KOSONG ";
		break;
		default:
            $where .= " and tb_01.idgolrupkt='".Input::get('idgolru')."'";
			$titleadd = "BERDASARKAN GOLONGAN ".$golru;
		break;
