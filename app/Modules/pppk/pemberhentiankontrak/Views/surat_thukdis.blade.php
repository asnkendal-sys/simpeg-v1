...
<div class="print"></div>
    <?php
        ...
        $rs = \PemberhentiankontrakModel::getDatanominatiftmt($bup, $idskpd, $nip);        
        $rstemplate = (\NominatifpensiunModel::getTemplatesk($rs[0]->kdunit,6) == '0')?'<div align="center"><b>Perhatian!</b> Template Belum tersedia.<br><em>"Silahkan buat template pada menu Template Tidak Pernah Hukdis."</em></div>':\NominatifpensiunModel::getTemplatesk($rs[0]->kdunit,6);
        ...
        foreach($rs as $item){
            ...
            $arrreplace = array("replace",$item->no_hukdis_opd,$item->pejpen_hukpid,$item->nippen_hukpid,$item->golpen_hukpid,$item->pangpen_hukpid,$item->jabpen_hukpid,$item->nama,$item->nip,'-',$item->golru,
