        ...
        <div class="box-header with-border row">
            <div class="col-md-12">
                <ul class="nav nav-tabs tab1" id="myTab">
                    ...
                    <li><a data-toggle="tab" href="{!!url()!!}/emutasi/templatemasukkabupaten/pengantarpersetujuan"><i class="fa fa-pencil"></i> Surat Pengantar Persetujuan</a></li>
                    <li><a data-toggle="tab" href="{!!url()!!}/emutasi/templatemasukkabupaten/surattugas"><i class="fa fa-pencil"></i> Surat Tugas</a></li>
                    <li class="active"><a data-toggle="tab" href="{!!url()!!}/emutasi/templatemasukkabupaten/pengantarsurattugas"><i class="fa fa-pencil"></i> Surat Pengantar Tugas</a></li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                          <input type="hidden" name="jnssurat" class="jnssurat" id="jnssurat" value="4.5">
                        ...
                        <div class="form-group">
        					...
        					<div class="col-sm-10">
        						{!! Form::text('nama', TemplatemasukkabupatenModel::getTemplate('all', 4.4, 'nama'), array('class'=> 'form-control', 'placeholder'=>'Nama Surat')) !!}
        					</div>
        				</div>
                        <div class="form-group">
                            {!! Form::label('template', 'Template:', array('class' => 'col-sm-2 control-label')) !!}
                            <div class="col-sm-10">
                                <textarea rows="10" cols="600" name="template" class="ckeditor form-control" id="template5" placeholder="Template Surat Keputusan Ijin Belajar">
                                <?php
                                    /*$cek = TemplatemasukkabupatenModel::getTemplate(session('idskpd'), 4.4);
                                    if($cek != 0){
                                        echo TemplatemasukkabupatenModel::getTemplate(session('idskpd'), 4.4);
                                    }else{
                                        echo  TemplatemasukkabupatenModel::getTemplate('all', 4.4);
                                    }*/

                                    echo  TemplatemasukkabupatenModel::getTemplate('all', 4.5, 'template');
                                ?>
                                </textarea>
                            </div>
                        </div>
