                            ...
                            <div class="box-body">
                                <table class="table table-striped table-hover table-condensed">
                                    ...
                                    <tr>
                                        <td width="24%">Nama</td>
                                        <td width="1%">:</td>
                                        <td width="75%">{!!$data->pegawai->nama!!}</td>
                                    </tr>
                                    <tr>
                                        <td width="24%">Jabatan</td>
                                        <td width="1%">:</td>
                                        <td width="75%">{!!ucword($data->jab)!!}</td>
                                    </tr>
                                    <tr>
                                        <td width="24%">Pangkat / Golongan</td>
                                        <td width="1%">:</td>
                                        <td width="75%">{!!$data->pangkat!!} / {!!ucword($data->golru)!!}</td>
                                    </tr>
                                    <tr>
                                        <td width="24%">Unit Kerja</td>
                                        <td width="1%">:</td>
                                        <td width="75%">{!!ucword($data->unit_kerja)!!}</td>
                                    </tr>
                                    <tr>
                                        <td width="24%">Sub Unit Kerja</td>
                                        <td width="1%">:</td>
                                        <td width="75%">{!!ucword($item->nama_skpd)!!}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="box-body">
                                <table class="table table-striped table-hover table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <td width="1%">:</td>
                                        <td width="75%">{!! $surat=='cpppk'?"PENGANGKATAN CALON PEGAWAI PEMERINTAH DENGAN PERJANJIAN KERJA":($surat=='sp'?"SURAT PERINTAH":"SURAT  PEMBERHENTIAN") !!}</td>
                                    </tr>
                                    <tr>
                                        <td width="24%">Nomor SK</td>
                                        <td width="1%">:</td>
                                        <td width="75%">{!!$data->nosk!!}</td>
                                    </tr>
                                    <tr>
                                        <td width="24%">Tanggal SK</td>
                                        <td width="1%">:</td>
                                        <td width="75%">{!!formatTanggalPanjang($data->tgsk)!!}</td>
                                    </tr>
                                    <tr>
