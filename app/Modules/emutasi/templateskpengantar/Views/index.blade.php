        ...
        <div class="table-responsive">
            <div class="box-body nav-tabs-custom">
                ...
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    @if(session('role_id') <= 3) <li class=""><a href="#pengantarbkd" data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil"></i> Surat Pengantar BKPP</a></li>
                        <li class=""><a href="#skperintah" data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil"></i> Surat Perintah</a></li>
                        <li class=""><a href="#skperintahfungsional" data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil"></i> Surat Perintah Fungsional</a></li>
                ...
                <div class="tab-content">
                    ...
                    <!-- /.tab-pane -->
                    <div class="tab-pane" id="skperintahfungsional"></div>
                    <!-- /.tab-pane -->
...
<script>
            ...
            $(item).click(function() {
                switch (index) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        getSkperintahFungsional();
                        break;
                    case 4:
                        getSkperintahRangkap();
                        break;
                    case 5:
                        getPengantarsekda();
                        break;
    ...
    function getSkperintahFungsional() {
        xhr.abort();
        $.ajax({
            type: 'post',
            url: '{!!url()!!}/emutasi/templateskpengantar/data/skperintahfungsional',
            data: {
                '_token': '{!!csrf_token()!!}'
            },
            beforeSend: function() {
            ...
            success: function(response) {
                preloader.off();
                $('#skperintahfungsional').html(response);
            }
        });
    }
